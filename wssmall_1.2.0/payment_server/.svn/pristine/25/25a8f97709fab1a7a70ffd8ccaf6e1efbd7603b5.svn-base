 ...
 * 翼支付wap支付
 */
public class BankEPAYACCWapPayParams implements IOnlinePayParams {
	private static Logger logger = Logger.getLogger(BankEPAYACCWapPayParams.class);
	@Override
	...
	public PayResult checkCallBack(PayCfg cfg,
		...
		String strMac = "UPTRANSEQ="+param.get("UPTRANSEQ")+
						...
						"&ORDERSEQ=" + param.get("ORDERSEQ") +
						"&ORDERAMOUNT=" + orderAmount + 
						"&RETNCODE=" + retnCode +
						"&RETNINFO=" + param.get("RETNINFO") + 
						"&TRANDATE=" + param.get("TRANDATE") + 
