...
public abstract class AbsTaobao implements OuterInf{
	 ...
	 * @throws ApiException
	 */
	public static TradeGetResponse getTrade(long tid,String appkey,String secret,String sessionKey,String url) throws ApiException{
	 ...
	 * @throws ApiException 
	 */
	public static TradeWtverticalGetResponse getTradeWtvertical(String tids,String appkey,String secret,String sessionKey,String url) throws ApiException{
		//if(true)return null;
		TaobaoClient client=new DefaultTaobaoClient(url, appkey, secret);
