...
public class ImportTemplate implements Serializable {
	...
	private String rule_java;
	private Integer thread_num;
	private Integer max_num;
	private String rule_desc;
	private String status;
	private String template_columns;
	...
	public String getTemplate_columns() {
	...
	public void setTemplate_columns(String template_columns) {
		this.template_columns = template_columns;
	}
	@NotDbField
	...
	public String getRule_java() {
		return rule_java;
	}

	public void setRule_java(String rule_java) {
		this.rule_java = rule_java;
	}
