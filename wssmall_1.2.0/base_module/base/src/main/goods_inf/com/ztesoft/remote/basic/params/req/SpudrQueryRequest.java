...
public class SpudrQueryRequest extends ZteRequest<SpudrQueryResponse>{
	...
	@ZteSoftCommentAnnotationParam(name = "产品id", type = "String", isNecessary = "Y", desc = "产品id(增值业务清单查询)")
	...
	public String getApiMethodName() {
		return BasicConst.API_PREFIX + "spudrQuery";
	}
