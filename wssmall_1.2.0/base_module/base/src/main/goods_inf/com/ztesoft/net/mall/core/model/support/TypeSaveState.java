 ...
 *
 */
public class TypeSaveState  implements Serializable {
	 ...
	 private int do_save_model;//是否完成保存型号关联
	...
	public int getDo_save_model() {
		return do_save_model;
	}
	public void setDo_save_model(int do_save_model) {
		this.do_save_model = do_save_model;
	}
