 ...
 * 
 */
public class PukQryRequest extends ZteRequest<PukQryResponse> {

	@ZteSoftCommentAnnotationParam(name = "号码", type = "String", isNecessary = "Y", desc = "号码")
	private String phoneNum;

	@ZteSoftCommentAnnotationParam(name = "产品id", type = "String", isNecessary = "Y", desc = "产品id(puk查询)")
	...
	public String getApiMethodName() {
		return BasicConst.API_PREFIX + "pukQry";
	}
