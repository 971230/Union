 ...
 * User: guangping
 * Date: 2013-12-24 16:41
 * To change this template use File | Settings | File Templates.
 * 促销规则管理接口
 */
public interface PromotionInf {
     ...
     *  优惠后的配送费用,
     *  优惠后的积分值
     *  @see {@link com.ztesoft.net.net.mall.core.model.support.DiscountPrice}
     */
...
//    public void delete(Integer[] pmtidArray);
     ...
     * @param code
     * @param memberId
     * @throws com.ztesoft.net.framework.database.ObjectNotFoundException 输入的优惠卷号码未找到
     */
