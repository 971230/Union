...
public class InterGroupBusiOrderBroadInfo {
	...
	private List<InterGroupFeeInfo> fee_list; // 费用项
...
0：不是
	...
	public List<InterGroupFeeInfo> getFee_list() {
		return fee_list;
	}

	public void setFee_list(List<InterGroupFeeInfo> fee_list) {
