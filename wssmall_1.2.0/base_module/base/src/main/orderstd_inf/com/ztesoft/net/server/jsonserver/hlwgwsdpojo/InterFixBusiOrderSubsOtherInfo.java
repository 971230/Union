...
public class InterFixBusiOrderSubsOtherInfo {
	private String user_group;//用户组名称
	private String lan_school;//校园信息
	private String complex_grid_id;//综合网格
	private String cust_building_id;//聚类市场信息
	private String grp_grid_id;//商企网格
	private String grpuser_ope_model;//商企用户运营模式
