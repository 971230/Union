 ...
 */
public class IntentOrderCustInfo implements Serializable {
	...
	@ZteSoftCommentAnnotationParam(name = "check_type", type = "String", isNecessary = "N", desc = "认证类型")
	private String check_type;//认证类型 返档订单必传	01：本地认证	02：公安认证	03：二代证读卡器
    ...
    private String chip_illumination;//芯片照
