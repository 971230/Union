...
public class MobileBusiCtnStandardResp extends OrderCollectionResp {
	...
	public String toString() {
		...
		builder.append("MobileBusiCtnStandardResp [validate_type=").append(validate_type).append(", validate_msg=").append(validate_msg).append(", error_code=").append(error_code)
				.append(", error_msg=").append(error_msg).append("]");
