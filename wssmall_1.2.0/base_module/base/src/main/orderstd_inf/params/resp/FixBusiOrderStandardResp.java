...
public class FixBusiOrderStandardResp extends OrderCollectionResp {
	...
	public String toString() {
		...
		builder.append("FixBusiOrderStandardResp [validate_type=").append(validate_type).append(", validate_msg=")
