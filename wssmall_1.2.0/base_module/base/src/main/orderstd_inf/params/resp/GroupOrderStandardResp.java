...
public class GroupOrderStandardResp extends OrderCollectionResp {
	...
	public String toString() {
		...
		builder.append("GroupOrderStandardResp [validate_type=").append(validate_type).append(", validate_msg=")
