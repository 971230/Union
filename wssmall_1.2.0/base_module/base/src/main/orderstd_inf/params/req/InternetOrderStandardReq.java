...
public class InternetOrderStandardReq extends ZteRequest<ZteResponse>{
...
//		if(StringUtils.isEmpty(this.getBase_order_id()))CommonTools.addError(new ZteError(ConstsCore.ERROR_FAIL, "订单编码不能为空"));
	...
	public String getApiMethodName() {
		return "zte.net.orderstd.internetBusiOrderStandard";
//		        zte.net.orderstd.internetBusiOrderStandard
	}
