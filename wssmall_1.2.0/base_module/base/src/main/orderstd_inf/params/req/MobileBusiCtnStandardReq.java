...
public class MobileBusiCtnStandardReq extends ZteRequest<ZteResponse> {
	...
	public void check() throws ApiRuleException {
		if (StringUtils.isEmpty(this.getBase_co_id()))
	...
	public String getApiMethodName() {
		return "zte.net.orderstd.MobileBusiCtnStandard";
	}
