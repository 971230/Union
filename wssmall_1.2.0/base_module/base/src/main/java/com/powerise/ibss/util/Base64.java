...
//    }
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 0) {
            logger.info("usage:  java Base64 [-d[ecode]] filename");
            System.exit(0);
        }
        ...
        if (!file.exists()) {
            logger.info("Error:  file '" + filename + "' doesn't exist!");
            System.exit(0);
        }
        ...
        if (decode) {
            ...
            char[] encoded = encodeChar(decoded);
    ...
    private static byte[] readBytes(File file) {
        ...
        try {
            java.io.InputStream fis = new FileInputStream(file);
            java.io.InputStream is = new BufferedInputStream(fis);
            int count = 0;
    ...
    private static char[] readChars(File file) {
        ...
        try {
        	java.io.Reader fr = new FileReader(file);
        	java.io.Reader in = new BufferedReader(fr);
            int count = 0;
    ...
    private static void writeBytes(File file, byte[] data) {
        try {
        	java.io.OutputStream fos = new FileOutputStream(file);
        	java.io.OutputStream os = new BufferedOutputStream(fos);
            os.write(data);
            os.close();
        }
        catch (Exception e) {
