	...
	private static void loadConfig() throws Exception {
		try {
			...
			tempEnv.put(
				...
				clientProps.get("factory.initial"));
			
			tempEnv.put(
				"java.naming.provider.url",
				clientProps.get("provider.url"));
			logger.info(clientProps.get("provider.url"));
			tempEnv.put(
				"java.naming.security.credentials",
				clientProps.get("credentials"));
			tempEnv.put(
				"java.naming.security.principal",
				clientProps.get("principal"));
	...
	private static LDAPUtils getHandler() throws  Exception{
		...
		try {
			...
			if (ldapHandler == null) {
				...
				LDAPUtils.ctx = new InitialDirContext(env);
