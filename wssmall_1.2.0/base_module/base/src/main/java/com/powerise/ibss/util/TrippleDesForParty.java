...
public class TrippleDesForParty{
	private static Logger logger = Logger.getLogger(TrippleDesForParty.class);
    //TYPE
...
//        Security.addProvider(new com.sun.crypto.provider.SunJCE());
    ...
    public static void main(String[] args) {
        try {
            ...
            String passwd = "pass";
            String cryptedData = TrippleDesForParty.encryptForPartyRole(partyRoleId,passwd);
            logger.info(cryptedData);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
