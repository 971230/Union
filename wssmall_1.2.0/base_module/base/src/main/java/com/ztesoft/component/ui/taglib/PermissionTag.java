...
//import com.ztesoft.ppm.systemmanage.service.PrivilegeService;
...
public class PermissionTag extends BodyTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		if("false".equalsIgnoreCase(this.getDisabled())){
			...
			try{ 
			  targetCodes =new ArrayList();//new PrivilegeService().privilegesCheckWithSession(privilegeCodes, ((HttpServletRequest)pageContext.getRequest()).getSession());
			}catch(Exception e){
				logger.info("读取控件权限列表失败！", null);
