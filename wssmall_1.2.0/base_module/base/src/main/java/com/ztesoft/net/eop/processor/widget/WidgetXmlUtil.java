package com.ztesoft.net.eop.processor.widget;
...
public class WidgetXmlUtil {
    ...
    public static  List<Map<String,String>>   jsonToMapList(String paramJson){
    	 ...
    	 Object[] paramArray =JSON.parseArray(paramJson,Object.class).toArray();
    	 for(Object param: paramArray){
    		 paramList.add(JSON.parseObject(String.valueOf(param),Map.class));
    	 }
    	 return paramList;
    }
