...
public class BatchSqlExecutor  implements IBatchSqlExecutor {
	...
	public void exeucte(String sql) {
		...
		for(int i=0;i<siteList.size();i++){
			...
			try{
				...
				this.logger.info("为站点userid["+site.get("userid")+"]siteid["+site.get("id")+"]执行sql出错，跳过...");
			}
		}
	...
	public static void main(String[] args){
		String content= FileBaseUtil.read("D:/work/eopnew/docs/version/2.2/update.sql", "UTF-8");
		//logger.info( getSiteUpdateSql(content) );
	}
