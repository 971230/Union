...
import com.ztesoft.net.app.base.core.service.solution.*;
...
public class SolutionInstaller implements ISolutionInstaller {
	...
	public void install(String userid, String siteid, String productId) {
		...
		if (EopSetting.RUNMODE.equals("2")) {
			...
			if (!"base".equals(productId)) {
				FileBaseUtil.copyFile(EopSetting.PRODUCTS_STORAGE_PATH + "/"
