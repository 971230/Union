...
public class SqlExportService {
	private static Logger logger = Logger.getLogger(SqlExportService.class);
	...
	public String getInsertSql(final String table)throws BadSqlGrammarException{
		...
		String rname = table;
		 EopSite site  = EopContext.getContext().getCurrentSite();
			...
			final String userid  = site.getUserid();
...
//					logger.info(rsmd.getColumnName(i));
					...
					comma = ",";
//					logger.info(rsmd.getColumnName(i) + ":" + rs.getString(rsmd.getColumnName(i)));
				}
