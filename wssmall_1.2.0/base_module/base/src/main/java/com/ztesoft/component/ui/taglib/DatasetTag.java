	...
	public int doEndTag() throws JspException {
		...
		try{		
			...
			if("true".equalsIgnoreCase(this.getExcel())){
				//mod by he.zhenwei 使用jxl导出excel
				dataset.toExcel2(pageContext);
				//result = dataset.toExcel(pageContext,this.getExcelName());
