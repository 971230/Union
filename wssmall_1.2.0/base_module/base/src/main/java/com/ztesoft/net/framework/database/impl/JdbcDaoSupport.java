				...
				while (rs.next()) {
					for (Map colMap : clob_names) {
						...
						try{
							...
							columnType  = dbRouterPublic.getJdbcTemplate(sqlTy, jdbcTemplate).queryForObject(sqlTy, String.class, 
...
//					this.getLastId(table);
	...
	public String queryForString(String sql) {
		...
		try {
			sql = this.addSourceFrom(sql);
			s  = dbRouterPublic.getJdbcTemplate(sql, jdbcTemplate).queryForObject(sql, String.class);
		} catch (RuntimeException e) {
//			e.printStackTrace();
		}
		return s;
	...
	public String queryForString(String sql,Object...args) {
        ...
        try {
        	sql = this.addSourceFrom(sql);
        	s  = dbRouterPublic.getJdbcTemplate(sql, jdbcTemplate).queryForObject(sql, String.class,args);
        } catch (RuntimeException e) {
			//e.printStackTrace();
        }
        return s;
