...
public abstract class HttpEntityFactory {
	...
	public static HttpEntity buildEntity(HttpServletRequest request,Map otherParams) {
	...
	private static HttpEntity buildFormEntity(HttpServletRequest request,Map otherParams) {
		try {
//			Map paramMap = request.getParameterMap();
			...
			UrlEncodedFormEntity entity = null;//new UrlEncodedFormEntity(formparams,"UTF-8");
			return entity;
...
//	
//	private static HttpEntity buildMultipartFormEntity(HttpServletRequest request,Map otherParams){
//		 
//
//		try {
