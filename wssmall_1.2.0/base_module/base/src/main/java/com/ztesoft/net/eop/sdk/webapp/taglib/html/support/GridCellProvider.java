...
import com.ztesoft.net.eop.sdk.webapp.plugin.AbstractPluginsBundle;
import com.ztesoft.net.eop.sdk.webapp.taglib.html.GridCellTaglib;
import com.ztesoft.net.eop.sdk.webapp.taglib.html.GridTaglib;
...
public class GridCellProvider extends AbstractPluginsBundle{
	...
	private String getUrl() {
		...
		if (servletPath.indexOf(request.getContextPath()) > -1)
			servletPath = servletPath.substring(servletPath.indexOf(request.getContextPath())
	...
	private String getSortOpStart(){
		...
		if(order.endsWith("asc")){
			...
			//<script>$(function(){$(\".gridbody[gridid='"+gridid+"']>.page\").gridAjaxPager('"+url+"');});</script>
