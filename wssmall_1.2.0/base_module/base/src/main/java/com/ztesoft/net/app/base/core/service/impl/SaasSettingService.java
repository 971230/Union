...
public class SaasSettingService extends BaseSupport implements ISettingService  {
	private static Logger logger = Logger.getLogger(SaasSettingService.class);
...
//		String setting_value = "{\"thumbnail_pic_height\":\"40\",\"thumbnail_pic_width\":\"50\"}" ;
		String setting_value = "{\"detail_pic_height\":\"470\",\"watermark\":\"off\",\"thumbnail_pic_height\":\"245\",\"album_pic_height\":\"2030\",\"markcolor\":\"6a616b\",\"thumbnail_pic_width\":\"185\",\"markpos\":\"5\",\"album_pic_width\":\"1500\",\"marksize\":\"12\",\"detail_pic_width\":\"350\"}" ;
		JSONObject jsonObject = JSONObject.fromObject( setting_value );  
		Map map1 = (Map)JSONObject.toBean(jsonObject, Map.class);
		logger.info(map1.get("thumbnail_pic_height"));		
	}
