...
public class StringUtils {
	...
	public static void main1(String[] args) {
		logger.info(StringUtils.isFloat("0"));
		logger.info(StringUtils.isFloat("4.3"));
		logger.info(StringUtils.isFloat("43.4"));
		logger.info(StringUtils.isFloat("4.3.4"));
		logger.info(StringUtils.isFloat("-2.3"));
		logger.info(StringUtils.genRandowNum(2));
...
//				+ (null == e ? "" : "errStack:" + errStack));
    ...
    private static void test(){
    	int i=0;
    	throw new ApiRunTimeException(ConstsCore.ERROR_FAIL,"测试数据");
    }
	public static void main(String[] args) {

		String serverUrl = "http://10.123.180.120:8086/router";
		BSSGetCardMsgReq req = new BSSGetCardMsgReq();
				ZteClient client = new DefaultZteRopClient(serverUrl,AppKeyEnum.APP_KEY_WSSMALL_ECSORD_RELESE.getAppKey(),AppKeyEnum.APP_KEY_WSSMALL_ECSORD_RELESE.getAppSec(),"1.0");
				BSSGetCardMsgRsp resp=  client .execute(req,  BSSGetCardMsgRsp.class);
				logger.info(resp);
...
//
//		logger.info(StringUtils.fen2Yuan("1"));
		//Pattern safePattern =Pattern.compile("^/mgWeb|/mgWeb/|/*.js|/*.html|/*.css$");
//		String url ="/mgWeb|/mgWeb/|/admin/message.jsp|/validcode.do|/wss_login!getUserApp.do|*/userAdmin!forwardResetBossPwdJsp.do|*.js|*.html|*.css|*.jpg|*.png|*.gif|*.jpeg|*.bmp";
//		//String url="/mgWeb|/mgWeb/|/admin/message.jsp|/validcode.do|*getUserApp.do|*forwardResetBossPwdJsp.do|/router|*/images/*|*/js/*|*/css/*|/services/*|/webservice/*|/apidoc/*|/report/*|/servlet/*|istoreself/*|*getRemoteImg.do|/resource/cms/*";
//		//String url ="*.js|*.html|*.css|*.jpg|*.png|*.gif|*.jpeg|*.bmp";
//		//url=url.replaceAll("\\u002A", "/(\\\\w+/)*(\\\\w+.)*\\\\w*");
//		//String url =".*(/)\\1{1}.*.js";
//		url=url.replaceAll("\\u002A", ".*");
...
//		logger.info(url);
//		Pattern safePattern1 =Pattern.compile("^"+url+"$");
//		Pattern safePattern2 =Pattern.compile("^.*(/)\\1{1}.*$");
//		logger.info(safePattern1.matcher("/test//test.js").matches());
//		logger.info(safePattern2.matcher("/test//test.js").matches());
//		String t ="202cb962ac59075b964b07152d234b70";
//		String t2="30d192d11f1b257291cbcc97192fd999";
//		String t3="0604409636"; 
//		logger.info(StringUtil.MD5(t+t3));
////		StringTokenizer t = new StringTokenizer(url,"|");
////		if(null!=t){
////			long t3 =System.currentTimeMillis();
////			while(t.hasMoreTokens()){
////				Pattern safePattern1 =Pattern.compile(t.nextToken()+"$");
////				logger.info(safePattern1.matcher(".css").matches());
