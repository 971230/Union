...
public class EncryptionUtil1 {
	private static Logger logger = Logger.getLogger(EncryptionUtil1.class);
	/**
...
//			logger.info("加密前：" + number);
//			String number2 = EncryptionUtil.authcode(number, "ENCODE","",0);
//			logger.info("加密后：" + number2);
//			logger.info("解密后：" + EncryptionUtil.authcode(number2, "DECODE","",0));
//			logger.info();
//		}
		logger.info(EncryptionUtil1.authcode("9,1319258194668", "ENCODE", "", 0));
		logger.info(EncryptionUtil1.authcode("0fb7Ys0fSwwMXGtXZhtVN9GqUQ7z7r.3.nlfiTBCPSSd.2.d1MmDRFCq8AaOh5I.1.", "DECODE", "",0));
	}
