...
public class DataModelManager extends  BaseSupport<DataModel> implements IDataModelManager {
	...
	public void delete(Integer modelid,String source_from) {
		DataModel dataModel  = this.get(modelid,source_from);
	...
	public void edit(DataModel dataModel,String source_from) {
		DataModel oldmodel = this.get(dataModel.getModel_id(), source_from);
	...
	public DataModel get(Integer modelid,String source_from) {
		String sql ="select * from data_model where model_id=? and source_from=?";
		return this.baseDaoSupport.queryForObject(sql, DataModel.class, modelid,source_from);
	}
