package com.ztesoft.net.cms.plugin.video;
...
import com.ztesoft.net.cms.plugin.ImageFieldPlugin;
...
public class VideoFieldPlugin extends AbstractFieldPlugin {
    ...
    public String onDisplay(DataField field, Object value) {
        ...
        if (value != null) {
            JSONObject videoData = JSON.parseObject(JSON.toJSONString(value));
    ...
    public void onSave(Map article, DataField field) {
        ...
        article.put(fieldname, JSON.toJSONString(video));
    }
