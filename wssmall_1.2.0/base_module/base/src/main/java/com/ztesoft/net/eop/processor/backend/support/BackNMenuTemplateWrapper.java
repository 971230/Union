 ...
 * @date 2014.05.29
 */
public class BackNMenuTemplateWrapper extends AbstractFacadePagetParser {
	
	public BackNMenuTemplateWrapper(FacadePage page, Request request) {
		super(page, request);
	}
	...
	protected Response parse(Response response) {
		...
		String content  = JspUtil.getJspOutput("/mgWeb/main_frame_none_menu.jsp", httpRequest, httpResponse);
