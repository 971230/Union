...
public class DefaultRemoter implements Remoter
{
	...
	public Replies execute(Calls calls)
    {
        ...
        {
            log.info("Call count for batch exceeds maxCallCount. Add an init-param of maxCallCount to increase this limit");
    ...
    public Reply execute(Call call)
    {
        try
        {
            ...
            // Some debug
            //log.debug("Exec: " + call.getScriptName() + "." + call.getMethodName() + "()");
