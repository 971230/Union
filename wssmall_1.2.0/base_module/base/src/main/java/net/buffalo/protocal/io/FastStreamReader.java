	...
	protected static String tagName(int tag)
	  {
	    switch (tag) {
	    case TAG_NULL: return "null";
	    case TAG_BOOLEAN: return "b";
	    case TAG_INT: return "i";
	    case TAG_LONG: return "lg";
	    case TAG_DOUBLE: return "db";
	    case TAG_STRING: return "s";
	    case TAG_MAP: return "m";
	    case TAG_LIST: return "l";
	    case TAG_TYPE: return "t";
	    case TAG_LENGTH: return "len";
	    case TAG_REF: return "ref";
	    case TAG_CALL: return "buffalo-call";
	    case TAG_FAULT: return "fault";
	    case TAG_METHOD: return "method";
	    case TAG_DATE: return "d";
	    case -1: return "end of file";
	    default: return "unknown " + tag;
	    }
	}
