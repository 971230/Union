...
public class SupplierExamReq extends  ZteRequest<ZteResponse> {
	String suppler_id;//供货商id
	String remd ="";//yes为精品商家
	String suppler_name;//供货商名称
	String company_name;//公司名称
	String phone_num;//联系电话
	String page_index ="1";//页数 默认为1
	String page_size ="10";//每页10条 
	...
	public String getApiMethodName() {
		return "supplierServ.findExamineSupplier";
	}
