 ...
 *
 */
public class GoodsAttZBWXSWK_FK extends GoodsAtt implements Serializable {
	...
	@ZteSoftCommentAnnotationParam(name = "产品包编码", type = "String", isNecessary = "N", desc = "ProPacCode：产品包编码")
	private String ProPacCode;
	
	@ZteSoftCommentAnnotationParam(name = "产品包说明", type = "String", isNecessary = "N", desc = "ProPacDesc：产品包说明")
	private String ProPacDesc;
	
	@ZteSoftCommentAnnotationParam(name = "终端信息", type = "String", isNecessary = "N", desc = "ResourcesInfo：终端信息（含终端时必传）")
