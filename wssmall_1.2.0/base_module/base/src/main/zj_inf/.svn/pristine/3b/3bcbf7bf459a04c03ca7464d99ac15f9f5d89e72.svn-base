...
public class OrderDealSuccessNDResponse  extends ZteResponse {
	...
	private List<DealOrderInfo> orderInfo;
	...
	public List<DealOrderInfo> getOrderInfo() {
		return orderInfo;
	}

	public void setOrderInfo(List<DealOrderInfo> orderInfo) {
