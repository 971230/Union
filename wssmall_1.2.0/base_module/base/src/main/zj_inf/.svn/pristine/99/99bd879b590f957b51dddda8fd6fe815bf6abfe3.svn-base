...
public class QueryStdAddrResp extends ZteResponse {
	...
	private QryStdAddrRespVo respJson ;
	...
	public QryStdAddrRespVo getRespJson() {
		return respJson;
	}
	public void setRespJson(QryStdAddrRespVo respJson) {
