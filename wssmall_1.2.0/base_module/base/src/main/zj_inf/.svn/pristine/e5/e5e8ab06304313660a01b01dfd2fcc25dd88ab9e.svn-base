...
public class ModeFact extends AutoFact {
	private static Logger logger = Logger.getLogger(ModeFact.class);
...
//	@DroolsFactField(name="特殊业务类型", ele_type="checkbox", stype_code="DC_BUSINESS_TYPE")
...
//	private String is_physics;
	...
	public String getRegion() {
		...
		this.region = getOrderTree().getOrderExtBusiRequest().getOrder_city_code();
		return region;
	}
	...
	public String getShop_code() {
		...
		this.shop_code = getOrderTree().getOrderExtBusiRequest().getOrder_from();
		return shop_code;
	}
...
//		this.shipping_type = getOrderTree().getOrderBusiRequest().getShipping_type();
...
//	}
	...
	public String getGoods_id() {
		goods_id = getOrderTree().getOrderBusiRequest().getGoods_id();
		return goods_id;
	}
	...
	public void toStringN(){
		logger.info("================================================================>");
		logger.info("zte.net.ecsord.rule.tache.ModeFact 日志信息打印:"+
																"订单编号："+this.getOrder_id()+
																"地市："+this.getRegion()+
																"订单来源:"+this.getShop_code()+
//																"配送方式:"+this.getShipping_type()+
//																"号卡类型:"+this.getCard_type()+
//																"网别:"+this.getNet_type()+
																"订单类型:"+this.getOrder_type()+
//																"特殊业务类型:"+this.getSpecial_buss_type()+
//																"是否老用户:"+this.getIs_old()+
//																"是否总部合约:"+this.getIs_group_contract()+
//																"是否社会机:"+this.getIs_society()+
//																"参与活动:"+this.getProd_cat_id()+
//																"是否实物单:"+this.getIs_physics()+
																"生产模式:"+this.getOper_mode()+
