...
public class NotifyStatusFromWMSOrderInfoVo implements Serializable{
	...
	@ZteSoftCommentAnnotationParam(name="明细信息",type="List<NotifyStatusFromWMSGoodInfoVo>",isNecessary="Y",desc="明细信息")
	private List<NotifyStatusFromWMSGoodInfoVo> goodInfo;
	...
	public List<NotifyStatusFromWMSGoodInfoVo> getGoodInfo() {
		return goodInfo;
	}

	public void setGoodInfo(List<NotifyStatusFromWMSGoodInfoVo> goodInfo) {
