 ...
 *
 */
public class OldUserBuySubmitReq extends ZteRequest<OldUserBuySubmitResp> {
	...
	public String getOpeSysType() {//TODO
...
//		return EcsOrderConsts.AOP_OPE_SYS_TYPE_1;
	...
	public String getApiMethodName() {
		return "ecaop.trades.sell.mob.oldu.activity.sub";
	}
