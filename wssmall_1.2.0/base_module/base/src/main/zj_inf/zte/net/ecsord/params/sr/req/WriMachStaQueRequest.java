...
/**
 * 
 * @author Rapon 轮询写卡机工位状态（一个写卡工位多台写卡机）
 */
public class WriMachStaQueRequest extends ZteRequest {
	...
	public String getRequest() {
		return InfConst.SR_GET_WORK_STATION;
	}
	...
	public WriMachStaQue getNotNeedReqStrData() {
		if (null == this.notNeedReqStrData) {
			notNeedReqStrData = new WriMachStaQue();
			notNeedReqStrData.setWorkStation(CommonDataFactory.getInstance().getAttrFieldValue(notNeedReqStrOrderId, AttrConsts.READID));
		}
		return this.notNeedReqStrData;
	}

	public void setNotNeedReqStrData(WriMachStaQue notNeedReqStrData) {
	...
	public String getApiMethodName() {
		return "com.zte.unicomService.sr.WriteMachineStation";
	}
