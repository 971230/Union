 ...
 * 
 */
public class OpenDealApplyReq extends ZteRequest {
	...
	private List<OpenDealApplySimCardNoVo> getSimCardNoVo(String order_id) {
		...
		vo.setCardType(""/*
							 * CommonDataFactory.getInstance().getAttrFieldValue(
							 * order_id, "WHITE_CART_TYPE")
	...
	public String getApiMethodName() {
		// TODO Auto-generated method stub
		return "ecaop.trades.sell.mob.newu.open.app";
	}
