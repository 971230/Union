 ...
 * 
 */
public class OpenDealApplyUserInfoVo implements Serializable {
	...
	private List<OpenDealApplyProductVo> product; // + 开户时选择的产品信息
	...
	private OpenDealApplyPayInfoVo payInfo;// Y 支付信息
	private List<OpenDealApplyActivityInfoVo> activityInfo; // 开户时活动信息
	...
	public OpenDealApplyPayInfoVo getPayInfo() {
		return payInfo;
	}

	public void setPayInfo(OpenDealApplyPayInfoVo payInfo) {
	...
	public List<OpenDealApplyProductVo> getProduct() {
		if (product == null || product.size() <= 0) return null;
		return product;
	}

	public void setProduct(List<OpenDealApplyProductVo> product) {
