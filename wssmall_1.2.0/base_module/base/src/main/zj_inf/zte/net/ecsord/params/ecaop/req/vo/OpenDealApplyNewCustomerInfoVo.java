 ...
 * 
 */
public class OpenDealApplyNewCustomerInfoVo implements Serializable {
	...
	private List<OpenDealApplyCustomerRemarkVo> customerRemark; // N 客户备注
	...
	public List<OpenDealApplyCustomerRemarkVo> getCustomerRemark() {
		if (customerRemark==null || customerRemark.size() <= 0) return null;
		return customerRemark;
	}
	public void setCustomerRemark(List<OpenDealApplyCustomerRemarkVo> customerRemark) {
