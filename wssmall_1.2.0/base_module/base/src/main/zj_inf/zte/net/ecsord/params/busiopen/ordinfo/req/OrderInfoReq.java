...
public class OrderInfoReq extends ZteRequest<OrderInfoResp> {
	...
	@ZteSoftCommentAnnotationParam(name = "第三方系统编码", type = "String", isNecessary = "Y", desc = "编码待定")
	private String third_sys_code;

	@ZteSoftCommentAnnotationParam(name = "收货人联系电话", type = "String", isNecessary = "N", desc = "收货人联系电话")
	private String consignee_num;
	...
	public String getConsignee_num() {
		return consignee_num;
	}

	public void setConsignee_num(String consignee_num) {
		this.consignee_num = consignee_num;
	}
}
