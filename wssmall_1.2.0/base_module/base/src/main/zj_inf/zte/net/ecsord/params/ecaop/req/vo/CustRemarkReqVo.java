 ...
 *
 */
public class CustRemarkReqVo implements Serializable {

	private String customerRemarkId; // Y 客户备注ID
	private String customerRemarkValue; // Y客户备注信息
	
	public String getCustomerRemarkId() {
		if (StringUtils.isBlank(customerRemarkId)) return null;
	...
	public String getCustomerRemarkValue() {
		if (StringUtils.isBlank(customerRemarkValue)) return null;
