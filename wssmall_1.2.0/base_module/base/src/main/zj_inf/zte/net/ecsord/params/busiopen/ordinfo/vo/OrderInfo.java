...
public class OrderInfo implements Serializable {
	...
	@ZteSoftCommentAnnotationParam(name = "订单兑换积分（支付订单所使用的积分）", type = "String", isNecessary = "N", desc = "订单兑换积分（支付订单所使用的积分）")
	private String orderPoints;
	
	@ZteSoftCommentAnnotationParam(name = "订单状态 0代表正常  1代表异常单", type = "String", isNecessary = "Y", desc = "订单状态 0代表正常  1代表异常单")
	private String expStatus;
	
	@ZteSoftCommentAnnotationParam(name = "异常信息", type = "String", isNecessary = "N", desc = "异常信息")
	...
	@ZteSoftCommentAnnotationParam(name = "订单处理轨迹", type = "String", isNecessary = "N", desc = "订单处理轨迹")
	private List<History_TrackingInfo> history_TrackingInfo;
	...
	public List<History_TrackingInfo> getHistory_TrackingInfo() {
		return history_TrackingInfo;
	}

	public void setHistory_TrackingInfo(
			List<History_TrackingInfo> history_TrackingInfo) {
		this.history_TrackingInfo = history_TrackingInfo;
	}
