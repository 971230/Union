...
import zte.net.ecsord.params.sr.vo.RecycleCardData;
...
public class RevertCardRequset extends ZteRequest {
	...
	@ZteSoftCommentAnnotationParam(name = "请求协议", type = "String", isNecessary = "N", desc = "data：请求协议")
	private RecycleCardData notNeedReqStrData;
	...
	public RecycleCardData getNotNeedReqStrData() {
		if (null == this.notNeedReqStrData) {
			this.notNeedReqStrData = new RecycleCardData();
	...
	public void setNotNeedReqStrData(RecycleCardData notNeedReqStrData) {
	...
	public String getApiMethodName() {
		return "com.zte.unicomService.sr.revertCard";
	}
