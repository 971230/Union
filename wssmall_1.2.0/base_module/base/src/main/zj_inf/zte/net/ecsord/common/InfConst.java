...
public class InfConst {
	...
	public static final String OLD_ORDER_SYS_REQ_ID = "newOrder"; // 同步订单信息给老订单系统-请求ID
	/***** 接口请求类型结束 ******/
	...
	public static final String SR_GET_WORK_STATION = "GetWorkStation";//获取写卡工位状态
//	public static final String SR_WRITECARD_KEY = "D4C3C86EF4DE4FD3AA7872EAA746A774";//key值
	...
	public static final String SR_BATCHGETSTATE = "batchGetstate";//批量获取写卡机状态
	...
	public static final String ORDER_DEAL_INFO = "2004"; // 订单处理轨迹
