 ...
 *
 */
public class OpenDealApplyCustomerInfoVo implements Serializable {
	...
	private List<OpenDealApplyNewCustomerInfoVo> newCustomerInfo; // 新客户信息
	...
	public List<OpenDealApplyNewCustomerInfoVo> getNewCustomerInfo() {
		if (newCustomerInfo==null || newCustomerInfo.size()<=0) return null;
		return newCustomerInfo;
	}
	public void setNewCustomerInfo(
			List<OpenDealApplyNewCustomerInfoVo> newCustomerInfo) {
