...
//	private String prodOfferCode;
	...
	@ZteSoftCommentAnnotationParam(name = "销售商品名称", type = "String", isNecessary = "Y", desc = "销售商品名称")
	private String sale_goodsname;
	
	@ZteSoftCommentAnnotationParam(name = "商品数量", type = "String", isNecessary = "Y", desc = "商品数量")
	private String prodOffernum;
...
//	}
	...
	public String getSale_goodsname() {
		return sale_goodsname;
	}

	public void setSale_goodsname(String sale_goodsname) {
		this.sale_goodsname = sale_goodsname;
	}

	public String getProdOffernum() {
		return prodOffernum;
	}

	public void setProdOffernum(String prodOffernum) {
		this.prodOffernum = prodOffernum;
	}
