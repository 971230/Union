...
public class QryEopBillReq extends ZteRequest<QryEopBillResp>{
	...
	public void check() throws ApiRuleException {
		...
		if(billing_cycle==null || "".equals(billing_cycle))CommonTools.addError(new ZteError(ConstsCore.ERROR_FAIL, "账期"));
	...
	public String getApiMethodName() {
		return SysConst.API_PREFIX + "qryEopBill";
	}
