...
/**
 * 物流公司将订单的状态通知给订单系统 接口    返回给南都订单信息实体
 * @author jun
 *
 */
public class StatuRespOrderInfo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7635648464959861934L;
