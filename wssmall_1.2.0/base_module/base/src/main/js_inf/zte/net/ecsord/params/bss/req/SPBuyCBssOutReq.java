 ...
 * 2015-1-28
 */
public class SPBuyCBssOutReq extends ZteRequest<SPBuyCBssOutResp> {
	
	private String loginUser; // 登录用户
	private String loginPsw; // 登录密码（加密后的密文，加密方式问cBss系统）
	private String ProvinceCode="51"; // 省份ID（默认"51"广东）
	...
	private String take_effect_type=""; // 生效方式（0-立即生效，1-下月生效），默认"0"
	...
	public String getApiMethodName() {
		// TODO Auto-generated method stub
		return "zte.net.ecsord.params.bss.req.spbuycbsslogincert";
	}
