 ...
 * 入参对象
 */
public class SynSerialNumWMSReq extends ZteRequest<SynSerialNumWMSResp>{
	...
	@ZteSoftCommentAnnotationParam(name="请求类型",type="String",isNecessary="Y",desc="请求类型,固定值：at_syn_series_num")
	private String reqType;
	@ZteSoftCommentAnnotationParam(name="请求时间",type="String",isNecessary="Y",desc="请求时间，格式：yyyy-mm-dd HH:mi:ss")
	private String reqTime;
	@ZteSoftCommentAnnotationParam(name="订单信息",type="List<SynSerialOrderInfoVo>",isNecessary="Y",desc="订单信息")
	private SynSerialOrderInfoVo orderInfo;
	...
	public String getApiMethodName() {
		...
		return "com.zte.unicomService.wms.synchronousSerialNumberWMS";
	}
	...
	public SynSerialOrderInfoVo getOrderInfo() {
		return orderInfo;
	}

	public void setOrderInfo(SynSerialOrderInfoVo orderInfo) {
