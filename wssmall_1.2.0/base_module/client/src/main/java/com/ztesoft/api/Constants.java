...
public abstract class Constants {
	...
	/** TOP FJSON 应格式 */
	public static final String FORMAT_F_JSON = "fjson";
	
	/** MD5签名方式 */
	public static final String SIGN_METHOD_ROP = "rop";
	...
	/** SDK版本号 */
	public static final String SDK_VERSION = "top-sdk-java-20131225";
