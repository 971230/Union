 ...
 */
public abstract class ZteUtils {
	private static String localIp;
	private ZteUtils() {}

    
	  //获取秘钥串
	  public static String encryptSHA(String app_secret, RequestParametersHolder requestHolder) {
	        //if (null == param) return null;

	       // Gson gson = new Gson();
	       // Map<String, String> form = gson.fromJson(gson.toJson(param), Map.class);
	        ...
	        //form.remove("sign");
	       // form.remove("appSecret");
	        //form.remove("serverUrl");
	        //form.remove("logined_id");
	       // form.remove("param_json");
	        
//	        List<String> paramNames = new ArrayList<String>(form.size());
//	        paramNames.addAll(form.keySet());
//	        Collections.sort(paramNames);
//
//	        
//	        for (String paramName : paramNames) {
//	            sb.append(paramName).append(form.get(paramName));
//	        }
	        sb.append(app_secret);
	        ...
	        try {
	            ...
	            byte[] bytes = md.digest(sb.toString().getBytes(Constants.CHARSET_UTF8));
...
//	}
	 ...
	 * @return API响应对象
	 */
//	public static <T extends ZteResponse> T parseResponse(String json, Class<T> clazz) throws ApiException {
