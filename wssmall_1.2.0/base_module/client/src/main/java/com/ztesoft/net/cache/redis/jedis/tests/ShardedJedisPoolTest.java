...
public class ShardedJedisPoolTest extends Assert {
    ...
    public static void main(String[] args) {
    	ShardedJedisPoolTest test = new ShardedJedisPoolTest();
    	
    	test.startUp();
    	
    	test.shouldReturnActiveShardsWhenOneGoesOffline();
    }
	...
	shards.add(new JedisShardInfo("10.45.47.168", 6379));
	shards.add(new JedisShardInfo("10.45.47.168", 6379));
	shards.add(new JedisShardInfo("10.45.47.168", 63791));
	shards.add(new JedisShardInfo("10.45.47.168", 63792));
