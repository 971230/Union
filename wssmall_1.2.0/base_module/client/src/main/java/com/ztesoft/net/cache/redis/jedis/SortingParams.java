...
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.ALPHA;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.ASC;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.BY;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.DESC;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.GET;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.LIMIT;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.NOSORT;
