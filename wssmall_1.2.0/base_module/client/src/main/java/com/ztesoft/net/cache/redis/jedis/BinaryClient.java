...
import com.ztesoft.net.cache.redis.jedis.Protocol.Command;
import com.ztesoft.net.cache.redis.jedis.Protocol.Keyword;
...
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.*;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.EXISTS;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.PSUBSCRIBE;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.PUNSUBSCRIBE;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.SUBSCRIBE;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Command.UNSUBSCRIBE;
import static com.ztesoft.net.cache.redis.jedis.Protocol.Keyword.*;
import static com.ztesoft.net.cache.redis.jedis.Protocol.toByteArray;
