...
import com.ztesoft.api.FileItem;
...
public abstract class WebUtils {
	...
	private static String _doPost(String url, String ctype, byte[] content,
		...
		try {
			try {
				...
				ZteLogger.logCommError(e, url, map.get("app_key"),
			...
			try {
				...
				Map<String, String> map = getParamsFromUrl(url);
				ZteLogger.logCommError(e, conn, map.get("app_key"),
						map.get("method"), content);
				throw e;
			}
	...
	public static void addCookie(String key, String value,
			HttpServletResponse response, HttpServletRequest request, int maxAge) {
		try {
	...
	public static InputStream getRemoteImg(String urlPath){
