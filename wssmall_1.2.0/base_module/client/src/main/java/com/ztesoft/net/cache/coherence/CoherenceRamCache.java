...
public class CoherenceRamCache implements ICoherenceCache {

	private CoherenceRamCache() {
	}

	private static final CoherenceRamCache cohe = new CoherenceRamCache();

	public static CoherenceRamCache getCache() {
		return cohe;
	}
...
//	}
	...
	public void clear(String objectname) {
		getCacheByObjectName(objectname).clear();
	}
	...
	private String getCacheName(String objectName) {
		return new StringBuffer().append("dist-ram-").append(objectName).toString();
	}
