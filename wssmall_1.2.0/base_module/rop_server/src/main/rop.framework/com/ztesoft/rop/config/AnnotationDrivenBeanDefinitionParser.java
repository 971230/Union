...
import com.ztesoft.rop.route.impl.AnnotationServletServiceRouterFactoryBean;
...
import com.ztesoft.rop.security.ReadDbBaseAppSecretManager;
	 ...
	 public static final int DEFAULT_CORE_POOL_SIZE = 200;
	    ...
	    private RuntimeBeanReference getAppSecretManager(Element element, Object source, ParserContext parserContext) {
	        ...
	        if (element.hasAttribute("app-secret-manager")) {
	            ...
	            RootBeanDefinition appSecretManagerDef = new RootBeanDefinition(ReadDbBaseAppSecretManager.class);
	            ...
	            if (logger.isInfoEnabled()) {
	                logger.info("使用默认的密钥管理器:" + ReadDbBaseAppSecretManager.class.getName());
	            }
	        }
