 ...
 * 日    期：12-4-17
 */
package com.ztesoft.rop.request;


import com.ztesoft.rop.common.RopException;
import com.ztesoft.rop.common.RopRequestParseException;
...
public class RopRequestMessageConverter implements ConditionalGenericConverter {
	...
	public Object convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
        try {
            if (SimpleRopRequestContext.messageFormat.get().equals("json")) {//输入格式为JSON
