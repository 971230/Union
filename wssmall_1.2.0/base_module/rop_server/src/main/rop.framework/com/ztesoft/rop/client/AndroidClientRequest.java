...
public class AndroidClientRequest implements ClientRequest {
    ...
    public AndroidClientRequest(RopClient ropClient, String appKey,
                                String msgType, Locale locale, String appSecret,
                                String serverUrl) {
        //
...
*/
    ...
    private <T> CompositeResponse post(Class<T> ropResponseClass,
        ...
        HttpEntity<String> entity = new HttpEntity(toMultiValueMap(requestParams), createHttpHeader());
    ...
    private HttpHeaders createHttpHeader() {
       ...
       /* headers.setCacheControl("max-age=1");*/
        ...
        headers.set("Connection", "close"); //close
               ...
               // logger.info("field.getType()==" + field.getType());
                ...
                try {
                    if (convertor != null) {// 有对应转换器
                        ...
                        String message = MessageJsonMarshallerUtils.getMessage(fieldValue, mf);
