...
public class RestTemplate extends InterceptingHttpAccessor implements RestOperations {
	...
	private class HttpEntityRequestCallback extends AcceptHeaderRequestCallback {
		...
		private HttpEntityRequestCallback(Object requestBody, Class<?> responseType) {
			...
			if (requestBody instanceof HttpEntity) {
				...
				//this.requestEntity =  new UrlEncodedFormEntity(requestBody, "UTF-8"); 
			}
			else {
	...
	@Override
	public <T> ResponseEntity<T> exchange(URI arg0, HttpMethod arg1,
			HttpEntity<?> arg2, ParameterizedTypeReference<T> arg3)
			throws RestClientException {
	...
	@Override
	public <T> ResponseEntity<T> exchange(String arg0, HttpMethod arg1,
			HttpEntity<?> arg2, ParameterizedTypeReference<T> arg3,
			Object... arg4) throws RestClientException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public <T> ResponseEntity<T> exchange(String arg0, HttpMethod arg1,
			HttpEntity<?> arg2, ParameterizedTypeReference<T> arg3,
			Map<String, ?> arg4) throws RestClientException {
		// TODO Auto-generated method stub
		return null;
	}
