...
/*	static{
	...
	private static void init(){
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil
				.getAddresses(Config.get("uba.memcached.servers")));
		builder.setSessionLocator(new KetamaMemcachedSessionLocator());
		//连接池
		builder.setConnectionPoolSize(Integer.parseInt(Config.get("uba.memcached.poolsize")));  
		...
		try {
			...
			client.setOpTimeout(CacheValues.MEMCACHE_TIMEOUT) ;
