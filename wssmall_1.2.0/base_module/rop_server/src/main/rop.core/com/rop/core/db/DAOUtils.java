...
import com.rop.core.utils.DateFormatUtils;
...
public class DAOUtils {
	...
	public static String getFormatedDate() {
		SimpleDateFormat dateFormator = new SimpleDateFormat(DateFormatUtils.DATE_TIME_FORMAT);
	...
	public static String getFormatedDbDate(Connection conn) throws Exception {
		...
		return new SqlMapExe(conn).querySingleValue(mainSql);
	...
	public static String getShortFormatedDate() {
		SimpleDateFormat dateFormator = new SimpleDateFormat(DateFormatUtils.DATE_FORMAT);
		return dateFormator.format(new Date(System.currentTimeMillis()));
	}
