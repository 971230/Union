...
public class testAopOld23to4{
	...
	public static String url = "http://127.0.0.1:10081/aop/aopservlet";
	//员工信息查询
	...
	public static String bizkey6 = "TS-4G-001";		 
	//23转4开户处理申请
	...
	//订单查询
	public static String method19 = "ecaop.trades.query.comm.cust.mcheck";	
	public static String bizkey19 = null;	
	...
	public static String request(String apptx,String phoneBssOccupyRequestBean){
	    ...
	    if(bizkey!=null)list.add(new BasicNameValuePair("bizkey", bizkey));
...
//				"\"areaCode\":\"\"," +
				if(checkType.equals("1"))jsonStr19 += "\"serialNumber\":\""+resourcesCode+"\"," ;
				if(checkType.equals("0"))jsonStr19 += "\"certType\":\""+certType+"\"," ;
				if(checkType.equals("0"))jsonStr19 += "\"certNum\":\""+certNum+"\",";
				jsonStr19 += "\"serType\":\""+serType+"\"}";
				
		String[] jsonStrs = new String[]{jsonStr0,jsonStr1,jsonStr2,jsonStr3,jsonStr4,jsonStr5,jsonStr6,jsonStr7,
				jsonStr8,jsonStr9,jsonStr10,jsonStr11,jsonStr12,jsonStr13,jsonStr14,jsonStr15,jsonStr16,jsonStr17,
				jsonStr18,jsonStr19};
	...
	public static String operatorId = "GZLT1476";//GZLT0051
	public static String province = "51";
	public static String city = "510";//广州510	
	public static String district = "000000";
	public static String channelId = "51b3z13";//51a1625
	public static String channelType = "2010200";//1020200
	public static String developerId= "5102942675";//5102942675
	public static String developerName= "W增城中小企源浚公司";		

	public static String opeSysType = "2";//办理业务系统：1：ESS2：CBSS
	public static String opeSysTypeQry = "2";//
	
	public static String custName = "徐博";//开户人姓名
	public static String certType = "02";
	public static String certNum = "430624198911104055";
	public static String contactNum = "18617037711";

	public static String custId="2013022839466529";
	public static String userId="2013022844111311";
	public static String userPasswd="";

	public static String orderId = "2015112617595966";

	public static String productId = "99002139";//99002308
	...
	public static String resourcesCodeMobile = "51AP091001144254001";
	...
	public static String provOrderId = "5115112458696706";
	public static String essOrigOrderId = "5115112458696706";
	public static String essSubscribeId = "5115112458696706";
	...
	public static String checkType ="0";
	public static String serType ="1";
	public static String resourcesCode = "18520104271";//办理号码
	...
	public static void main(String[] args) throws Exception {
		...
		//12、套餐变更撤单 13、流量包订购 14、用户资料校验三户返回 15、换机 16、退机处理申请 17、退机提交 18、订单查询 19、客户校验
		request(apptx,
				makeJsonStr(18,"P512015427942379056"));
	}
}
