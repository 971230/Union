...
//				"\"forceCancel\":\"\"" +//强制撤单标识	可空非必传。	1：强制撤单	不传：非强制撤单
		...
		String jsonStr13 = "{\"operatorId\":\""+operatorId+"\"," +
				...
				"\"money\":\"5\"," +//金额，单位是？
				"\"count\":\"5000\"," +//资源量，如何理解？
				"\"validTime\":\"20150901\"," +//当前资源有效时间，生效时间？格式是？
				"\"validCalculateType\":\"0\"," +//有效期计算方式	0：日期顺延	1：截止日月底（暂不需支撑）
...
//				"\"brokenRe\":\"\"" +//故障原因
	...
	public static String custName = "KIM JOONBOM";
	public static String certType = "08";
	public static String certNum = "M53500352";
	public static String contactNum = "18664212687";

	public static String custId="2011072426264849";
	public static String userId="2011072425867937";
	public static String userPasswd="";

	public static String orderId = "1415001548024002";
	...
	public static String serviceClassCode = "0001";//电信业务类别（电信业务类别）0000是移网   0100是固网
	public static String areaCode = "";
	public static String infoList = "CUST|USER|ACCT";//CUST|USER|ACCT：对应客户、用户和账户
	
	public static String resourcesCode = "13265174574";
	...
	public static void main(String[] args) throws Exception {
		...
		request(apptx,
				makeJsonStr(13,"P512015427942379056"));
	}
}
