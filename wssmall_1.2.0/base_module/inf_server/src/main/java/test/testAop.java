...
public class testAop{
	...
	public static String request(String url,String appkey,String method,String apptx,String phoneBssOccupyRequestBean){
	    ...
	    //list.add(new BasicNameValuePair("bizkey", "TS-3G-005"));
...
//				"\"areaCode\":\"\"," +
		...
		String jsonStr5 = "{\"operatorId\":\""+operatorId+"\"," +
				...
				"\"channelId\":\""+channelId+"\"," +
				"\"channelType\":\""+channelType+"\"," +
				//"\"ossOperId\":\"HLWFS679\",\"operFlag\":\"3\","+
				"\"resourcesInfo\":[" +
				"{" +
					"\"resourcesType\":\"01\"," +
					"\"resCodeType\":\"01\"," +
					"\"resourcesCode\":\"867622021903532\"," +
					"\"occupiedFlag\":\"0\"," +
					"\"occupiedTime\":\""+occupiedTime+"\"," +
					"\"allocationFlag\":\"1\"}" +
//				",{" +
...
//							",\"productCode\":\"\"" +
					"}," +
					"{" +
						"\"productId\":\"89096193\"," +//产品标识
						"\"productMode\":\"2\"" +//产品模式 1：主产品2：附加产品
//						",\"packageElement\":[{" +
//							"\"packageId\":\"51000386\"," +//包编号
//							"\"elementId\":\"78880000\"," +//元素编号
//							"\"elementType\":\"A\"}]" +//元素类型
...
//							"\"elementId\":\"78880000\"," +//元素编号
//							"\"elementType\":\"A\"}]" +//元素类型							
//						",\"resourcesType\":\"03\"," +//资源类型 03：移动电话04：上网卡05：上网本
...
//						"\"activityFee\":\"\"" +//活动预存费用
					"}]," +					 
//							"\"groupFlag\":\"1\" ," +//集团标识 0：非集团用户1：集团用户
...
//						
//				",\"resourcesInfo\":[{" +
//					"\"salePrice\":\"1399000\"," +//销售价格（单位：厘）
//					"\"cost\":\"999000\"," +//成本价格（单位：厘）
////					"\"cardPrice\":\"\"," +//卡费（单位：厘）
...
//					"\"resourcesBrandCode\":\"XM\"," +//品牌
//					"\"orgDeviceBrandCode\":\"XM\"," +//3GESS维护品牌，当iphone时品牌与上面的一致
//					"\"resourcesBrandName\":\"小米\"," +//终端品牌名称
//					"\"resourcesModelCode\":\"517401401602163312005\"," +//型号
//					"\"resourcesModelName\":\"小米 2S黑\"," +//终端型号名称
//					"\"resourcesSrcCode\":\"1\"," +//终端来源编码
////					"\"resourcesSupplyCorp\":\"\"," +//终端供货商名称
////					"\"resourcesServiceCorp\":\"\"," +//终端服务商名称
//					"\"resourcesColor\":\"黑\"," +//终端颜色
//					"\"machineTypeCode\":\"7401401602\"," +//终端机型编码
//					"\"machineTypeName\":\"小米 2S黑\"," +//终端机型名称
...
//				"\"invoiceNo\":\"3\" }]," +  //支付账号+ //发票号码
				"\"origTotalFee\":\"120000\"," +//总费用正整数，单位：厘	
			 	"\"acceptanceReqTag\":\"1\"," + 
			 	"\"payInfo\":{\"payType\":\"10\"," +//支付方式参考附录支付方式说明现金，不填写支付机构和支付账号
//				"\"payOrg\":\"工商银行\"," +//支付机构名称
//				"\"payNum\":\"201507166311174814\"" +
				"}" +
			"}";
		//写卡数据查询
		String jsonStr8 = "{\"operatorId\":\""+operatorId+"\"," +
				...
				"\"reDoTag\":\"1\"," +//重复查询标记 0：首次读卡 1：重复读卡 2: 重复写卡
				"\"opeSysType\":\"2\"," +//办理业务系统：1：ESS2：CBSS
				//"\"procId\":\"\"," +//读卡序列（首次为空）
...
//				"}]," +
	...
	public static void main(String[] args) throws Exception {
		...
		//终端状态查询变更		
		String method5 = "ecaop.trades.query.resi.term.autochg";		
		//开户处理申请
		String method6 = "ecaop.trades.sell.mob.newu.open.app";		
		//开户处理提交
		String method7 = "ecaop.trades.sell.mob.newu.open.sub";		
		//写卡数据查询
		String method8 = "ecaop.trades.sell.mob.comm.carddate.autoqry";		
		//写卡结果通知
		String method9 = "ecaop.trades.sell.mob.comm.cardres.notify";		
		//开户卡数据同步
		String method10 = "ecaop.trades.sell.mob.newu.opencarddate.syn";

		String url = "http://127.0.0.1:10081/aop/aopservlet";
		String orderId = "20157161042464103";
		String operatorId = "HLWGZ679";//GZLT0051
		String province = "51";
		String city = "510";//广州510	
		String district = "512039";
		String channelId = "51b3vud";//51a1625
		String channelType = "1010400";//1020200
		String developerId= "5105305871";//5102942675
		String developerName= "佛山市禅城区坚通电讯经营部（乐天电讯）";
		String channelIdDev = "51b1jbq";
		String custName = "闫仁航";
		String certType = "02";
		String certNum = "130428198905110321";
		String contactNum = "18520995392";
		String occupiedTime = "20151125235900";
		String productId = "99999830";
		String actPlanId="89000100";//总部活动编码
		String resourcesCodeMobile = "867622021896751";
		String bipType = "1";//业务类型：1：号卡类业务2：合约类业务3：上网卡4：上网本5：其它配件类6：自备机合约类业务
		String iccid ="8986011485106347132";
		String provOrderId = "5115071686477482";//5115051862808467
		String imsi="460010992513782";
		String procId="51202507160000000020523082";
		String capacityTypeCode="1000101";
		String resKindCode="08";
		String cardData = "\nYcpgCO5kExwjBlWGPKVSFAVTo1cwjifGiyYr";
		...
		request(url,
				...
				method5,
				apptx,
				makeJsonStr(5, url, operatorId, province, city,district, channelId, channelType, "18675092404",						
						developerId, developerName, channelIdDev, "20150716104103285719",custName, certType, certNum, contactNum, occupiedTime,						
						productId,resourcesCodeMobile,bipType,iccid,orderId,provOrderId,imsi,capacityTypeCode,resKindCode,actPlanId,"2",
						procId,cardData));
	}
}
