...
public class testAop2{
	...
	public static String request(String url,String appkey,String method,String apptx,String phoneBssOccupyRequestBean){
	    ...
	    list.add(new BasicNameValuePair("bizkey", "CS-011"));//TS-3G-005
...
//				"}]," +
	...
	public static void main(String[] args) throws Exception {
		...
		String url = "http://127.0.0.1:10080/aop/aopservlet";
		String orderId = "20157161011343278";
		String operatorId = "HLWGZ679";//GZLT0051
		String province = "51";
		String city = "510";//广州510	
		String district = "51a0np";
		String channelId = "51b0gws";//51a1625
		String channelType = "1030100";//1020200
		String developerId= "5104571161";//5102942675
		String developerName= "孙文娟";
		String channelIdDev = "51b1jbq";
		String custName = "闫仁航";
		String certType = "02";
		String certNum = "411302198607091854";
		String contactNum = "18520995392";
		String occupiedTime = "20150525235900";
		String productId = "99999830";
		String actPlanId="20140619244002";//总部活动编码
		String resourcesCodeMobile = "865773029266430";
		String bipType = "2";//业务类型：1：号卡类业务2：合约类业务3：上网卡4：上网本5：其它配件类6：自备机合约类业务
		String iccid ="8986011485106347119";
		String provOrderId = "5115071685946981";//5115051862808467
		String imsi="460010992513775";
		String procId="51202507160000000020384314";
		String capacityTypeCode="1000101";
		String resKindCode="08";
		String cardData = "\nfyLHVcalC+Ujj+d895aP3ES+BP0hbia7kQZx";
		...
		request(url,
				...
				method5,
				apptx,
				makeJsonStr(4, url, operatorId, province, city,district, channelId, channelType, "18566476735",						
						developerId, developerName, channelIdDev, "20150716152625799362",custName, certType, certNum, contactNum, occupiedTime,						
