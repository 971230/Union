...
public class HttpPostMsgBSSInvoker extends Invoker{
	...
	public Object invoke(InvokeContext context) throws Exception {
        ...
        Object	new_map=paramMap;
        paramMap=new HashMap<String, String>();
        paramMap.put("msg", new_map);
...
//            	resContent = "{\"code\":\"9999\",\"detail\":\"未知(aop@!@#$%^&~:{}|?><<*()[]/.,';未返回错误描述)\"}";
            ...
            if (result != null) {
                ...
                resContent = resContent.replace("\"serial_num\":", "\"bms_accept_id\":");
