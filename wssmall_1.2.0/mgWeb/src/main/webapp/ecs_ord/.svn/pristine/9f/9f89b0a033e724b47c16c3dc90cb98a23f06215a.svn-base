...
<!-- 号码开户信息开始 -->
                        ...
                        <table width="100%" border="0" cellspacing="0" ceqllpadding="0" class="grid_form">
                            <tr>
                               ...
                               <th>新/老用户：</th><!-- 卡种类 -->
                               <td>
                                	<html:orderattr  attr_code="DC_CUSTOMER_USER_TYPE"  order_id="${order_id}"  field_name="is_old"  field_desc ="新/老用户" field_type="select"></html:orderattr>
                               </td>
                            </tr>
                            <tr>
                               <th>共享子号：</th>
               	    ...
               	    <!-- 号码开户信息结束 -->
               	  	<div id="phoneInfoDiv">
               	  	     <jsp:include page="phone_info.jsp?order_id=${order_id }&order_amount=${order_amount}&isChangePhone=${isChangePhone} }"/>
					</div>
               	  	<%} %>
