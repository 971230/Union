...
<script type="text/javascript" src="<%=request.getContextPath()%>/ecs_ord/order/onlinecustomwork/js/write_card.js"></script>
                ...
                <div class="grid_n_cont">
                	<div class="grid_n_cont_sub">
                    	<h3>开户对象：套卡<span id="custNum"><a id="phone_num"></a></span>
                    	  	...
                    	  	<a id="open_acct_btn" onclick="writeCard();" class="blue_b" style="margin-left:5px;cursor: pointer;">写卡</a>
	                    </h3>
