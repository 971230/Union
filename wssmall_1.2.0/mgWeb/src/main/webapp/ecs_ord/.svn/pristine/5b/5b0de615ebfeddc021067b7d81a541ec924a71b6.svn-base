...
<title>3G开户白打免填单</title>
    ...
    <tr height="36px">
      <td width="884px" colspan="5" rowspan="2" align="center" bgcolor="#FFFFFF" class="titlebox" height="19px">
        ...
        <div style="display:inline;"> 
          <div class="titleword" style="margin-top:20px;">中国联合网络通信有限公司<u><span id="provinceId"></span></u>分公司移动业务客户入网登记单（预付费）</div>
  ...
  <table cellpadding="0" cellspacing="0" bgcolor="#000000" border="0px;" width="884px">
    <tr height="25px">
      <td bgcolor="#FFFFFF" width="30px;">&nbsp;</td>
      ...
      <td bgcolor="#FFFFFF" width="317px;" id="custType"></td>
    </tr>
  ...
  <table cellpadding="0" cellspacing="0" bgcolor="#000000" border="0px;" width="884px">
    <tr height="25px">
      ...
      <td bgcolor="#FFFFFF" width="257px;" id="userType"></td>
  ...
  <table  cellpadding="0" cellspacing="0" bgcolor="#000000" border="0px;" width="884px" >
    ...
    <tr height="20px">
      <td bgcolor="#FFFFFF" width="15px;"/>
      <td bgcolor="#FFFFFF" class="secondtitle" width="412px"/>
      <td bgcolor="#FFFFFF" class="secondtitle" width="140px">受理人及工号</td>
      <td bgcolor="#FFFFFF"  width="317px;">${bss_operator }
      </td>
    </tr>
    <tr height="20px">
      <td bgcolor="#FFFFFF" width="15px;" rowspan="2">&nbsp;</td>
