...
<script type="text/javascript" src="<%=request.getContextPath()%>/ecs_ord/order/onlinecustomwork/js/write_card_error.js"></script>
...
<body style="background: white;">	
	...
	<div id="div_btn" class="pop_btn" align="center">
		<a id="roll_back_btn" onclick="rollBack();" class="blue_b" style="margin-right: 10px;cursor: pointer;""><span id="span_goto">返回</span></a>
		<a id="re_try_btn" onclick="reTry();" class="blue_b" style="margin-left:5px;cursor: pointer;"><span id="span_re_try">重试</span></a>
		<a id="print_card_btn" onclick="doPrintCard();" class="blue_b" style="margin-left:5px;cursor: pointer;">号卡领取热敏单打印</a>
	</div>
</body>
