        	        ...
        	        <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                          	...
                          	<tr>
                                ...
                                <td>
                                    <html:orderattr attr_code="DC_MODE_REGION" order_id="${order_id}" field_name="order_city_code"  field_desc ="归属地市" field_type="select" ></html:orderattr>
                            	</td>
                                <th><span>*</span>渠道标记：</th>
                                <td>
                                   <html:orderattr attr_code="DIC_CHANNEL_MARK" order_id="${order_id}" field_name="channel_mark"  field_desc ="渠道标识" field_type="select"></html:orderattr>
                            	 </td>
                          	</tr>
                          	<tr>
                                <th>发展人编码：</th>
                                ...
                                --%>
                                <td><html:orderattr  order_id="${order_id}"  field_name="development_code"  field_desc ="发展人编码" field_type="input"></html:orderattr>
                                <input type="button" value="...." id="selDevelopmentBtn" class="graybtn1"/></td>
                                <th>发展人名称：</th>
                            ...
                            <tr>
                                <th>是否WMS发送 ：</th>
                                <td><html:orderattr attr_code="DC_IS_OR_NO"  order_id="${order_id}"  field_name="is_send_wms"  field_desc ="是否WMS发送"  field_type="select"></html:orderattr></td>
                                <th>异常类型：</th>
                               <td>
                                <html:selectdict name="abnormal_type"   curr_val="${abnormal_type}"    attr_code="ORDER_ABNORMAL_TYPE"  appen_options="<option>---请选择---</option>" style="border:1px solid #a4a4a4; height:18px; line-height:18px;width:200px; background:url(${context}/images/ipt.gif) repeat-x;"></html:selectdict>
                               </td>
                               <th>异常状态：</th>
                               <td><html:orderattr attr_code="DC_ABNORMAL_STATUS"  order_id="${order_id}"  field_name="abnormal_status"  field_desc ="异常状态" field_type="select"></html:orderattr></td>
        	        ...
        	        <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                            <tr>
                              	...
                              	<td>
                                    <html:orderattr   attr_code="DIC_PAY_TYPE" order_id="${order_id}" field_name="paytype"  field_desc ="支付类型"  field_type="select"></html:orderattr>
                            	</td>
                              	<th><span>*</span>支付方式：</th>
                              	<td>
                                   <html:orderattr   attr_code="DIC_PAY_WAY" order_id="${order_id}" field_name="pay_method"   field_desc ="支付方式" field_type="select"></html:orderattr>
                            	</td>
                            </tr>
                            <tr>
