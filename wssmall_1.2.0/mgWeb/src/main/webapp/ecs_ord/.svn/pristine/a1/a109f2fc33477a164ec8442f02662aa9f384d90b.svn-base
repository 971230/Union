                    ...
                    <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                            <tr>
                              	...
                              	<td><input  type="text" class="ipt_new" value="<%=CommonDataFactory.getInstance().getProductSpec(order_id, SpecConsts.TYPE_ID_10001, null, SpecConsts.GOODS_NAME) %>" id="textfield" style="width:200px;" /></td>
                                <th><span>*</span>合约期限：</th>
                              	<td><input name="package_limit" type="text"  class="ipt_new" value="<%=CommonDataFactory.getInstance().getProductSpec(order_id, SpecConsts.TYPE_ID_10001, null, SpecConsts.PACKAGE_LIMIT) %>" id="textfield" style="width:200px;" /></td>
