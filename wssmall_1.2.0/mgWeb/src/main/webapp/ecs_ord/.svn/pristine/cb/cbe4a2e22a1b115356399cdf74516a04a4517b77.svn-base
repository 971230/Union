...
System.out.println("性能测试****************************订单详情界面渲染工作流1总耗时："+(time2-time1));
try{
    ...
    System.out.println("性能测试****************************订单详情界面渲染工作流2总耗时："+(time3-time2));
    ...
    System.out.println("性能测试****************************订单详情界面渲染工作流3总耗时："+(time4-time3));
}catch(Exception ex){
	ex.printStackTrace();
}
