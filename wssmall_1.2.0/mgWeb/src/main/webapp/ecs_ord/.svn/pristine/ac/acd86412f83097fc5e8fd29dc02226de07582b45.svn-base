...
<%
	...
	Boolean isTerminalCheck = false;//泛智能终端数据
                	...
                	<div class="grid_n_cont_sub">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                          <tr>
                            ...
                            <td>
                            	<input type="text" value="${element_id}" readonly id ="element_id" readonly style="border:1px solid #a4a4a4;height:18px;line-height:18px">
                            </td>
                          </tr>
                          <tr>
                          	<th><span></span>终端串号：</th>
                            <td>
                            	<input type="text" value="${terminal_num }" readonly id = "mobile_imei" style="border:1px solid #a4a4a4;height:18px;line-height:18px">
                        ...
                        <tr>
                         ...
                         <tr>                          	
                              <th><span>*</span>开户费（元）：</th>
                                ...
                                <!-- BSS/ESS缴费款不在页面显示 -->
                                <th style="display: none"><span>*</span>BSS/ESS缴费款3：</th>
	                            <td style="display: none"><html:orderattr  order_id="${order_id}" field_name="busi_money"  field_desc ="BSS缴费款" field_type="input" field_value="0"></html:orderattr></td>
                         </tr>
