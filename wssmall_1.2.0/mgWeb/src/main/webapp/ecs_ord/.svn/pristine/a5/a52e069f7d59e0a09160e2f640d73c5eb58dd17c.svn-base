...
<tr>
<th>用户号码：</th>
<td><input type="text" value="${moneyAuditBaseData.phone_num }" readonly="readonly"></td>
<th>订单营业款：</th>
<td>
	<c:if test="${moneyAuditBaseData.order_type_return=='新增' }">
	   <input type="text" value="${moneyAuditBaseData.busi_money }" disabled="disabled">
	</c:if>
	<c:if test="${moneyAuditBaseData.order_type_return!='新增' }">
	   <input type="text" value="-${moneyAuditBaseData.busi_money }" disabled="disabled">
	</c:if>
...
<td>
	<c:if test="${moneyAuditBaseData.order_type_return=='新增' }">
		<input type="text" value="${moneyAuditBaseData.paymoney }" disabled="disabled">
	</c:if>
	<c:if test="${moneyAuditBaseData.order_type_return!='新增' }">
		<input type="text" value="-${moneyAuditBaseData.paymoney }" disabled="disabled">
	</c:if>
...
<tr>
<th>订单号：</th>
<td><input type="text" value="${moneyAuditBaseData.order_id }" style="font-size: 11px" readonly="readonly"></td>
<th>商城来源：</th>
...
<th>UDP：</th>
<td><input type="text"  value="${moneyAuditBaseData.audit_udp }" style="font-size: 11px" readonly="readonly"></td>
<th>稽核备注：</th>
<td><input type="text"  value="${moneyAuditBaseData.audit_remark }" disabled="disabled"></td>
</tr>
<tr>
<th>外部订单号：</th>
<td><input type="text"  value="${moneyAuditBaseData.out_tid }" style="font-size: 11px" readonly="readonly"></td>
<th></th>
<td></td>
<th></th>
<td></td>
