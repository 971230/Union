  ...
  <body>
     <div id="receiptDivId">
      <table cellpadding="0" cellspacing="1" width="880px">
       ...
       <tr style="height:19;">
           <td style="height:19;" colspan="5" class="tdcss1">温馨提示：</td>
           <td style="height:19;" colspan="5" class="tdcss1" width="524px;">${warmTips}</td>
       </tr>
