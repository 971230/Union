...
<%@ include file="/commons/taglibs.jsp"%>
                    ...
                    <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                            ...
                            <tr>
                                ...
                                <th>订单备注：</th>
								<td><html:orderattr style="height:50px;width:200px;"   order_id="${order_id}" field_name="service_remarks" cols="45"  rows="5" field_desc ="订单备注式" field_type="textarea" ></html:orderattr></td>
                            </tr>
                          <!--  <tr>
                              	<th>订单备注：</th>
                    ...
                    <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                            <tr>
                              	<th>回收方式：</th>
                              	<td><html:orderattr  order_id="${order_id}" field_name="file_return_type"  field_desc ="回收方式" field_type="input"></html:orderattr></td>
                              	<th>回收内容：</th>
