...
<body>
<form action="javascript:void(0);" id="returned_ord_cfm" method="post">
...
<div class="gridWarp">
	<div class="new_right">
        <div class="right_warp">
            ...
            <!-- 顶部公共 -->
        	<jsp:include page="auto_flows.jsp?order_id=${order_id }&btn=RETURNEDCONFIRM"/>
        	<!-- 订单基本信息开始-->
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
	                        ...
	                        <%--  <tr>
	                         ...
	                         <tr>
	                            ...
	                            <td><input type="text"   value="" disabled="disabled" class="ipt_new"/></td> --%>
	                            <th>资料回收方式：</th>
                                <td><html:orderattr disabled="disabled"  attr_code="DIC_RECOVERTY_TYPE" order_id="${order_id}" field_name="file_return_type"  field_desc ="资料回收方式" field_type="select"></html:orderattr></td>
	                         ...
	                         <tr>
                              	<th>买家留言：</th>
                              	<td><html:orderattr disabled="disabled" order_id="${order_id}" field_name="buyer_message" cols="45"   rows="5" field_desc ="买家留言" field_type="input" ></html:orderattr></td>
                            	<th>卖家留言：</th>
					...
					<div class="grid_n_cont">
			  		<div class="grid_n_cont_sub">
			              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_grid">
			                ...
			                <tr>
			                     <td><span style="color:red;padding-right: 3px">*</span>退单描述：</td>
			                     <td>${reasonDesc }</td>
			                   </tr>
			              <!-- 爬虫订单才显示 -->    
			               <%    
			                String order_model=CommonDataFactory.getInstance().getAttrFieldValue(order_id, AttrConsts.ORDER_MODEL);
			                if(EcsOrderConsts.ORDER_MODEL_07.equals(order_model)||EcsOrderConsts.ORDER_MODEL_08.equals(order_model)){%>  
			                	<tr>
			                		 <td><span style="color:red;padding-right: 3px">*</span>是否退款：</td>
				                     <td> 
