...
<div class="grid_n_div">
    <div class="grid_n_div">
		...
		<div class="grid_n_cont_sub">
          	<div class="open_more_div"><a href="javascript:void(0);" id="logs_hide_a" class="open_more show"><span>收起所有步骤信息</span><i class="arr"></i></a>
          	</div>
          	<div id="context_bd">
		...
		<div class="grid_n_cont_sub">
          	...
          	<div class="open_more_div"><a href="javascript:void(0);" id="exception_a" class="open_more"><span id="exp_show" style="display: none;">展开异常跟踪信息</span><span id="exp_hide">收起异常跟踪信息</span><i class="arr"></i></a>
          	</div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#exp_show").bind("click",function(){
			$("#context_exception").show();
			$("#exp_show").hide();
			$("#exp_hide").show()
		});
		$("#exp_hide").click(function(){
	    	$("#context_exception").hide();
	    	$("#exp_show").show();
			$("#exp_hide").hide()
	    });
