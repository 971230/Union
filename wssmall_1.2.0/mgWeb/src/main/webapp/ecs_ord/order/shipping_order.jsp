            		...
            		<div class="remind_div"><img src="${context}/images/ic_remind.png" width="16" height="16"><span></span></div>
                  	<div class="grid_n_cont_sub">
                    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_form">
                          ...
                          <tr>
                            <th>&nbsp;</th>
                            <td colspan="3" style="color:#F00;"> 订单处理类型：${deal_type} 闪电送物流公司：${quick_shipping_cop} 闪电送状态：${quick_shipping_status }
                            </td>
                          </tr>
                          </c:if>
                          <tr>
                            ...
                            <td>
                               <c:choose>
                               <c:when test="${flowCode !='cellphone_region_delivery_with_web_input'}">
                               ...
                               <select name="shipping_company" field_name="shipping_company" field_desc="物流公司"  id="logi_company" class="ipt_new" style="width:200px;">
									<option value="">---请选择---</option>
										...
										<option value="${logicompany.id }" <c:if test="${logiCompanyCode eq logicompany.id}">selected="selected"</c:if>>${logicompany.name }</option>
										</c:forEach>
								</select> 
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="">
                                      ...
                                      <tr>
                                        <th>发票号码：</th>
                           			  ...
                           			  <tr>
                                        <th>ICCID：</th>
		                              	<td><html:orderattr disabled="disabled"  order_id="${order_id}" field_name="ICCID"  field_desc ="iccid" field_type="input"></html:orderattr></td>
		                             	<th>终端串号：</th>
		                              	<td><html:orderattr disabled="disabled" order_id="${order_id}" field_name="object_esn"  field_desc ="终端串号" field_type="input"></html:orderattr></td>
                           			  </tr>
                           			  <tr>
                            <th>终端类型：</th>
                            <td>
