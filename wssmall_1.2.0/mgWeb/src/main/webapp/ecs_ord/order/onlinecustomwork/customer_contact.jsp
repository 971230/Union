...
$(function(){
	...
	OrderInfoTool.field_names = "out_tid,zb_inf_id,order_city_code,district_code,tid_time,"
		...
		+"carry_person_mobile,reference_phone,receiver_mobile,contact_results_frist,contact_results_second,cbss_develop_code,cbss_development_point_code";
	if (order_from=="10093" && save_terminal_cat_id==goods_cat ) {
		OrderInfoTool.change_fields = "district_code,phone_owner_name,cert_card_num,ship_name,"
			+"receiver_mobile,ship_addr,service_remarks,province_id,city_code,area_code,cert_address,"
