                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                           ...
                           <c:if test="${hide_div!='handle_input_area' }"> 
			                ...
			                <tr>
	                            	<th><span>*</span>备注：</th>
	                                <td colspan="5">
	                                  	<textarea id="node_deal_message" name="dealDesc" cols="45" rows="5" class='ipt_new' style="height:20px;width:600px;"></textarea>
	                            	</td>
	                            </tr>
        	        ...
        	        <!-- 订单基本信息结束 -->
							...
							<tr>
							 <th><span>*</span>商品大类：</th>
                                <td>
                                <%-- <html:orderattr  disabled="disabled"  order_id="${order_id}" attr_code="DC_MODE_GOODS_TYPE" field_name="goods_type"  field_desc ="商品类型" field_type="select"></html:orderattr> --%>
                                ${goods_type_name}
                                </td>
