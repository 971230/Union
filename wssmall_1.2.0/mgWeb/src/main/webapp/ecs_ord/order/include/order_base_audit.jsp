        	        ...
        	        <div class="grid_n_cont_sub">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_form">
                          	...
                          	<tr>
                                ...
                                --%>
                                <td><html:orderattr  order_id="${order_id}"  field_name="develop_code_new"  field_desc ="发展人编码" field_type="input" style="width: 165px;"></html:orderattr>
<!--                                 <input type="button" value="...." id="selDevelopmentBtn" class="graybtn1"/></td>
 -->                            <th>发展人名称：</th>
                                <td><html:orderattr  order_id="${order_id}" field_name="develop_name_new"  field_desc ="发展人名称" field_type="input"></html:orderattr></td>
                                ...
                                <td><html:orderattr disabled="disabled"  order_id="${order_id}" field_name="tid_time"   field_desc ="下单时间" field_type="date"></html:orderattr></td>
                                  ...
                                  <script>
		                          	$("[field_name='development_code']").blur(function(){
		                     	    	   ...
		                     	    	   var order_from = "${orderTree.orderExtBusiRequest.order_from}";
		                     	    	   alert(order_from);
                            ...
                            <tr>
                           	...
                           	<c:if test="${not empty orderTree.orderExtBusiRequest.refund_status &&  orderTree.orderExtBusiRequest.refund_status!='00'}">
	                          <th style="color:red;">退款状态：</th>
	                          <td>${pageDatas.get('refund_name')}</td>
                            </c:if>
