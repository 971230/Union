...
var PhoneList={
		 search:function(){
			 $("#queryBtnZb").unbind("click").bind("click",function(){
				 ...
				 var url= app_path+"/shop/admin/orderFlowAction!getPhoneNumList.do?ajax=yes&isQuery=yes&order_id="+order_id+"&queryTypeChooseReturnVal="+queryTypeChooseReturnVal+"&queryTypeZbChooseReturnVal="+queryTypeZbChooseReturnVal+"&infIsZb=yes&selNumChannel=zb";
