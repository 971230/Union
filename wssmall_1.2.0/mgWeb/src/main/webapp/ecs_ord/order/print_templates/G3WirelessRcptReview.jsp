    ...
    <div id="receiptDivId">
        ...
        <tr height="36px">
          ...
          >
            ...
            <div style="display: inline;">
              ...
              >
                中国联合网络通信有限公司
                <u><span id="provinceId"></span>
                </u>分公司移动业务客户入网登记单（预付费）
              </div>
              <div
                style="text-align: center; font-size: 14px; display: inline; margin-left: 300px; font-weight: bold;"
              >
                <input
                  name=""
                  type="checkbox"
              ...
              <div
                style="text-align: center; margin-left: 100px; font-size: 14px; display: inline; font-weight: bold;"
              >
                受理编号：
                <span></span>
              </div>
      ...
      >
        <tr height="25px">
          ...
          <td
            ...
            colspan="4"
          >
            本人证实上述资料属实,并已阅读及同意本登记表及相关资料等内容。预付费方式下客户需预存金额，当账户余额不足，须及时预存，否则不能正常使用。
          </td>
        </tr>
      </table>
      ...
      >
        ...
        <tr height="25px">
          ...
          <td
            bgcolor="#FFFFFF"
            style="font-size: 14px; text-indent: 28px;"
            colspan="3"
          >
        ...
        <tr height="25">
          <td
            ...
            class="wordMidtwo"
          >
            <span style="text-decoration: underline">客服热线：10010  充值专线:10011</span>
            <br />
            登陆中国联通网上营业厅www.10010.com,查询、交费、办业务，方便又实惠
          </td>
        </tr>
      </table>
