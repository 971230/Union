...
,{
	...
	getSyncTarget:function(){ 
		if(!this.syncTarget) {
			this.syncTarget = $("#wssapp_setting_con #wgt_preview>div" );
		}
...
enation.eop.WidgetSettingOperator,
{
	...
	getSyncTarget:function(){ 
		if(!this.syncTarget) {
			this.syncTarget = $("#wssapp_setting_con #wgt_preview>div .title" );
		}
		return this.syncTarget;
	}
}
...
enation.eop.WidgetSettingOperator,
{
	getSyncTarget:function(){ 
		if(!this.syncTarget) {
			this.syncTarget = $("#wssapp_setting_con #wgt_preview>div .content" );
		}
		return this.syncTarget;
	}
}
...
enation.eop.WidgetSettingOperator.TemplateOp={
	...
	init:function()	{
		...
		this.pWidget = $("#wssapp_setting_con #wgt_preview>div");
		 
	},
	bindChangeEvent:function(){
		var that = this;
		$("#wssapp_setting_con .wdg_tpl ul li").click(function(){
			$("#wssapp_setting_con .wdg_tpl ul li").removeClass("active");
			var li =$(this);
			li.addClass("active");
			that.changeTpl(li);
		});
