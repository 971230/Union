...
<div class="grid">
	...
	<grid:grid  from="uriList">
	  ...
	  <grid:body item="uri">
	        ...
	        <grid:cell><input type="text" class="ipttxt"  name="uri" value="${uri.uri }" style="width:200px" /> </grid:cell>
	        <grid:cell><input type="text" class="ipttxt"  name="path" value="${uri.path}" style="width:150px" /> </grid:cell> 
	        <grid:cell><input type="text" class="ipttxt"  name="pagename" value="${uri.pagename}" style="width:150px" /></grid:cell> 
	        <grid:cell><input type="text" class="ipttxt"  name="point" value="${uri.point}" style="width:100px" /></grid:cell>
	        <grid:cell>
