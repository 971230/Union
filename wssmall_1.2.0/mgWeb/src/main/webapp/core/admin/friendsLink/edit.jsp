  ...
  <input type="hidden" name="oldpic" value="${friendsLink.logo }" />
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" class="ipttxt"  name="friendsLink.name" maxlength="60" value="${friendsLink.name }"  dataType="string" required="true" />       </td>
      </tr>
      <tr>
       <th><label class="text">友情链接地址：</label></th>
       <td  ><input type="text" class="ipttxt"  name="friendsLink.url" maxlength="60" value="${friendsLink.url }"  dataType="string" required="true" /></td>
      </tr>
      <tr>
       <th><label class="text">排序：</label></th>
       <td  ><input type="text" class="ipttxt"  name="friendsLink.sort" maxlength="60" value="${friendsLink.sort }"  dataType="int" /></td>
      </tr>
      <tr>
