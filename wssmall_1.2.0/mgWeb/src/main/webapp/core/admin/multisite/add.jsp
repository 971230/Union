...
<table  class="form-table">
	<tr>
		...
		<td><input type="text" class="ipttxt"  name="site.name"  dataType="string" required="true" style="width:250px"/></td>
	</tr>
	<tr>
       <th><label class="text">父站点：</label></th>
       <td><select  class="ipttxt"  name="site.parentid" id="siteparent"/></td>
     </tr>
     <tr>
       <th><label class="text">指定站点域名：</label></th>
       <td><input type="text" class="ipttxt"  name="site.domain" id="sitedomain"   dataType="string" required="true"  style="width:250px"/></td>
     </tr>
      <tr>
