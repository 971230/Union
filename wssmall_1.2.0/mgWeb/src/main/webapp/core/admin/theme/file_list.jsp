...
新文件名：<inptype="text" class="ipttxt" xt" name="newName" id="newName"  /> 
</div>
</form>
...
<input type="hidden" name="type" value="${type }" />
<div id="addcontent">
名称：<inptype="text" class="ipttxt" xt" name="name" id="newFolderName"  /> 
</div>
</form>
<div class="footContent" >
<div style="width: 200px; height: 40px; margin: 0pt auto;"
...
至<inptype="text" class="ipttxt" xt" name="newPath" id="newPath"  /><br/>
