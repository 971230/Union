	 ...
	 <form method="post"   id="fieldForm" >
	   ...
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="dataField.china_name" value="${dataField.china_name }"  dataType="string" required="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">字段名：</label></th>
	       <td><input type="text" class="ipttxt"  name="dataField.english_name"   value="${dataField.english_name }"  required="true"  dataType="string"/></td>
	      </tr>
	     <tr>
	       <th><label class="text">展现形式：</label></th>
	       <td>
		       <select  class="ipttxt"  name="dataField.show_form" id="show_form">
	     ...
	     <tr>
	       ...
	       <td>
	       <select  class="ipttxt"  name="dataField.data_type" id="data_type">
	     ...
	     <tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="dataField.data_size"  style="width:50px"  value="${ dataField.data_size}"  required="true"  dataType="string"/></td>
	      </tr>
 --> 
	     <tr id="saveValueTr">
	     ...
	     <tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="dataField.taxis" style="width:50px"  value="${dataField.taxis }"  required="true"  dataType="int"/></td>
	      </tr>	      
	     <tr>
