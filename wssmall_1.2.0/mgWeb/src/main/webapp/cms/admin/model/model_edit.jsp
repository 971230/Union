	 ...
	 <input type="hidden" name="dataModel.model_id" value="${dataModel.model_id }" id="modelid"/>
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="dataModel.china_name" maxlength="60" value="${dataModel.china_name }"  dataType="string" required="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">表名：</label></th>
	       <td><input type="text" class="ipttxt"  name="dataModel.english_name"  maxlength="60" size="40" value="${ dataModel.english_name}"  required="true"  dataType="string"/></td>
	      </tr>
	     <tr>
...
<grid:grid  from="fieldList">
  ...
  <grid:body item="field">
        ...
        <grid:cell>${field.english_name} </grid:cell> 
         ...
         <input type="text" class="ipttxt"  name="sorts" style="width:50px;" value="${field.taxis}" />
          </grid:cell> 
