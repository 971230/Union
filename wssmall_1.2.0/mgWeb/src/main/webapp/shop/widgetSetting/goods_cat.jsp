...
<table  border="0" cellspacing="0" cellpadding="2"  >
	     <tr><td height="30" width="200">
	        <select  class="ipttxt"  id="goodstype" name="goodstype" eop_type="widget_params" >
...
<table  border="0" cellspacing="0" cellpadding="2"  >
	     ...
	     <td height="30" width="200">
	        <select  class="ipttxt"  id="catmode" name="catmode" eop_type="widget_params" >
...
<table  border="0" cellspacing="0" cellpadding="2"  >
	     ...
	     <td>商品分类循环深度:</td>
	     <td height="30" width="200">
	        <select  class="ipttxt"  id="catdepth" name="catdepth" eop_type="widget_params" >
