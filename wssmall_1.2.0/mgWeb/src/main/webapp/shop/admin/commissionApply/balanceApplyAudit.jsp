...
<div class="input">
 <form class="validate" method="post" name="balanceApplyAuditForm" id="balanceApplyAuditForm" enctype="multipart/form-data">
 ...
 <tr>
  <th></th>
    <td >
      <input  type="button" id ="balanceApplyAudit" value=" 确    定 " class="submitBtn" />
   </td>
   </tr>
 </table>
</div>
...
<script type="text/javascript">
 $(function(){
    $("#balanceApplyAudit").click(function(){
       var url = ctx +"/shop/admin/commissionApply!balanceApplyAudit.do?ajax=yes";
       Cmp.ajaxSubmit('balanceApplyAuditForm', '', url, {},function jsonBack(reply){
           if(reply.result == 0){
             alert("操作成功");
             Eop.Dialog.close("balanceApplyAuditDlg");
