...
<table class="form-table">
	<tr>
		<th>商品名称：</th>
		<td><input type="hidden" name="goods.goods_type" value="bind"/><input type="text" class="ipttxt"  name="goods.name" id="goods_name"
			class="input_text" dataType="string" required="true"
			 /></td>
	</tr>
	<tr>
		<th>货号：</th>
		<td><input type="text" class="ipttxt"  name="goods.sn" class="input_text" dataType="string" required="true"
			 /></td>
	</tr>
	<tr>
		<th>是否上架销售：</th>
	...
	<tr>
		<th>市场价格：</th>
		<td><input type="text" class="ipttxt"  name="goods.mktprice" id="mktprice"
