...
<form action="warehouseAssign!selectGoodsList.do?ajax=yes" method="post" id="choiceGoodsform">
		<div class="searchformDiv">
			...
			<th></th> 
			 ...
			 <input class="comBtn" type="submit" id="searchGoodsBtn" value="搜索" style="margin-right:5px;"/>
			</td>
		   </tr>
		  </tbody>
		  </table>
