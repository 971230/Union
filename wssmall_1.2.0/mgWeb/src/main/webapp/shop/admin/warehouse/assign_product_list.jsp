...
$(function(){
 ...
 WarehouseProduct.initAssign();
	
});
//-->
</script>
<div id="assign_pro_list">
				...
				<tbody>
					<tr>
						...
						<td >
						    ...
						    <input type="button" id="select_pro_btn" value="选择">
					    </td>
					    <td>
	...
	<form id="gridform" class="grid">
		<grid:grid from="webpage" ajax="yes" formId="warehouseForm">
			<grid:header>
				...
				<grid:cell width="20%">货品名称</grid:cell>
				<grid:cell width="20%">货品库存</grid:cell>
				<grid:cell width="10%">未分配</grid:cell>
				<grid:cell width="10%">已分配</grid:cell>
			...
			<grid:body item="obj">
				...
				<grid:cell><span name="apply_num">${obj.apply_num} </span></grid:cell>
				<grid:cell>
