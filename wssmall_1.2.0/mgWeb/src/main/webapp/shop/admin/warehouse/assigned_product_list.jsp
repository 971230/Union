...
$(function(){
		...
		WarehouseProduct.initAssigned();

});
//-->
</script>
<div id="recover_pro_list">
	<form action="" method="post" name="searchFrom" id="assignedProductSF">
				...
				<tbody>
				    <tr>
						...
						<td >
						    ...
						    <input type="button" id="v_select_pro_btn" value="选择">
					    </td>
					    <td>
						</td>
				    </tr>
					<tr>
						...
						<td >
						    <html:selectdict  name="apply.house_id" curr_val="${apply.house_id }"
		...
		<grid:grid from="webpage"  ajax="yes" formId="assignedProductSF">
			...
			<grid:body item="obj">
				<grid:cell>
					...
					<input type="hidden" name="org_id" value="${obj.org_id}" />
				...
				<grid:cell><span name="is_share" style="display:none">${obj.is_share}</span>
					...
					<c:if test="${obj.is_share=='1'}">共享</c:if>
				</grid:cell>
