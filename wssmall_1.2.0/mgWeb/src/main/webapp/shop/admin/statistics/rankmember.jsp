...
<div class="grid">
	...
	<form method="GET" action="rank!rankmember.do">
		<ul>
			<li>订单日期从：<input type="text" class="ipttxt"  name="beginTime" value="${beginTime }" maxlength="60" dataType="date" class="dateinput"/></li>
			<li>到：<input type="text" class="ipttxt"  name="endTime" value="${endTime }" maxlength="60" dataType="date" class="dateinput"/></li>
			<li><input type="submit" class="comBtn" value="查询" /></li>
		</ul>
	</form>		
