 ...
 <input type="hidden" name="lv.lv_id"  value="${lv.lv_id }" />
   ...
   <table cellspacing="1" cellpadding="3" width="100%">
     <tr>
       ...
       <td width="27%"><input type="text" class="ipttxt"  name="lv.name" id="name" maxlength="60" value="${lv.name }" dataType="string" required="true"/>       </td>
       <td width="58%" align="left"><div id="nameTip" style="width:80px;"></div></td>
     </tr>
    <tr>
       <th><label class="text">所需积分</label></th>
       <td width="27%"><input type="text" class="ipttxt"  name="lv.point" id="name"  style="width:80px" value="${lv.point}" dataType="int" required="true"/>       </td>
       <td width="58%" align="left"><div id="nameTip" style="width:80px;"></div></td>
     </tr>     
     <tr>
       <th><label class="text">优惠百分比</label></th>
       <td  >
       <input type="text" class="ipttxt"  name="lv.discount" id="discount" style="width:50px;" value="${lv.discount}" dataType="float" required="true"/>%&nbsp;&nbsp;
		</td>
