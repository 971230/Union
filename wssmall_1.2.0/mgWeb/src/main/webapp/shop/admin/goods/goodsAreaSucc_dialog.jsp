...
<%--				<grid:cell sort="state" width="180px">审核状态</grid:cell>--%>
			</grid:header>
...
<%--				<grid:cell>&nbsp;--%>
<%--					<c:if test="${goodsArea.state==0}">待审核</c:if>--%>
<%--					<c:if test="${goodsArea.state==1}">审核通过</c:if>--%>
<%--					<c:if test="${goodsArea.state==2}">审核不通过</c:if>--%>
<%--					<c:if test="${goodsArea.state==3}">下架</c:if>--%>
<%--				</grid:cell>--%>
			</grid:body>
