...
<%--		<grid:cell sort="brand_id">品牌</grid:cell>--%>
		<grid:cell sort="create_time">上架时间</grid:cell>
  ...
  <grid:body item="goods" >
        ...
        <grid:cell>&nbsp;<a href="goods!showGoodsMsg.do?goods_id=${goods.goods_id}">${goods.name }</a> </grid:cell> 
...
<%--        <grid:cell>&nbsp;${goods.brand_name} </grid:cell> --%>
        ...
        <grid:cell>&nbsp;<html:dateformat pattern="yyyy-MM-dd" time="${goods.create_time}"></html:dateformat> </grid:cell> 
