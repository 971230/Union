...
<form id="pkgGridForm" class="grid">
	<grid:grid from="webpage" formId="searchProductPkgForm" ajax="yes">
		<grid:header>
			<grid:cell width="30px"></grid:cell>
		...
		<grid:body item="pkg">
			<grid:cell>
				<input type="radio" name="id" value="${pkg.relation_id }" md="${pkg.model_code }"/>
			</grid:cell>
...
<a href="javascript:void(0);" style="margin-right:10px;" class="graybtn1" id="confirmPkgBtn"><span>确定</span></a>
</div>
<script>
$(function(){
