...
<form action="javascript:;" method="post" id="choiceTerminalform">
	    ...
	    <th>终端名称</th>
	    <td>
		   <input type="text"  name="terminal_name" id="terminal_name" value='${terminal_name}' style="width: 188px;" maxlength="60" class="ipttxt" /> 
		</td>
	    <th>终端类型</th>
	    <td>
		    <html:selectdict name="terminal_type" id="terminal_type"  curr_val="${terminal_type }"
		             attr_code="DC_TERMINAL_TYPE" style="width:150px" 
        ...
        <form  id="form_tc" class="grid" >
            <grid:grid from="webpage" ajax="yes"  formId="choiceTerminalform">
                <grid:header>
                ...
                <grid:body item="goods">
                    <grid:cell><input type="radio"  name="goodsId" value="${goods.product_id }" pid="${goods.product_id }" bid="${goods.brand_id }"
...
var addGoods= {
    ...
    searchBottonClks : function() {
    	...
    	contractConfig.showTerminal(params);
