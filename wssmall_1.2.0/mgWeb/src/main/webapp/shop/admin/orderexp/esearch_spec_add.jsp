		...
		<h3>
			<div class="graph_tab">
				<ul>
					...
					<li id="show_click_2" class="selected"><span class="word">新增关键字规格</span><span
						class="bg"></span></li>
					<div class="clear"></div>
				</ul>
			</div>
	...
	<form action="" class="validate" method="post"
		...
		<table class="form-table">
			<tr>
				...
				<td><input type="text" class="ipttxt"  name = "sdqInner.search_code" id="search_code" /></td>
			</tr>
			<tr>
				<th><label class="text"><span class='red'>*</span>搜索id：</label></th>
				<td><input type="text" class="ipttxt" name = "sdqInner.search_id" id="search_id" /></td>
			</tr>
			<tr>
				<th><label class="text"><span class='red'>*</span>搜索名称：</label></th>
				<td><input type="text" class="ipttxt" name = "sdqInner.search_name" id="search_name" /></td>
			</tr>
			<tr>
				<th><label class="text"><span class='red'></span>处理器：</label></th>
				<td><input type="text" class="ipttxt" name = "sdqInner.hander_class" id="hander_class" /></td>
			</tr>
			<tr>
				...
				<td>
					<select name="sdqInner.search_field" id="search_field">
						...
						<option value="0">出参报文</option>
						<option value="1">入参报文</option>
					</select>
				</td>
			</tr>
			<tr>
