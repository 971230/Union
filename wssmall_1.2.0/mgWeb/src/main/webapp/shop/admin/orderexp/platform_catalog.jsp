...
<div region="center" >
    ...
    <table id="catalog_list" url="<%=request.getContextPath() %>/shop/admin/esearchCatalog!qryCatalogTreeList.do?ajax=yes&end_time=${end_time }&start_time=${start_time }" idField="catalog_id" treeField="catalog_name" style="width:205;height:520px;" border=0>
        <thead>
        <tr>
	...
	$("#catalog_list").treegrid({
        onBeforeExpand: function (node) {
        	if(node){
	            ...
	            $.ajax({
	            	url:ctx+"/shop/admin/esearchCatalog!qryChildrenCatalog.do?ajax=yes&end_time="+end_time+"&start_time="+start_time,
	            	dataType:"json",
