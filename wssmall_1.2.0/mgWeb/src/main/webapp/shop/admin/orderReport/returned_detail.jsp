...
<table class="form-table">
	<tr>
		<th>订单号:</th><td>${delivery.order_id }</td>
		<th>物流单号：</th><td>${delivery.delivery_id }</td>
	...
	<tr>
		...
		<th>生成时间:</th><td><html:dateformat pattern="yyyy-MM-dd HH:mm:ss" d_time="${delivery.create_time}"></html:dateformat></td>
	</tr>
</table>
<hr class="space">
<h4>退货明细:</h4>
