...
<form id="payment_form" method="POST" action="${pageContext.request.contextPath}/shop/admin/orderReport!paymentList.do">
...
<table class="form-table">
	<tr>
		...
		<a href="javascript:void(0)" id="paymentsearchBtn" style="margin-right:10px;" class="graybtn1"><span>搜索</span></a>
		</td>
	</tr>
</table>		
</div>
...
$(function(){
	$("#paymentsearchBtn").bind("click",function(){
		$("#payment_form").submit();
	});	
});
</script>
