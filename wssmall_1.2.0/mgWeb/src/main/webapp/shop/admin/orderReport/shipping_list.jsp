...
<form id="shipping_form" method="POST" action="${pageContext.request.contextPath}/shop/admin/orderReport!shippingList.do">
...
<table class="form-table">
	<tr>
		...
		<th>
		${(create_type==6||create_type==7)?'退':'收' }货人：
		</th>
		<td>
		<input type="text" class="ipttxt"  name="member_name"  value="${member_name }"/>&nbsp;&nbsp;
		<a href="javascript:void(0)" id="shippingsearchBtn" style="margin-right:10px;" class="graybtn1"><span>搜索</span></a>
		</td>
	</tr>
</table>		
</div>
...
$(function(){
	$("#shippingsearchBtn").bind("click",function(){
