...
<%@ taglib uri="/WEB-INF/FCKeditor.tld" prefix="fck" %>
 ...
 <input type="hidden" name="seo.id" value="1" />
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       <th>首页标题：</th>
       <td  ><input type="text" class="ipttxt"  name="seo.title" maxlength="60" value="${seo.title }"  dataType="string" required="true" />       </td>
      </tr>
      <tr>
       <th>META_KEYWORDS<br/>(关键词)：</th>
       <td  >
       	<input type="text" class="ipttxt"  name="seo.meta_keywords" maxlength="60" value="${seo.meta_keywords }" />
       </td>
      </tr>
      <tr>
   ...
   <p class="submitlist"> <input  type="submit" class="button" value=" 确定 " />
