...
<grid:grid  from="webpage">
  ...
  <grid:body item="freeOffer">
        ...
        <grid:cell>&nbsp;<html:dateformat pattern="yyyy-MM-dd" d_time="${freeOffer.startdate}"></html:dateformat></grid:cell>
        <grid:cell>&nbsp;<html:dateformat pattern="yyyy-MM-dd" d_time="${freeOffer.enddate}"></html:dateformat></grid:cell>
