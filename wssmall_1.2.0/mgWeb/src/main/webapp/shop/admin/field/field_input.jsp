	 ...
	 <form method="post"   id="fieldForm" >
	   ...
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="goodsField.china_name" value="${goodsField.china_name }"  dataType="string" required="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">字段名：</label></th>
	       <td><input type="text" class="ipttxt"  name="goodsField.english_name"   value="${goodsField.english_name }"  required="true"  dataType="string"/></td>
	      </tr>
	     <tr>
	       <th><label class="text">字段插件：</label></th>
	       <td>
		       <select  class="ipttxt"  name="goodsField.pluginid" id="pluginid">
	     ...
	     <tr>
	      ...
	      <input type="radio" name="goodsField.data_source" value="manual" checked />手工输入
	       ...
	       <select  class="ipttxt"  name="source_id">
	     ...
	     --><tr>
	       ...
	       <td><input type="text" class="ipttxt"  name="goodsField.field_sort" style="width:50px"  value="${goodsField.field_sort }"  required="true"  dataType="int"/></td>
	      </tr>	      
	     <tr>
