...
<script type="text/javascript" src="<%=request.getContextPath() %>/shop/admin/numero/js/selectShop.js"></script>
...
<div class="cate-wrapper">
	<div id="cate-container" class="grid">
		...
		<table style="background-color: #F5F9FF;">
			<tr style="display:none;">
				<th style="width:200px;">省<input type="hidden" id="numbers" value="${numbers}"></th>
	...
	<div id="cateBottom">
		<input type="button" style="" class="comBtn" value="发&nbsp;布" id="confirmButton" name="button">
	</div>
</div>
