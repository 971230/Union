...
loadScript("numero/js/numero_synch_logs_ecs.js");
</script>
	    		...
	    		<tbody>
		    	    <tr>
						...
						<td style="width:180px;">
		    	       	...
		    	       	<th>号码：</th>
						<td style="width:180px;">
							<input type="text" class="ipttxt" style="width: 150px" id="number" name="params.number" value="${params.number }" />
						</td> --%>
						<td>
