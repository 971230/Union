...
<table class="table_frame" width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="td_frame"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="right"><h2>订购日期：<html:dateformat pattern="yyyy-MM-dd HH:mm:ss" d_time="${ord.create_time}"/></h2></td>
      </tr>
  ...
  <tr>
    <td style="height:30px; padding-bottom:50px;" align="right"><strong>中国电信-江西采购平台</strong>
</td>
  </tr>
</table>
</div>
...
<table class="table_frame" width="90%" border="0" align="center"
			...
			<tbody>
				<tr>
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%">
						<tbody>
							<tr>
								<td><span style="font-family: EanP36Tt; font-size: 36px;">${ord.sn}</span></td>
								<td>
	...
	<tr>
		<td style="height: 30px; padding-bottom: 50px;" align="right"><strong>中国电信-江西采购平台</strong></td>
	</tr>
</table>
...
<table>
	<tr>
		<td><input name="button" type="button" value=" 打    印   " 	id="btn_print"/></td>
	</tr>
</table>
</div>
