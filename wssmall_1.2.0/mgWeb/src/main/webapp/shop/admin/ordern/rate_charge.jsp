...
<script type="text/javascript" src="js/rate_charge.js"></script>
<h3>
       	...
       	<h3>
               <div class="graph_tab">
                   <ul>
                       ...
                       <li id="show_click_2" class="selected"><span class="word">流量卡充值</span><span class="bg"></span></li>
                       <div class="clear"></div>
                   </ul>
               </div>
           </h3>
...
<div class="input">
	<form class="validate" method="post" action="" id='rate_charge_form' validate="true">
