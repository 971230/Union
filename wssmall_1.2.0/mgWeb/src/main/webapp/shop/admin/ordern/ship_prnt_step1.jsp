...
<div class="tableform" id="x-order_tableform">
    ...
    <div class="division">
      ...
      <tbody><tr>
	      <th>姓名：</th>
          <td colspan="3"><input size="10" style="width:80px;" value="${ord.ship_name }" name="ship_name" /></td>
      ...
      <tr>
	      <th>所在城市：</th>
          <td><input type="text" class="ipttxt"  name="shipping_area" value="${ord.shipping_area }"/></td>

	      <th>邮编：</th>
	      <td><input name="ship_zip" value="${ord.ship_zip }" /></td>
          </tr>
	        <tr>
	      <th>地址：</th>
          <td colspan="3"><input size="50" style="width:400px;" name="ship_addr" value="${ord.ship_addr }"/></td>
	        </tr>
	  
      <tr>

	      <th>手机：</th>
          <td><input value="${ord.ship_mobile }" name="ship_mobile"/></td>
	      <th>电话：             </th>
	      <td><input value="${ord.ship_tel }" name="ship_tel"/></td>
          </tr>
      <tr>
        <th>备注：</th>

        <td colspan="3"><input size="50" style="width:400px;" name="remark" value="${ord.remark }" /></td>
        </tr>
	   </tbody></table>
  </div>
    ...
    <span style=" padding-left:10px;">发货点选择:
     <select  class="ipttxt"  name="dly_center_id" id="dly_center_id"  required="true" >
   ...
   <option value="${dlyCenter.dly_center_id }">${dlyCenter.name }</option>
    ...
    <select  class="ipttxt"  name="prt_tmpl_id"  required="true" >
