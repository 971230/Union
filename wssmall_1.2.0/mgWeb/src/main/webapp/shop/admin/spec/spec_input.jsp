...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	<tr>
		...
		<td><input type="text" class="ipttxt"  name="spec.spec_name" maxlength="60"
			value="${specView.spec_name }" dataType="string" required="true" /></td>
	</tr>
	<tr>
		<th><label class="text">规格备注：</label></th>
		<td><input type="text" class="ipttxt"  name="spec.spec_memo" maxlength="60" value="${specView.spec_memo}"/></td>
	</tr>
	<tr>
...
<div class="grid">
	<div class="toolbar" style="width: 100%;">
		...
		<input class="comBtn" type="button" name="" id="addtype" value="添加规格值" style="margin-right:10px;outline-style:none"/></a>
		<span class="help_icon" helpid="spec_add"></span>
		<span style="float: right;">
		<input  type="submit"  value=" 保 存   " class="comBtn" />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</span>
...
<grid:grid from="valueList" pager="no">
	...
	<grid:body item="val">
		<grid:cell><input type="text" class="ipttxt"  name="valueArray" value="${val.spec_value }" /> </grid:cell>
		<grid:cell>
...
<tr>
	<td><input type="text" class="ipttxt"  name="valueArray"  /> </td>
	<td>
