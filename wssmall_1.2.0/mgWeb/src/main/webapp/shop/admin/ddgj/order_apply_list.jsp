	...
	<form method="POST">
		<grid:grid from="webpage">
			...
			<grid:body item="orderApply">
				<grid:cell><input type="radio" order_id="${orderApply.order_id}" name="apply_id" apply_id="${orderApply.order_apply_id }" service_type="${service_type }"/></grid:cell>			
				...
				<%-- <grid:cell>
<!-- 				<a href="javascript:void(0);" name="edit_order_apply" applyid="${orderApply.order_apply_id }" class="showSupplierOrder">编辑/查看</a>&nbsp;&nbsp; -->
