...
<form  method="post" id="common_form_c" > 
<div class="formWarp">
    ...
    <div id="order_tag_5000" class="formGridDiv" >
    	<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0" class="formGrid" >
          ...
          <tr id="flowInfo" style="display: none;">
				...
				<th>物流描述:</th>
				<td colspan="3">
					<input id="delivery_flow_desc" type="text" class="ipttxt" style="width: 90%;" name="flow.description" autocomplete="off" />
				</td>
		 </tr>
          ...
          <tr>
            <th>收货人姓名：</th>
            <td>
            	<input type="text" class="formIpt" style="width: 136px;" value="${ord.ship_name}" name="delivery.ship_name" autocomplete="off">
            </td>
            <th>电话号码：</th>
            <td>
...
<div id="order_tag_5001" class="formGridDiv">
    <table id="goods_items_tb" width="100%" border="0" cellspacing="0" cellpadding="0" class="blueTable">
      ...
      <tbody>
      <c:forEach items="${shipGoodsList }" var="item">
	      <tr>
    	...
    	<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0" class="formGrid" >
          ...
          <tr>
	         <th colspan="6" style="text-align: center;">
	         	<a href="javascript:void(0);" id="allowReturnBtn_c" class="dobtn" style="margin-right:5px;">退货</a>
	         	<a href="javascript:void(0);" id="notallowReturnBtn_c" class="dobtn" style="margin-right:5px;display: none;">不允许退货</a>
	         </th>
	       </tr>
        </table>
    </div>
