...
function setParamNum(){
	...
	if(result){	
		...
		for(var i=0;i<tbls.length;i++){
			...
			//各个参数组中参数名个数
			var texts = tbls[i].getElementsByTagName("i");
			if(paramnum!=''){
				paramnum+=",";
			}
			
			paramnum+=(texts.length);
...
<form method="post" action="type!saveParams.do" name="theForm1"
	id="theForm1" onsubmit="javascript:return setParamNum();">
	...
	<div style="text-align:center">
		<div class="list-div" id="listDiv" style="width:100%;text-align:left">
							...
							<tr class="group">
								...
								<td style="background-color:#DDEEF2;width:93px;" colspan="3">
									<input type="text" class="ipttxt" name="groupnames" maxlength="60"
											value="${group.name }" style="width:120px;" /></td>
			...
			<div class="submitlist" align="center">
				<table>
					<tr>
						<td><input type="submit" value=" 下一步   " id="saveTypeBtn" class="submitBtn" />
						</td>
					</tr>
				</table>
			</div>
