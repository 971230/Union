   ...
   <table cellspacing="1" cellpadding="3" width="100%"  class="form-table">
     <tr>
       <td width="19%" height="77" align="left" >&nbsp;
       	...
       	<select  class="ipttxt"  name="brandlist" id="brand_sel" multiple="true" style="width:200px;height:200px; border: 1px solid #000000">
	   ...
	   <input  type="button" class="button" value="  ->  "  onclick="javascript:rightMove();"/>
	   <br/>
	   <input  type="button" class="button" value="  <-  "  onclick="javascript:leftMove();"/>
	   <br/>
	   <input  type="button" class="button" value="  重置  " onclick="javascript:clean();"/>
	   </td>
       <td width="68%" height="77" align="left" >
		<select  class="ipttxt"  name="chhoose_brands" id="choose_sel" multiple="true" style="width:200px;height:200px; border: 1px solid #000000">
