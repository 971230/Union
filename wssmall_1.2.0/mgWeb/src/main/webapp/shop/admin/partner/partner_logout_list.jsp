...
<div >
	...
	<grid:cell sort="partner_id">分销商编码</grid:cell> 
	<grid:cell sort="partner_name">分销商名称</grid:cell> 
	<grid:cell sort="partner_type">分销商类型</grid:cell> 
	<grid:cell sort="need_amount">达量</grid:cell> 
	<grid:cell sort="partner_level">分销商级别</grid:cell> 
	<grid:cell sort="partner_cat">分销商类别</grid:cell> 
	<grid:cell sort="shop_type">店铺类型</grid:cell> 
	<grid:cell>服务保证金</grid:cell>
	<grid:cell>上级分销商姓名</grid:cell>
