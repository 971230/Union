...
<script type="text/javascript" src="js/accnbr_forSearch_list.js"></script>
<form  method="post" id='accnbr_forSearch_query_form' action='ContractAction!list_avaible_forSearch.do'>
...
<div id="insureDiv">
	<td>	<input type="submit" style="margin-right:10px;" class="comBtn" value="确&nbsp;定"  id="accInsureBtn" name="button"></td>
</div>
