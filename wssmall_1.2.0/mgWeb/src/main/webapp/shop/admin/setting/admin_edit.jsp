 ...
 <input type="hidden" name="admin.id" value="${admin.id }"/> 
   <table cellspacing="1" cellpadding="3" width="100%">
     <tr>
       ...
       <td width="17%"><input type="text" class="ipttxt"  name="admin.uname"  maxlength="60" value="${admin.uname }" id="uname"/>       </td>
       <td width="55%" align="left"><div id="unameTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">姓名</td>
       <td width="17%"><input type="text" class="ipttxt"  name="admin.name"  maxlength="60" value="${admin.name }" id="name"/>       </td>
       <td width="55%" align="left"><div id="nameTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">密码</td>
       <td width="17%"><input type="password"  class="ipttxt"  name="pwdup"  maxlength="60"  id="password" />       </td>
       <td width="55%" align="left"><div id="pwdupTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">确认密码</td>
       <td width="17%"><input type="password"  class="ipttxt"  name="repwd"  maxlength="60" value="" id="repwd"/>       </td>
