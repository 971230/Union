 ...
 <input type="hidden" name="id" value="${payCfg.id}"/>
   <table cellspacing="1" cellpadding="3" width="100%">
     ...
     <tr>
       ...
       <td width="40%"><input type="text" class="ipttxt"  name="parterID" id="parterID"  style="width:300px"  value="${payCfg.parterID }" />       </td>
       <td width="33%" align="left">&nbsp;</td>
     </tr>
     	 
     <tr>
       <td width="27%" class="label">交易安全校验码(key)</td>
       <td width="40%"><input type="text" class="ipttxt"  name="key" id="key"  style="width:300px" value="${payCfg.key }" />       </td>
       <td width="33%" align="left">&nbsp;</td>
     </tr>
	 
     <tr>
       <td width="27%" class="label">支付宝帐户(email)</td>
       <td width="40%"><input type="text" class="ipttxt"  name="seller_email" id="seller_email"  style="width:300px" maxlength="60" value="${payCfg.seller_email }" />       </td>
       <td width="33%" align="left">&nbsp;</td>
     </tr>
     	 
     <tr>
       <td width="27%" class="label">支付费率</td>
       <td width="40%"><input type="text" class="ipttxt"  name="payCfg.pay_fee" id="name"  style="width:100px" value="${payCfg.pay_fee }" />%       </td>
       <td width="33%" align="left">&nbsp;</td>
     </tr>
     ...
     <tr>
       <td colspan="3" align="center"><br /> 
           <input  type="submit" class="button" value=" 确定 " class="btn"/>
