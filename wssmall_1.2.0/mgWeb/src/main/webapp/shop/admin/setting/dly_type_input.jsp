...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	<tbody>
		<tr>
			<th>配送方式名称:</th>
			<td><input type="text" class="ipttxt"  maxlength="20"   name="type.name" value="${type.name }"  dataType="string" required="true"></td>
			<th>选择默认物流公司:</th>
			<td><select  class="ipttxt"  id="corp_id" name="type.corp_id">
		...
		<tr>
			<th>重量设置:</th>
			<td>首重重量&nbsp;<select  class="ipttxt"  id="firstunit" name="firstunit">
			...
			<select  class="ipttxt"  id="continueunit" name="continueunit">
				<option value="500" label="500克">500克</option>
				<option selected="selected" value="1000" label="1公斤">1公斤</option>
				<option value="1200" label="1.2公斤">1.2公斤</option>
				<option value="2000" label="2公斤">2公斤</option>
		...
		<tr id="protectrate" style="display:none">
			<th>保价设置:</th>
			<td>费率&nbsp;<input type="text" class="ipttxt"  id="protect_rate" name="type.protect_rate" style="width:25px"  dataType="float" />
			%
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			最低保价费&nbsp;<input type="text" class="ipttxt"  style="width: 25px;" id="min_price" name="type.min_price" dataType="float" ></td>
			<th>&nbsp;</th>
			<td>&nbsp;</td>
		</tr>
		<tr>
				...
				<li style="line-height: 30px;display:none" class="division">
					...
					<div class="deliverycity" >
	                     <span class="delCfgBtn" style="float: right;"><img border="none" title="删除" alt="删除" style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;" src="images/transparent.gif"></span>
	                  	 配送地区 <input type="text" class="ipttxt"   disabled="true"  readonly="true" name="areaGroupName" style="width: 300px;" dataType="string" required="true">
			...
			<c:forEach var="typeArea"  items="${type.typeAreaList}" varStatus="area">
				<li style="line-height: 30px;" class="division" id="deliverycity_${area.index}">
					...
					<div class="deliverycity" >
	                     <span class="delCfgBtn" style="float: right;"><img border="none" title="删除" alt="删除" style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;" src="images/transparent.gif"></span>
	                  	 配送地区
	                  	  <input type="text" class="ipttxt"  readonly="true" name="areaGroupName" style="width: 300px;" value="${typeArea.area_name_group}"  dataType="string" required="true"/>
...
<div class="division">
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
            <tbody><tr>
                <th>排序:</th>
                <td>
                    <input type="text" class="ipttxt"   size="5" id="ordernum" name="type.ordernum" value="${type.ordernum}"  dataType="int" required="true">
                </td>
            </tr>
            <tr>
                <th>状态:</th>
