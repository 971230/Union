...
OrderStatus.ORDER_COLLECT = 5; // 采集单
OrderStatus.ORDER_COLLECT_REFUSE = 6; // 采集单审核不通过
OrderStatus.ORDER_ACCEPT = 7; // 已受理
OrderStatus.ORDER_ACCEPT_FAIL = 8; // 已受理失败
OrderStatus.ORDER_CONFIRM_SHIP = 9; // 确认收货
OrderStatus.ORDER_ACCEPT_WITHDRAW = 10; // 撤单
OrderStatus.ORDER_CONFIRM_CANCEL= 11; // 取消订单
...
var OrderDetail ={
		...
		pay:function(){
			var self= this;
			var url =basePath+"payment!pay.do?ajax=yes";
