	...
	<form action="partner!auditlist.do" method="post">
		<div class="searchformDiv">
	    	  <table width="100%" cellspacing="0" cellpadding="0" border="0">
	    	    <tbody><tr>
	    	     <th>行业用户名称：</th>
	    	      <td><input type="text" class="ipttxt"  style="width: 120px;" name="partAudit_s.partner_name" value="${partAudit_s.partner_name }" class="searchipt" /></td>
	    	        <th>行业用户编码：</th>
	    	      <td><input type="text" class="ipttxt"  style="width: 120px;" name="partAudit_s.partner_code" value="${partAudit_s.partner_code }" class="searchipt" /></td>
	    	       </tr>
	    	       <tr>
	    	       <th>联系人：</th>
