		 ...
		 <td>
 	      ...
 	      <tr align="center">
   	      <td><input type="submit" value="保存" class="comBtn"></td>
   	       <td>
   			<c:if test="${classTag.cat_type == 'tag_good' || classTag.cat_type == 'taglist_good'}">
   				<a href="tag!goodlist.do" style="margin-right:10px;" id="backBtn" class="comBtn" ><span>返回</span></a>
   			</c:if>
   			
   			<c:if test="${classTag.cat_type == 'tag_shop' || classTag.cat_type == 'taglist_shop'}">
...
<a href="" style="margin-right:10px;" id="backBtn" class="graybtn1" ><span>标签组:</span></a><img class="modify" src="images/open.gif" >
<grid:grid  from="webpage"  >
	...
	<grid:header>
  	...
  	<grid:body item="tag">
        ...
        <grid:cell><a  href="tag!deleteTag.do?tag_code=${tag.tag_code}&choose_tag_type=${classTag.cat_type}" style="margin-right:10px;" id="deleteBtn" class="graybtn1"><span>删除</span></a></grid:cell>
  	</grid:body>  
