...
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
  <tbody><tr>
    ...
    <td><input type="text" class="ipttxt"  required="true" name="coupons.cpns_name" value="${coupons.cpns_name }"></td>
  </tr>
  </tbody></table>
</div>
<div class="division">
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
  <tbody><tr>
    <th>号码:</th>
      <td><input type="hidden" required="true" name="coupons.cpns_prefix" value="${coupons.cpns_prefix }"/><input type="text" class="ipttxt"  required="true" name="cpns_prefix" value="${coupons.cpns_prefix }" disabled="disabled"/></td>
    </tr>
  <tr>
    <th>状态:</th>
