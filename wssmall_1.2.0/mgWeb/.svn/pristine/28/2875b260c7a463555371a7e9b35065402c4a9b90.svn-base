			...
			<table>
				<tr>
					<td>共有商品相册：${total }个，生成从
						<input id="istart" type="text" class="ipttxt"  name="start" value="1" style="width:35px"></input> -
						<input id="iend" type="text" class="ipttxt"  name="end" value="${total}" style="width:35px"></input>个
					</td>
				</tr>
				<tr>
					<td>
