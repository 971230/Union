...
<div >
	<form method="POST" action="tag!search.do?choose_tag_type=tag_shop">
	...
	<form method="post" name="invalForm" id="invalForm">
		<div class="comBtnDiv">
	操作:&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="tag!addTagList.do?choose_tag_type=tag_shop" style="margin-right:10px;" id="addTagList" class="comBtn" ><span>添加标签组</span></a>
    <a href="tag!addTag.do?choose_tag_type=tag_shop" style="margin-right:10px;" id="addTag" class="comBtn" ><span>添加标签</span></a>
    <a href="javascript:;"  id="shopSyncTag" style="margin-right:10px;" class="comBtn"><span>同步</span></a>
     <a href="javascript:;"  style="margin-right:10px;" id="shopInvalBtn" class="comBtn" ><span>失效</span></a>
...
<grid:body item="tag">
        ...
        <grid:cell>
          <a href="tag!editTag.do?tag_id=${tag.tag_id }&choose_tag_type=tag_shop" style="margin-right:10px;color:FF0000;text-decoration:underline;"><span>${tag.tag_name }</span></a>
        </grid:cell>
