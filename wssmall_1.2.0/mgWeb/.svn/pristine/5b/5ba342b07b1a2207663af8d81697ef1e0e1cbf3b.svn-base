...
<form  method="post" id="order_dispatch_form" > 
<div class="formWarp">
    	...
    	<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0" class="formGrid" >
          <tr>
            ...
            <td>
            	<p style="height:26px;">
	            	...
	            	<a href="javascript:void(0);" name="user_clear_btn" class="dobtn" style="margin-right:5px;display: none;">清空</a>
	            	<a href="javascript:void(0);" name="user_add_btn" class="dobtn" style="margin-right:5px;display: none;">+</a>
            	</p>
            	<span></span>
            </td>
          </tr>
          ...
          <tr>
	         <th colspan="6" style="text-align: center;">
	         	<a href="javascript:void(0);" id="order_dispatch_btn_submit" class="dobtn" style="margin-right:5px;">确认分派</a>
	         </th>
	       </tr>
        </table>
    </div>
