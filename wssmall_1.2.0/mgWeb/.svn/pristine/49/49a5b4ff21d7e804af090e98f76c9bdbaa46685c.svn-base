...
<table class="form-table">
	...
	<tr>
		<th>出生日期：</td><td><html:dateformat pattern="yyyy-MM-dd" d_time="${member.birthday }"></html:dateformat></td>
		<th>注册日期：</td><td><html:dateformat pattern="yyyy-MM-dd" d_time="${member.regtime }"></html:dateformat></td>
