...
<div class="input">
	<form action="goods!listInbox.do" method="post">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<td>
					<input type="text" style="width: 130px" name="name"
						value="${name }" />
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" style="width: 130px" name="sn" value="${sn }" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<select class="ipttxt" id="catid" name="catid"
						class="inputstyle">
						<option value="">
							--请选择--
						</option>
			...
			<tr>
				...
				<td>
					<select class="ipttxt" id="brand_id" name="brand_id" class="inputstyle">
						<option value="">
							--请选择--
						</option>
					</select>
			...
			<tr>
				...
				<td>
					<select class="ipttxt" id="tagids" name="tagids" class="inputstyle">
						<option value="">
							--请选择--
						</option>
					</select>
			...
			<tr>
				...
				<td>
					<input type="radio" checked="checked" name="market_enable"
						value="2" />
					全部
					<input type="radio" name="market_enable" value="1" />
					是
					<input type="radio" name="market_enable" value="0" />
					否
				</td>
			</tr>
			<!--${goodstype} ${goodstag}  -->
