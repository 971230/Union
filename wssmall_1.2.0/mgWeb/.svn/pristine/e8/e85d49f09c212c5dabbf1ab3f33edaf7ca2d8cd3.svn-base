...
<table class="form-table">
	<tr>
		...
		<td><inputtype="text" class="ipttxt" " name="eopUser.username"
	...
	<tr>
		...
		<td><inputtype="text" class="ipttxt" " name="eopUser.address"
			id="eopUser.address" value="${eopUser.address }" dataType="string"  style="width:260px;"/></td>
	</tr>
	<tr>
		<th><label class="text">法人代表：</label></th>
		<td><inputtype="text" class="ipttxt" " name="eopUser.legalrepresentative"
