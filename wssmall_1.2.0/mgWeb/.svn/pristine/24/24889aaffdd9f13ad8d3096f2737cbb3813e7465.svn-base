	   ...
	   showSetting:function(){
		...
		MenuController:{
			...
			blockClick:function(){
				...
				$("#wssapp_setting_con #wgt_setting_content").load(
					 "eop/setting/block.jsp",
					 {},
					 function(){
						 //初始化区块设置的tabs
						 var widget  = $("#wssapp_setting_con #wgt_preview>div");
			...
			titleClick:function(){
				$("#wssapp_setting_con #wgt_setting_content").load(
						 ...
						 function(){
							 //初始化title设置的tabs
							 var widget  = $("#wssapp_setting_con #wgt_preview>div .title");
			...
			contentClick:function(){
				$("#wssapp_setting_con #wgt_setting_content").load(
						 ...
						 function(){
							 //初始化title设置的tabs
							 var widget  = $("#wssapp_setting_con #wgt_preview>div .content");
