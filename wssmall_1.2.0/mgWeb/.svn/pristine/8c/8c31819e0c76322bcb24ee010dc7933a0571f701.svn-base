...
<script type="text/javascript" src="js/supplier_ecs.js"></script>
<style>
#tagspan {
	position: absolute;
	display: none;
...
<div>
	<form action="supplier!listECS.do" method="post" id="suppListForm">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" class="ipttxt" style="width: 250px"
