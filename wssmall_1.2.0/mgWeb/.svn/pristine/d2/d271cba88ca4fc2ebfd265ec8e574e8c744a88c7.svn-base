          ...
          <table cellspacing="0" cellpadding="2" border="0" width="98%">
            <tbody><tr> 
              <td nowrap="" width="70%">配送公式：
                <input type="text" class="ipttxt"  size="50" value="" id="dlg_expressions">
              </td>
            </tr>
            <tr> 
              <td nowrap="" width="70%">商品重量：
                <input type="text" class="ipttxt"  value="0" size="8" maxlength="20" class="inputstyle" name="weight" id="weight">
                克 </td>
