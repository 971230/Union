...
<form action="javascript:void(0);" method="post" id="choiceform">
 ...
 <form id="gridform" class="grid" ajax="yes">
  ...
  <grid:body item="obj">
	    <grid:cell><input type="radio"  id = "checkBox" name="checkBox" house_id="${obj.house_id }" value="${obj.house_name}" /></grid:cell>
...
<script type="text/javascript" src="store/js/warehouseSeatDalog.js"></script>
