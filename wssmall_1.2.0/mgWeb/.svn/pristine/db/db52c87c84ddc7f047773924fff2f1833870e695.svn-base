...
<table cellspacing="0" cellpadding="0" class="finderInform">
	...
	<c:forEach items="${itemList}" var="item">
		<tr>
			...
			<td <c:if test="${item.have_stock==0}"> style='display:none;'</c:if>><input type="text" class="ipttxt"  style="width: 50px;" value="${ item.num-item.ship_num}" name="numArray" autocomplete="off"></td>
...
<div class="submitlist" align="center">
 <table>
	 <tr>
	 	<td >
           <input  type="button"  value="发货" class="submitBtn" name='shippingBtn'/>
	   </td>
	</tr>
 </table>
</div> 
