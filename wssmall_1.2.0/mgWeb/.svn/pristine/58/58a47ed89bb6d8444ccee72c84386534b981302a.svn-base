 ...
 <form method="post" action="../admin!saveAdd.do" name="theForm" id="theForm"  >
   <table cellspacing="1" cellpadding="3" width="100%">
     <tr>
       ...
       <td width="17%"><input type="text" class="ipttxt"  name="admin.uname"  maxlength="60" value="" id="uname"/>       </td>
       <td width="55%" align="left"><div id="unameTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">姓名</td>
       <td width="17%"><input type="text" class="ipttxt"  name="admin.name"  maxlength="60" value="" id="name"/>       </td>
       <td width="55%" align="left"><div id="nameTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">密码</td>
       <td width="17%"><input type="password"  class="ipttxt"  id="password" name="admin.pwd"  maxlength="60" value="" />       </td>
       <td width="55%" align="left"><div id="passwordTip" style="width:250px"></div></td>
     </tr>
     <tr>
       <td width="28%" class="label">确认密码</td>
       <td width="17%"><input type="password"  class="ipttxt"  name="repwd" id="repwd"  maxlength="60" value="" />       </td>
