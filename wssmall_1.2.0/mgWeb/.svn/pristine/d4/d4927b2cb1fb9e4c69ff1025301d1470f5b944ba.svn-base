...
<table  class="form-table">
	<tr>
		...
		<td ><input type="text" class="ipttxt"  name="eopSiteDomain.domain"  dataType="string" required="true" /></td>
	</tr><input type="hidden" name="eopSiteDomain.domaintype" value="0" /><tr>
		<th><label class="text" >状态：</label></th>
		<td><select  class="ipttxt"  name="eopSiteDomain.status" id="eopSiteDomain.status">
			<option value="0"
