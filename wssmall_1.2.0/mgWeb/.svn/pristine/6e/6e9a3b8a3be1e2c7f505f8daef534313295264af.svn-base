...
<script type="text/javascript" src="js/activity_selector.js"></script>
<style>
...
<div class="input">
<form  action="promotion!saveAll.do" method="post"  class="validate" enctype="multipart/form-data">
...
<table class="form-table"  cellspacing="0" cellpadding="0" border="0" width="100%">
	 <tr>
       ...
       <td><input type="text" class="ipttxt"  name="activity.name"  id ="name" maxlength="60" value=""  dataType="string" required="true"  />
       <input type="hidden" name="activity.id" id ="id">
       <a href="javascript:void(0)" style="margin-right:10px;"
						class="graybtn1" name="checkAct" id="checkAct"><span>选择已有活动</span></a>
       </td>
     </tr>
     <tr>
