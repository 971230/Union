...
<div class="grid">
	...
	<div class="comBtnDiv">
	  <a href="coupon!addExchange.do" style="margin-right:10px;" class="graybtn1" ><span>添加兑换规则</span></a>
...
<grid:grid  from="webpage">
  ...
  <grid:body item="coupon">
  		<grid:cell><input type="checkbox" name="id" value="${coupon.cpns_id }" /></grid:cell>
        <grid:cell>${coupon.cpns_name } </grid:cell>
        <grid:cell>${coupon.cpns_prefix } </grid:cell>
        <grid:cell>${coupon.cpns_point} </grid:cell>
        <grid:cell> <a href="coupon!editExchange.do?cpnsid=${coupon.cpns_id }" ><img class="modify" src="images/transparent.gif" ></a> 
