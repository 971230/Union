...
<form  method="post" id="order_openaccount_form" > 
<div class="formWarp">
...
<div class="formWarp">
  <div class="tit"><a href="javascript:void(0);" name="show_close_btn" tag_id="5000" class="closeArrow"></a>订单处理
  <div class="dobtnDiv"></div></div>
    <div id="order_tag_5000" class="formGridDiv" >
    	<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0" class="formGrid" >
          <tr>
          ...
          <tr>
	         <th colspan="6" style="text-align: center;">
	         	<a href="javascript:void(0);" id="order_openaccount_btn_submit" class="dobtn" style="margin-right:5px;">确认开户</a>
	         </th>
	       </tr>
        </table>
    </div>
