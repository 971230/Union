...
<form action="ask!listAll.do" method="get">
	<div class="toolbar">
		...
		<div>
		             关键字:<input type="text" class="ipttxt"  name="keyword" value="${keyword }"/>&nbsp;&nbsp;
		             日期：由<input type="text" class="ipttxt"  name="startTime" readonly class="dateinput" value="${startTime }"/>
		                            至<input type="text" class="ipttxt"  name="endTime" readonly class="dateinput" value="${endTime }"/><input type="submit" value="搜索"  />
		 </div>
