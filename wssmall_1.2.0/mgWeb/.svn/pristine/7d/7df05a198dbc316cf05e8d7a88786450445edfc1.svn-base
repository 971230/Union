...
<div class="grid">
	<div class="toolbar">
		...
		本月 由<select  class="ipttxt"  name="startday" id="startday">
	...
	<select  class="ipttxt"  name="endday" id="endday">
		 <option value="0">全部</option>
		 <%
		 	for(int i=1;i<=31;i++){
		 %>
		 ...
		 <input type="submit"  value="查询" />   <a href="access!history.do" >其它月份报表下载</a>
