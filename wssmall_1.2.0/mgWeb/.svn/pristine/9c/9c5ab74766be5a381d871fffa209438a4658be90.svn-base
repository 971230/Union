...
<input type="hidden" name="params.esgoodscos" id="esgoodsco" value="${numbers }" >
...
<script>
	...
	function publish() {
		...
		$("#orgids_input").val(ids);
		$("#batchForm").attr("action",$("#actionName").val());
		$.Loading.hide();
