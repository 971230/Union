...
<form action="goods!list.do?is_edit=true" method="get">
	...
	<div style="float:left;height:25px;">
			<a href="goods!add.do"><input class="comBtn" type="button" name="searchBtn" value="添加" style="margin-right:10px;outline-style:none"/></a>
			<a href="javascript:;" id="delBtn"><input class="comBtn" type="button" name="searchBtn" value="删除" style="margin-right:10px;outline-style:none"/></a>
			<a href="goods!trash_list.do"><input class="comBtn" type="button" name="searchBtn" value="回收站" style="margin-right:10px;outline-style:none"/></a>
			<a href="javascript:;" id="saveBtn"><input class="comBtn" type="button" name="searchBtn" value="保存" style="margin-right:10px;outline-style:none"/></a>
			<a href="goods!list.do" ><input class="comBtn" type="button" name="searchBtn" value="返回列表" style="margin-right:10px;outline-style:none"/></a>
	</div> 
		<div style="margin-left:10px">&nbsp;&nbsp;&nbsp;&nbsp;商品名称：<input type="text" class="ipttxt"  style="width:90px" name="name" value="${name }"/>&nbsp;&nbsp;&nbsp;&nbsp;商品编号：<input type="text" class="ipttxt"  style="width:90px" name="sn" value="${sn }"/>&nbsp;&nbsp;&nbsp;&nbsp;<span id="searchCat"></span>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit"  value="搜索"></div>
...
<%--		<grid:cell sort="cat_id"  width="150px">分类</grid:cell> --%>
  ...
  <grid:body item="goods" >
        ...
        <grid:cell><div ><input type="text" class="ipttxt"  class="editinput" value="${goods.name }" name="name" autocomplete="off" style="width:90%"  /></div></grid:cell> 
<%--        <grid:cell><div catid="${goods.cat_id }" class="catwrapper"></div></grid:cell> --%>
        <grid:cell><input type="text" class="ipttxt"  class="editinput" value="<fmt:formatNumber value="${goods.price}" type="currency" pattern="0.00"/>" name="price" autocomplete="off" style="90%"  /> </grid:cell> 
        <grid:cell><div><input type="text" class="ipttxt"  name="store" value="${goods.store}" /></div></grid:cell> 
