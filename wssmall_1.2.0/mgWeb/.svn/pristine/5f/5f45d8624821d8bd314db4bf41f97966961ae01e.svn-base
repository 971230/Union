       	...
       	<h3>
               <div class="graph_tab">
                   <ul>
                       ...
                       <li id="show_click_2" class="selected"><span class="word">添加友情链接</span><span class="bg"></span></li>
                       <div class="clear"></div>
                   </ul>
               </div>
           </h3>
 ...
 <form class="validate" method="post" action="friendsLink!addSave.do" name="theForm" id="theForm" enctype="multipart/form-data">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" class="ipttxt"  name="friendsLink.name" maxlength="60"  dataType="string" required="true" />       </td>
      </tr>
      <tr>
       <td  class="label"><label class="text">友情链接地址：</label></td>
       <td  ><input type="text" class="ipttxt"  name="friendsLink.url" maxlength="60"  dataType="string" required="true" /></td>
      </tr>
      <tr>
       <td  class="label"><label class="text">排序：</label></td>
       <td  ><input type="text" class="ipttxt"  name="friendsLink.sort" maxlength="60" dataType="int"  /></td>
      </tr>
      <tr>
