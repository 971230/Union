...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tr>
		...
		<td><input type="text" class="ipttxt"  required="true" name="bind.name"></td>
	</tr>
</table>
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	class="form-table">
	...
	<tr>
		...
		<td><input type="text" class="ipttxt"   required="true" name="bind.store"dataType="int" ></td>
	</tr>
	<tr>
		<td class="label" style="width: 100px">重量：</td>
		<td><input type="text" class="ipttxt"  name="bind.weight" readonly="readonly"  dataType="int" id="bind_weight">克(g)</td>
	</tr>
	<tr>
		<td class="label" style="width: 100px">原价格：</td>
		<td><input type="text" class="ipttxt"  name="bind.mktprice" readonly="readonly" id="bind_mktprice"></input></td>
	</tr>
	<tr>
		<td class="label" style="width: 100px">捆绑销售价：</td>
		<td><input type="text" class="ipttxt"    required="true" dataType="float"  name="bind.price">
		</td>
	</tr>
</table>
<div class="division">
