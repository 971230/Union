...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tbody>
		<tr>
			...
			<td>
			<input type="text" class="ipttxt"  name="eopSite.sitename" 
			value="${eopSite.sitename }" dataType="string" required="true" style="width:325px"/></td>
		</tr>
		<tr>
			<th>网站标题：</th>
			<td>
			<input type="text" class="ipttxt"  name="eopSite.title" 
			value="${eopSite.title }" dataType="string" required="true" style="width:325px"/></td>
		</tr>
		<tr>
			<th>页面关键词：</th>
			<td>
			<input type="text" class="ipttxt"  name="eopSite.keywords" 
...
<table cellspacing="0" cellpadding="0" border="0"
	...
	<tbody>
		<tr>
			...
			<input type="text" class="ipttxt"  name="eopSite.username" 
		...
		<tr>
			...
			<input type="text" class="ipttxt"  vtype="text" class="ipttxt" 
		...
		<tr>
			...
			<td style="width:230px">
			<input type="text" class="ipttxt"  vtype="text" class="ipttxt"  required="true" datatype="email"
...
<table cellspacing="0" cellpadding="0" border="0" width="100%"
	...
	<tbody>
		<tr>
			<th>备案号：</th>
			<td><input type="text" class="ipttxt"  vtype="text" class="ipttxt" 
				name="eopSite.icp" value="${eopSite.icp }" style="width: 176px"><span class="notice-inline">此处填写您在工信部备案管理网站申请的备案编号，详请登录<a
				target="_blank" href="http://www.miibeian.gov.cn">官方网站</a></span></td>
		</tr>
		<tr>
			<th>详细地址：</th>
			<td><span id="el-e927a-51407"><input type="text" class="ipttxt"  vtype="text" class="ipttxt"  required="true" dataType="string"
				name="eopSite.address" value="${eopSite.address }" style="width: 519px"></span></td>
		</tr>
		<tr>
			<th style="height: 34px">邮政编码：</th>
			<td style="height: 34px">
			<input type="text" class="ipttxt"  vtype="text" class="ipttxt"  required="true" dataType="zipcode"
		...
		<tr>
			...
			<td style="height: 34px">
			<input type="text" class="ipttxt"  vtype="text" class="ipttxt"  required="true" dataType="string"
