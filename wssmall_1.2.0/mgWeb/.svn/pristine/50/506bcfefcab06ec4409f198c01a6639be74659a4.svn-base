       	...
       	<h3>
               <div class="graph_tab">
                   <ul>
                       ...
                       <li id="show_click_2" class="selected"><span class="word">新增快讯列表</span><span class="bg"></span></li>
                       <div class="clear"></div>
                   </ul>
               </div>
           </h3>
...
<div class="input">
 <form class="validate" method="post" action="news!addSave.do" name="theForm" id="theForm">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table" align="center">
   
     <tr >
       <th  class="label"><label class="text" >标题：</label></th>
       <td><input type="text" class="ipttxt"  name="newsVO.title" maxlength="60" value=""  dataType="string" required="true" />       </td>
      </tr>
      <tr>
       <th><label class="text">有限期：</label></th>
       <td  ><input type="text"  class="dateinput"  class="ipttxt"  name="newsVO.end_time" maxlength="60" value=""  dataType="date" required="true" class="dateinput"/></td>
      </tr>
       <tr>
       <th><label class="text">会员：</label></th>
       <td>
       	 <c:forEach items="${lvList }" var="lv">
       	 	<input type="checkbox" name="lvids" value="${lv.lv_id }" />&nbsp;${lv.name }&nbsp;&nbsp;
       	 </c:forEach>
       </td>
      </tr>
      <tr>
