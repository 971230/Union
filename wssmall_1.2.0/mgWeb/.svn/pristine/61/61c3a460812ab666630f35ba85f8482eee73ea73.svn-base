...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	<tbody>
		<tr>
			<th>充值金额:</th>
			<td><input type="text" class="ipttxt"  name="modify_advance" size="20" dataType="float"><span><img
				border="none"
			...
			<th>备注:</th>
			<td><input type="text" class="ipttxt"  name="modify_memo" size="30"></td>
		</tr>
		<tr>
			<td colspan="4">
...
<div class="grid"><grid:grid from="listAdvanceLogs">
	...
	<grid:body item="advance">
		<grid:cell>
			<html:dateformat pattern="yyyy-MM-dd HH:mm" d_time="${advance.mtime }" />
		</grid:cell>
