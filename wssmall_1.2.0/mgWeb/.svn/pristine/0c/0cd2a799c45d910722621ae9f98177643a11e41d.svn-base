  ...
  <input type="hidden" name="oldpic" value="${freeOffer.pic }" />
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       ...
       <td  ><input type="text" class="ipttxt"  name="freeOffer.fo_name" maxlength="60" value="${freeOffer.fo_name }"  dataType="string" required="true" />       </td>
      </tr>
      <tr>
       <th><label class="text">赠品分类：</label></th>
       <td  >
       <select  class="ipttxt"  name="freeOffer.fo_category_id">
	...
	<tr>
       ...
       <td  ><input type="text" class="ipttxt"  name="mstartdate" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${freeOffer.startdate }"></html:dateformat>"  dataType="date" required="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">终止时间：</label></th>
       <td  ><input type="text" class="ipttxt"  name="menddate" maxlength="60" value="<html:dateformat pattern="yyyy-MM-dd" time="${freeOffer.enddate }"></html:dateformat>"  dataType="date" required="true" class="dateinput"/></td>
      </tr>
      <tr>
       <th><label class="text">允许兑换<br/>的会员等级：</label></th>
       <td  >
<!--       <input type="text" class="ipttxt"  name="freeOffer.lv_ids" id="freeOffer_lv_ids" maxlength="60" value="${freeOffer.lv_ids }"  dataType="string" required="true" />-->
      ...
      <tr>
       ...
       <td><input type="text" class="ipttxt"  name="freeOffer.limit_purchases" maxlength="60" id="limit_purchases" value="${freeOffer.limit_purchases }" required="true"  dataType="int" fun="chknum" /></td>
      </tr>      
      <tr>      
      <tr>
       <th><label class="text">价格：</label></th>
       <td  ><input type="text" class="ipttxt"  name="freeOffer.price" maxlength="60" value="${freeOffer.price }" required="true"   dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">简介：</label></th>
       <td  ><input type="text" class="ipttxt"  name="freeOffer.synopsis" maxlength="60" value="${freeOffer.synopsis }"  dataType="string"  /></td>
      </tr>
		<tr>
      ...
      <tr>
       ...
       <td  ><input type="text" class="ipttxt"  name="freeOffer.score" maxlength="60" value="${freeOffer.score }" required="true"  dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">重量：</label></th>
       <td  ><input type="text" class="ipttxt"  name="freeOffer.weight" maxlength="60" value="${freeOffer.weight }" required="true"   dataType="float"  /></td>
      </tr>
      <tr>
       <th><label class="text">库存：</label></th>
       <td  ><input type="text" class="ipttxt"  name="freeOffer.repertory" maxlength="60" value="${freeOffer.repertory }" required="true"  dataType="int"  /></td>
      </tr>
	<tr>
