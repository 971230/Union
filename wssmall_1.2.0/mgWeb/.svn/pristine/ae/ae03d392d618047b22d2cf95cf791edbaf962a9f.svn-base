...
<table  class="form-table">
	<tr>
		...
		<td>
		<input type="password"  class="ipttxt"  name="oldpassword" id="oldpassword"  dataType="string" required="true" style="width:260px;" />
		</td>
	</tr>
	<tr height="30px">
		<th><label class="text">请输入新密码：</label></th>
		<td><input type="password"  class="ipttxt"  name="password" id="password" class="password" style="width:260px;"/></td>
	</tr>
	<tr>
		<th><label class="text">确认新密码：</label></th>
		<td>
			<input type="password"  class="ipttxt"  name="newpassword" id="newpassword" dataType="string" required="true" fun="checkPassword" style="width:260px;" />
		</td>
	</tr>
