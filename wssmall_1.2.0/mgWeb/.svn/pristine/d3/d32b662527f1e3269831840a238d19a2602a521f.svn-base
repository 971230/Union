...
<table cellspacing="1" cellpadding="3" width="100%" style="height: 400px;width:300" class="form-table">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="ipttxt" id="default_value" name="goodsAttrDef.default_value" value="${goodsAttrDef.default_value }" required="true" autocomplete="on" dataType="string">
        </td>
    </tr>
    <tr>
        <th ><label class="text"><span class='red'>* </span>缺省值描述：</label></th>
        <td>
            <input type="text" class="ipttxt" id="default_value_desc" name="goodsAttrDef.default_value_desc" value="${goodsAttrDef.default_value_desc }" required="true" autocomplete="on" dataType="string">
        </td>
    </tr>
     <tr>
