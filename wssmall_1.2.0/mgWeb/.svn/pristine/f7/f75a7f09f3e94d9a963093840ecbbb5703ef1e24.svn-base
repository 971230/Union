...
<form  class="validate" method="post" action="" id='common_form_c' validate="true">
...
<c:forEach items="${giftList}" var="gift" >
 ...
 <table>
	 <tr>
	 	<td >
           <input  type="button"  value=" 允许退货 " class="submitBtn" name='allowReturnBtn_c'/>
           <input  type="button"  value=" 拒绝退货 " class="submitBtn" name='notallowReturnBtn_c' style="display: none;"/>
	   </td>
	</tr>
 </table>
</div> 
