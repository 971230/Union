...
<input type="hidden" name="cps" value="yes" />
<div class="tableform">
<div class="division">
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
  <tbody><tr>
    <th>名称:</td>
    <td><input type="text" class="ipttxt"  required="true" name="coupons.cpns_name"></td>
  </tr>
  </tbody></table>
</div>
<div class="division">
<table cellspacing="0" cellpadding="0" border="0" width="100%" class="form-table">
  <tbody><tr>
    <th>号码:B</th>
      <td><span id="c_p"></span><input type="text" class="ipttxt"  required="true" name="coupons.cpns_prefix" ></td>
    </tr>
  <tr>
    <th>状态:</th>
  ...
  <tr>
    ...
    <input type="radio" checked="checked" value="0" name="coupons.cpns_type" class="cpnstype">A类优惠券&nbsp;&nbsp;<span class="fontcolorGray">说明：此类优惠券，顾客只需获得一张，即可在规定的时间内重复使用。</span><br>
     -->
    <input type="radio" value="1" name="coupons.cpns_type" checked class="cpnstype">B类优惠券&nbsp;&nbsp;<span class="fontcolorGray">说明：此类优惠券，顾客可一次获得多张，但在规定时间内每张只能使用一次，无法重复使用。</span></td>
  </tr>
</tbody></table>
</div>
