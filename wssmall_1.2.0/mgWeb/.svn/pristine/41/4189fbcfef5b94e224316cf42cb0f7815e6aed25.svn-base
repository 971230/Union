...
function(e, t) {
	...
	return function(e) {
		...
		n = [i(1), i(2), i(3)], o = function(e, t, i) {
			...
			return n.modes = {}, n.prototype._create = function(e, t, i) {
				...
				try {
					var l = "text" == a.data;
					if (o = this.getName(), t = this[l ? "getText" : "get"](), this._delete(), i.clear(this), i.extend(this, a.mixin), this.create(s, r), this.setName(o), this[l ? "setText" : "set"](t), "function" == typeof a.load) try {
						a.load.call(this)
					} catch (c) {}
				} catch (c) {
					this._onError(c)
				...
				var t, o;
				if (i.isArray(e)) for (t = 0; t < e.length; t++) n.registerMode(e[t]);
				else {
		...
		n = [i(4), i(5), i(6), i(7), i(8), i(3)], o = function(e, t, i, n, o, s) {
			...
			return r.set = function(e, t) {
				if (t && (s.log('Warning: second parameter "name" is deprecated. Use setName(name) instead.'), this.options.name = t), e instanceof Function || void 0 === e) this.clear();
				else {
				...
				if (r.title = "Collapse all fields", r.className = "collapse-all", r.onclick = function() {
					...
					l.className = "redo", l.title = "Redo (Ctrl+Shift+Z)", l.onclick = function() {
						t._onRedo()
					}, this.menu.appendChild(l), this.dom.redo = l, this.history.onChange = function() {
						a.disabled = !t.history.canUndo(), l.disabled = !t.history.canRedo()
				...
				var t = e.target;
				"keydown" == e.type && this._onKeyDown(e), "focus" == e.type && (l = t);
				...
				if (9 == t && setTimeout(function() {
					s.selectContentEditable(l)
				}, 0), this.searchBox) if (i && 70 == t) this.searchBox.dom.search.focus(), this.searchBox.dom.search.select(), o = !0;
		...
		n = [i(8), i(3)], o = function(e, t) {
			...
			return i.create = function(i, n) {
				...
				if (this.content = document.createElement("div"), this.content.className = "outer", this.frame.appendChild(this.content), this.container.appendChild(this.frame), "code" == this.mode) {
					...
					l.setTheme("ace/theme/jsoneditor"), l.setShowPrintMargin(!1), l.setFontSize(13), l.getSession().setMode("ace/mode/json"), l.getSession().setTabSize(2), l.getSession().setUseSoftTabs(!0), l.getSession().setUseWrapMode(!0), this.editor = l;
					var c = document.createElement("a");
					c.appendChild(document.createTextNode("powered by ace")), c.href = "http://ace.ajax.org", c.target = "_blank", c.className = "poweredBy", c.onclick = function() {
						window.open(c.href, c.target)
					}, this.menu.appendChild(c), n.change && l.on("change", function() {
						n.change()
					})
				} else {
					var h = document.createElement("textarea");
					h.className = "text", h.spellcheck = !1, this.content.appendChild(h), this.textarea = h, n.change && (null === this.textarea.oninput ? this.textarea.oninput = function() {
						n.change()
				...
				var e, i = this.getText();
				try {
					e = t.parse(i)
				} catch (n) {
					i = t.sanitize(i), this.setText(i), e = t.parse(i)
				}
				return e
			}, i.getText = function() {
			...
			e.isUrl = function(e) {
				...
				for (var i = t.childNodes, n = 0, o = i.length; o > n; n++) {
					...
					if (r) for (var a = r.length - 1; a >= 0; a--) {
						var l = r[a];
						1 == l.specified && s.removeAttribute(l.name)
					}
					e.stripFormatting(s)
				}
				...
				return t && "startOffset" in t && "endOffset" in t && t.startContainer && t.startContainer == t.endContainer ? {
		...
		n = [i(3)], o = function(e) {
			...
			return t.prototype.onChange = function() {}, t.prototype.add = function(e, t) {
		...
		n = function() {
			function e(e, t) {
				...
				c.appendChild(h), s = document.createElement("tr"), h.appendChild(s);
				var d = document.createElement("button");
				d.className = "refresh", r = document.createElement("td"), r.appendChild(d), s.appendChild(r);
				...
				g.title = "Next result (Enter)", g.className = "next", g.onclick = function() {
					i.next()
				}, r = document.createElement("td"), r.appendChild(g), s.appendChild(r);
		...
		n = [i(9), i(10), i(3)], o = function(e, t, i) {
			...
			n.prototype._updateEditability = function() {
				...
				if ("array" == this.type) {
					this.childs = [];
					for (var r = 0, a = e.length; a > r; r++) i = e[r], void 0 === i || i instanceof Function || (o = new n(this.editor, {
						value: i
					}), this.appendChild(o));
					this.value = ""
				...
				if (e) {
					var t = this.value,
						n = "auto" == this.type ? i.type(t) : this.type,
						o = "string" == n && i.isUrl(t),
						s = "";
				...
				return e.tr.appendChild(s), e.tree = this._createDomTree(), s.appendChild(e.tree), this.updateDom({
					updateIndexes: !0
				}), e.tr
				...
				var t, s, r, a, l, c, h, d, u, g, f, p, m, v, A = e.pageY,
					C = e.pageX,
					w = !1;
				if (t = this.dom.tr, u = i.getAbsoluteTop(t), p = t.offsetHeight, u > A) {
					s = t;
					do s = s.previousSibling, h = n.getNodeFromTarget(s), g = s ? i.getAbsoluteTop(s) : 0;
					while (s && g > A);
					h && !h.parent && (h = void 0), h || (c = t.parentNode.firstChild, s = c ? c.nextSibling : void 0, h = n.getNodeFromTarget(s), h == this && (h = void 0)), h && (s = h.dom.tr, g = s ? i.getAbsoluteTop(s) : 0, A > g + p && (h = void 0)), h && (h.parent.moveBefore(this, h), w = !0)
				} else if (l = this.expanded && this.append ? this.append.getDom() : this.dom.tr, a = l ? l.nextSibling : void 0) {
					f = i.getAbsoluteTop(a), r = a;
					do d = n.getNodeFromTarget(r), r && (m = r.nextSibling ? i.getAbsoluteTop(r.nextSibling) : 0, v = r ? m - f : 0, 1 == d.parent.childs.length && d.parent.childs[0] == this && (u += 23)), r = r.nextSibling;
					while (r && A > u + v);
					if (d && d.parent) {
						var E = C - this.drag.mouseX,
							F = Math.round(E / 24 / 2),
							b = this.drag.level + F,
							y = d.getLevel();
						for (s = d.dom.tr.previousSibling; b > y && s;) {
							if (h = n.getNodeFromTarget(s), h == this || h._isChildOf(this));
							else {
								if (!(h instanceof o)) break;
								var x = h.parent.childs;
								if (!(x.length > 1 || 1 == x.length && x[0] != this)) break;
								d = n.getNodeFromTarget(s), y = d.getLevel()
							}
							s = s.previousSibling
						}
						l.nextSibling != d.dom.tr && (d.parent.moveBefore(this, d), w = !0)
					}
				}
				w && (this.drag.mouseX = C, this.drag.level = this.getLevel()), this.editor.startAutoScroll(A), e.preventDefault()
				...
				if ((o == s.drag || o == s.menu) && ("mouseover" == n ? this.editor.highlighter.highlight(this) : "mouseout" == n && this.editor.highlighter.unhighlight()), "mousedown" == n && o == s.drag && this._onDragStart(e), "click" == n && o == s.menu) {
					...
					l.highlight(r), l.lock(), i.addClassName(s.menu, "selected"), this.showContextMenu(s.menu, function() {
						i.removeClassName(s.menu, "selected"), l.unlock(), l.unhighlight()
					})
				}
				...
				case "click":
					var g = void 0 != e.offsetX ? e.offsetX < 24 * (this.getLevel() + 1) : e.pageX < i.getAbsoluteLeft(s.tdSeparator);
					g || a ? d && (i.setEndOfContentEditable(d), d.focus()) : h && (i.setEndOfContentEditable(h), h.focus())
				}
				if (o == s.tdExpand && !a || o == s.tdField || o == s.tdSeparator) switch (n) {
				case "click":
					d && (i.setEndOfContentEditable(d), d.focus())
				}
				"keydown" == n && this.onKeyDown(e)
			}, n.prototype.onKeyDown = function(e) {
				var t, s, r, a, l = e.which || e.keyCode,
				...
				if (13 == l) {
					if (c == this.dom.value)(!this.editable.value || e.ctrlKey) && i.isUrl(this.value) && (window.open(this.value, "_blank"), g = !0);
				...
				else if (69 == l) h && (this._onExpand(d), c.focus(), g = !0);
				else if (77 == l && f) h && (this.showContextMenu(c), g = !0);
				else if (46 == l && f) h && (this._onRemove(), g = !0);
				else if (45 == l && f) h && !d ? (this._onInsertBefore(), g = !0) : h && d && (this._onInsertAfter(), g = !0);
				else if (35 == l) {
					if (u) {
					...
					if (u && !d) {
						var C = this._previousElement(c);
						C && this.focus(this._getElementName(C)), g = !0
					} else if (u && d && f) {
						if (this.expanded) {
							var w = this.getAppend();
							r = w ? w.nextSibling : void 0
						} else {
							var E = this.getDom();
							r = E.nextSibling
						}
						r && (s = n.getNodeFromTarget(r), a = r.nextSibling, y = n.getNodeFromTarget(a), s && s instanceof o && 1 != this.parent.childs.length && y && y.parent && (y.parent.moveBefore(this, y), this.focus(n.focusElement || this._getElementName(c))))
					}
				} else if (38 == l) u && !d ? (t = this._previousNode(), t && t.focus(n.focusElement || this._getElementName(c)), g = !0) : u && d && (t = this._previousNode(), t && t.parent && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(c))), g = !0);
				else if (39 == l) {
					if (u && !d) {
						...
						b && (t = n.getNodeFromTarget(b), t && t.parent && t instanceof o && !t.isVisible() && (t.parent.moveBefore(this, t), this.focus(n.focusElement || this._getElementName(c))))
					}
				} else if (40 == l) if (u && !d) s = this._nextNode(), s && s.focus(n.focusElement || this._getElementName(c)), g = !0;
				else if (u && d && f) {
					...
					var y = n.getNodeFromTarget(a);
					y && y.parent && (y.parent.moveBefore(this, y), this.focus(n.focusElement || this._getElementName(c))), g = !0
				}
				...
				if (this.parent && this.parent._hasChilds()) {
					...
					var l = o.parent.childs;
					o == l[l.length - 1] && r.push({
						text: "Append",
		...
		n = [i(9)], o = function(e) {
			function t(t, i, n) {
				...
				for (var s = {
					...
					c.className = "type-modes" + (n == l ? " selected" : ""), r.push(c)
				}
				var h = s[n];
				if (!h) throw new Error('Unknown mode "' + n + '"');
				var d = h.text,
					u = document.createElement("button");
				return u.className = "modes separator", u.innerHTML = d + " &#x25BE;", u.title = "Switch editor mode", u.onclick = function() {
					var t = new e(r);
					t.show(u)
				}, u
			}
		...
		n = [i(3)], o = function(e) {
				...
				function i(e, t, o) {
					o.forEach(function(o) {
						if ("separator" == o.type) {
							...
							e.appendChild(a);
							var l = document.createElement("button");
							if (l.className = o.className, r.button = l, o.title && (l.title = o.title), o.click && (l.onclick = function() {
								n.hide(), o.click()
								...
								if (o.click) {
									l.className += " default";
									var d = document.createElement("button");
									r.buttonExpand = d, d.className = "expand", d.innerHTML = '<div class="expand"></div>', a.appendChild(d), o.submenuTitle && (d.title = o.submenuTitle), h = d
								} else {
									var u = document.createElement("div");
									u.className = "expand", l.appendChild(u), h = l
								}
								h.onclick = function() {
									n._onExpandItem(r), h.focus()
								};
								var g = [];
								r.subItems = g;
								var f = document.createElement("ul");
								r.ul = f, f.className = "menu", f.style.height = "0", a.appendChild(f), i(f, g, o.submenu)
			...
			return t.prototype._getVisibleButtons = function() {
				...
				var n = window.innerHeight,
					o = window.pageYOffset || document.scrollTop || 0,
					s = n + o,
					r = i.offsetHeight,
					a = this.maxHeight,
					l = e.getAbsoluteLeft(i),
					c = e.getAbsoluteTop(i);
				s > c + r + a ? (this.dom.menu.style.left = l + "px", this.dom.menu.style.top = c + r + "px", this.dom.menu.style.bottom = "") : (this.dom.menu.style.left = l + "px", this.dom.menu.style.top = "", this.dom.menu.style.bottom = n - c + "px"), document.body.appendChild(this.dom.menu);
				var h = this,
					d = this.dom.list;
				this.eventListeners.mousedown = e.addEventListener(document, "mousedown", function(e) {
					var t = e.target;
					t == d || h._isChildOf(t, d) || (h.hide(), e.stopPropagation(), e.preventDefault())
				...
				var i, n, o, s, r = t.target,
					a = t.which,
					l = !1;
				27 == a ? (this.selection && e.setSelection(this.selection), this.anchor && this.anchor.focus(), this.hide(), l = !0) : 9 == a ? t.shiftKey ? (i = this._getVisibleButtons(), n = i.indexOf(r), 0 == n && (i[i.length - 1].focus(), l = !0)) : (i = this._getVisibleButtons(), n = i.indexOf(r), n == i.length - 1 && (i[0].focus(), l = !0)) : 37 == a ? ("expand" == r.className && (i = this._getVisibleButtons(), n = i.indexOf(r), o = i[n - 1], o && o.focus()), l = !0) : 38 == a ? (i = this._getVisibleButtons(), n = i.indexOf(r), o = i[n - 1], o && "expand" == o.className && (o = i[n - 2]), o || (o = i[i.length - 1]), o && o.focus(), l = !0) : 39 == a ? (i = this._getVisibleButtons(), n = i.indexOf(r), s = i[n + 1], s && "expand" == s.className && s.focus(), l = !0) : 40 == a && (i = this._getVisibleButtons(), n = i.indexOf(r), s = i[n + 1], s && "expand" == s.className && (s = i[n + 2]), s || (s = i[0]), s && (s.focus(), l = !0), l = !0), l && (t.stopPropagation(), t.preventDefault())
	...
	function e(e) {
		var t = function(e, t) {
			...
			s = i;
		e && (i[e] || (i[e] = {}), s = i[e]), s.define && s.define.packaged || (n.original = s.define, s.define = n, s.define.packaged = !0), s.require && s.require.packaged || (o.original = s.require, s.require = t, s.require.packaged = !0)
	}
	var t = "",
		i = function() {
			return this
	...
	if (t || "undefined" == typeof requirejs) {
		var n = function(e, t, i) {
				return "string" != typeof e ? void(n.original ? n.original.apply(window, arguments) : (console.error("dropping module because define wasn't a string."), console.trace())) : (2 == arguments.length && (i = t), n.modules || (n.modules = {}, n.payloads = {}), n.payloads[e] = i, n.modules[e] = null, void 0)
			},
			o = function(e, t, i) {
				if ("[object Array]" === Object.prototype.toString.call(t)) {
					for (var n = [], s = 0, a = t.length; a > s; ++s) {
						var l = r(e, t[s]);
				...
				if (!i) {
					if (i = n.payloads[t], "function" == typeof i) {
						var r = {},
							...
							c = i(l, r, a);
						r = c || a.exports, n.modules[t] = r, delete n.payloads[t]
					}
					i = n.modules[t] = r || i
				}
				return i
	...
	e("./worker/worker_client"), e("./keyboard/hash_handler"), e("./placeholder"), e("./multi_select"), e("./mode/folding/fold_mode"), e("./theme/textmate"), e("./ext/error_marker"), t.config = e("./config"), t.require = e, t.edit = function(e) {
		if ("string" == typeof e) {
			var s = e;
			if (e = document.getElementById(s), !e) throw new Error("ace.edit can't find div #" + s)
		}
	...
	(function() {
		this.addRules = function(e, t) {
			...
			return this.$rules
		}, this.embedRules = function(e, t, n, o, s) {
			var r = "function" == typeof e ? (new e).getRules() : e;
			if (o) for (var a = 0; a < o.length; a++) o[a] = t + o[a];
			else {
				o = [];
				for (var l in r) o.push(t + l)
			}
			if (this.addRules(r, t), n) for (var c = Array.prototype[s ? "push" : "unshift"], a = 0; a < o.length; a++) c.apply(this.$rules[o[a]], i.deepCopy(n));
		...
		this.normalizeRules = function() {
			...
			return Object.keys(e).forEach(function(t) {
				var s = e[t];
				i && (s = s.toLowerCase());
				for (var r = s.split(n || "|"), a = r.length; a--;) o[r[a]] = t
			}), Object.getPrototypeOf(o) && (o.__proto__ = null), this.$keywordList = Object.keys(o), e = null, i ?
			function(e) {
		...
		i.implement(this, n), this.getPosition = function() {
			...
			if ((i.start.row != i.end.row || i.start.row == this.row) && !(i.start.row > this.row || i.start.row == this.row && i.start.column > this.column)) {
				var n = this.row,
					...
					s = i.start,
					r = i.end;
				"insertText" === t.action ? s.row === n && s.column <= o ? s.column === o && this.$insertRight || (s.row === r.row ? o += r.column - s.column : (o -= s.column, n += r.row - s.row)) : s.row !== r.row && s.row < n && (n += r.row - s.row) : "insertLines" === t.action ? (s.row !== n || 0 !== o || !this.$insertRight) && s.row <= n && (n += r.row - s.row) : "removeText" === t.action ? s.row === n && s.column < o ? o = r.column >= o ? s.column : Math.max(0, o - (r.column - s.column)) : s.row !== r.row && s.row < n ? (r.row === n && (o = Math.max(0, o - r.column) + s.column), n -= r.row - s.row) : r.row === n && (n -= r.row - s.row, o = Math.max(0, o - r.column) + s.column) : "removeLines" == t.action && s.row <= n && (r.row <= n ? n -= r.row - s.row : (n = s.row, o = 0)), this.setPosition(n, o, !0)
			}
			...
			this.$worker = function() {
				if (t.running) {
					...
					for (t.running = !1; r > i;) {
						...
						do i++;
						while (t.lines[i]);
						if (a++, a % 5 == 0 && new Date - e > 20) return t.running = setTimeout(t.$worker, 20), void(t.currentLine = i)
					}
					t.currentLine = i, n >= s && t.fireUpdateEvent(s, n)
				}
			}
		};
	(function() {
	...
	(function() {
		...
		}, this.update = function(e, t, o, s) {
			if (this.regExp) for (var r = s.firstRow, a = s.lastRow, l = r; a >= l; l++) {
				var c = this.cache[l];
				...
				for (var h = c.length; h--;) t.drawSingleLineMarker(e, c[h].toScreenRange(o), this.clazz, s)
			}
		}
	...
	function i() {
		this.getFoldAt = function(e, t, i) {
			...
			if (!n) return null;
			for (var o = n.folds, s = 0; s < o.length; s++) {
				var r = o[s];
			...
			for (var s = 0; s < n.length; s++) {
				var r = n[s].range.compareRange(e);
				if (2 != r) {
					if (-2 == r) break;
			...
			for (var o, s, r = {
				...
				s = n.folds[a];
				var l = s.range.compareEnd(e, t);
				if (-1 == l) {
					o = this.getLine(s.start.row).substring(r.end.column, s.start.column);
					break
				}
				if (0 === l) return null;
				r = s
			}
			return o || (o = this.getLine(s.start.row).substring(r.end.column)), -1 == i ? o.substring(0, t - r.end.column) : 1 == i ? o.substring(t - r.end.column) : o
			...
			if (c > a || a == c && h - 2 >= l) {
				...
				if (d && !d.range.isStart(a, l) || u && !u.range.isEnd(c, h)) throw new Error("A fold can't intersect already existing fold" + i.range + d.range);
				...
				return r || (p = this.$addFoldLine(new o(this.$foldData, i))), this.$useWrapMode ? this.$updateWrapData(p.start.row, p.start.row) : this.$updateRowLengthCache(p.start.row, p.start.row), this.$modified = !0, this._emit("changeFold", {
					data: i,
					action: "add"
				}), i
			}
			...
			var t = e.foldLine,
				...
				o = this.$foldData,
				s = t.folds;
			if (1 == s.length) o.splice(o.indexOf(t), 1);
				...
				s = r.folds, s.shift(), r.start.row = s[0].start.row, r.start.column = s[0].start.column
			}
			...
			else for (var s = o; s.length;) this.expandFolds(s), s = this.getFoldsInRangeList(i);
			...
			if (!o) {
				var s;
				return s = this.doc.getLine(e), s.substring(n || 0, t || s.length)
			}
			...
			if (o.isEmpty()) {
				...
				(i = this.findMatchingBracket(s)) ? 1 == o.comparePoint(i) ? o.end = i : (o.start = i, o.start.column++, o.end.column--) : (i = this.findMatchingBracket({
					row: s.row,
					column: s.column + 1
				})) ? (1 == o.comparePoint(i) ? o.end = i : o.start = i, o.start.column++) : o = this.getCommentFoldRange(s.row, s.column) || o
			} else {
			...
			var o = new r(this, e, t),
				s = o.getCurrentToken();
			if (s && /^comment|string/.test(s.type)) {
				var a = new n,
					l = new RegExp(s.type.replace(/\..*/, "\\."));
				if (1 != i) {
					do s = o.stepBackward();
					while (s && l.test(s.type));
					o.stepForward()
				}
				if (a.start.row = o.getCurrentTokenRow(), a.start.column = o.getCurrentTokenColumn() + 2, o = new r(this, e, t), -1 != i) {
					do s = o.stepForward();
					while (s && l.test(s.type));
					s = o.stepBackward()
				} else s = o.getCurrentToken();
				return a.end.row = o.getCurrentTokenRow(), a.end.column = o.getCurrentTokenColumn() + s.value.length - 2, a
			}
			...
			for (var n, o = e - 1; o >= 0;) {
				var s = i[o];
				if (null == s && (s = i[o] = this.getFoldWidget(o)), "start" == s) {
			...
			if (this.getFoldWidget) {
				var i = this.getFoldWidget(e),
					n = this.getLine(e),
					o = "end" === i ? -1 : 1,
					s = this.getFoldAt(e, -1 === o ? 0 : n.length, o);
				if (s) return void(t.children || t.all ? this.removeFold(s) : this.expandFold(s));
				var r = this.getFoldWidgetRange(e, !0);
				if (r && !r.isMultiLine() && (s = this.getFoldAt(r.start.row, r.start.column, 1), s && r.isEqual(s.range))) return void this.removeFold(s);
				if (t.siblings) {
					var a = this.getParentFoldRangeData(e);
					if (a.range) var l = a.range.start.row + 1,
						c = a.range.end.row;
					this.foldAll(l, c, t.all ? 1e4 : 0)
				} else t.children ? (c = r ? r.end.row : this.getLength(), this.foldAll(e + 1, r.end.row, t.all ? 1e4 : 0)) : r && (t.all && (r.collapseChildren = 1e4), this.addFold("...", r));
				return r
			}
			...
			if (0 === o) this.foldWidgets[n] = null;
				...
				var s = Array(o + 1);
				s.unshift(n, 1), this.foldWidgets.splice.apply(this.foldWidgets, s)
			}
		}
	}
	var n = e("../range").Range,
	...
	(function() {
		this.shiftRow = function(e) {
			...
			for (var c = 0; c < a.length; c++) {
				if (n = a[c], o = n.range.compareStart(t, i), -1 == o) return void e(null, t, i, r, l);
				if (s = e(null, n.start.row, n.start.column, r, l), s = !s && e(n.placeholder, n.start.row, n.start.column, r), s || 0 == o) return;
			...
			var n, o, s = this.getNextFoldTo(e, t);
			if (s) if (n = s.fold, "inside" == s.kind && n.start.column != t && n.start.row != e) window.console && window.console.log(e, t, n);
			else if (n.start.row == e) {
				o = this.folds;
				var r = o.indexOf(n);
				for (0 == r && (this.start.column += i), r; r < o.length; r++) {
					if (n = o[r], n.start.column += i, !n.sameRow) return;
					n.end.column += i
				}
				this.end.column += i
			}
			...
			var r = o.indexOf(n),
				a = o[r - 1];
			this.end.row = a.end.row, this.end.column = a.end.column, o = o.splice(r, o.length - r);
			var l = new i(s, o);
	...
	var i = 1e3,
		n = function(e) {
			...
			for (var t in this.states) {
				for (var i = this.states[t], n = [], o = 0, s = this.matchMappings[t] = {
					defaultToken: "text"
				}, r = "g", a = [], l = 0; l < i.length; l++) {
					var c = i[l];
					if (c.defaultToken && (s.defaultToken = c.defaultToken), c.caseInsensitive && (r = "gi"), null != c.regex) {
						c.regex instanceof RegExp && (c.regex = c.regex.toString().slice(1, -1));
						var h = c.regex,
							d = new RegExp("(?:(" + h + ")|(.))").exec("a").length - 2;
						if (Array.isArray(c.token)) if (1 == c.token.length || 1 == d) c.token = c.token[0];
						else {
						...
						}) : (d = 1, h = this.removeCapturingGroups(c.regex)), !c.splitRegex && "string" != typeof c.token && a.push(c)), s[o] = l, o += d, n.push(h), c.onMatch || (c.onMatch = null)
					}
				}
	...
	(function() {
		this.$setMaxTokenCount = function(e) {
			...
			for (var n = [], o = 0, s = i.length; s > o; o++) t[o] && (n[n.length] = {
				type: i[o],
				value: t[o]
			});
			return n
			...
			if (!t) return "text";
			for (var i = [], n = this.tokenArray, o = 0, s = n.length; s > o; o++) t[o + 1] && (i[i.length] = {
				type: n[o],
				value: t[o + 1]
			});
			return i
			...
			if (-1 != e.indexOf("(?=")) {
				...
				e.replace(/(\\.)|(\((?:\?[=!])?)|(\))|([\[\]])/g, function(e, t, s, r, a, l) {
					return n ? n = "]" != a : a ? n = !0 : r ? (i == o.stack && (o.end = l + 1, o.stack = -1), i--) : s && (i++, 1 != s.length && (o.stack = i, o.start = l)), e
			...
			var o = t || "start",
				s = this.states[o];
			s || (o = "start", s = this.states[o]);
			var r = this.matchMappings[o],
				a = this.regExps[o];
			a.lastIndex = 0;
			for (var l, c = [], h = 0, d = {
				type: null,
				...
				var u = r.defaultToken,
					...
					p = a.lastIndex;
				if (p - f.length > h) {
					var m = e.substring(h, p - f.length);
					d.type == u ? d.value += m : (d.type && c.push(d), d = {
						type: u,
						value: m
					})
				}
				for (var v = 0; v < l.length - 2; v++) if (void 0 !== l[v + 1]) {
					g = s[r[v]], u = g.onMatch ? g.onMatch(f, o, n) : g.token, g.next && (o = "string" == typeof g.next ? g.next : g.next(o, n), s = this.states[o], s || (window.console && console.error && console.error(o, "doesn't exist"), o = "start", s = this.states[o]), r = this.matchMappings[o], h = p, a = this.regExps[o], a.lastIndex = p);
					break
				}
				if (f) if ("string" == typeof u) g && g.merge === !1 || d.type !== u ? (d.type && c.push(d), d = {
					type: u,
					value: f
				}) : d.value += f;
				else if (u) {
					...
					for (var v = 0; v < u.length; v++) c.push(u[v])
				}
				if (h == e.length) break;
				if (h = p, c.length > i) {
					for (; h < e.length;) d.type && c.push(d), d = {
			...
			return d.type && c.push(d), n.length > 1 && n[0] !== o && n.unshift(o), {
				tokens: c,
				state: n.length ? n : o
			}
		}
	...
	a.inherits(l, r), function() {
		this.toString = function() {
			...
			if (!this.range.isEqual(e)) {
				...
				n(e, this.start);
				for (var t = e.start.row, i = e.start.column, o = 0, s = -1; o < this.subFolds.length && (s = this.subFolds[o].range.compare(t, i), 1 == s); o++);
				var r = this.subFolds[o];
				if (0 == s) return r.addSubFold(e);
				for (var t = e.range.end.row, i = e.range.end.column, a = o, s = -1; a < this.subFolds.length && (s = this.subFolds[a].range.compare(t, i), 1 == s); a++); {
					this.subFolds[a]
				}
	...
	(function() {
		this.tokenRe = new RegExp("^[" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + s.packages.L + s.packages.Mn + s.packages.Mc + s.packages.Nd + s.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function() {
			return this.$tokenizer || (this.$highlightRules = new this.HighlightRules, this.$tokenizer = new i(this.$highlightRules.getRules())), this.$tokenizer
		}, this.lineCommentStart = "", this.blockComment = "", this.toggleCommentLines = function(e, t, i, n) {
			function o(e) {
				for (var t = i; n >= t; t++) e(s.getLine(t), t)
			}
			var s = t.doc,
				a = !0,
				l = !0,
			...
			if (this.lineCommentStart) {
				...
				var f = function(e, t) {
					...
					p = g + " ",
					m = function(e, t) {
						(!a || /\S/.test(e)) && (A(e, c, c) ? s.insertInLine({
							row: t,
							column: c
						}, p) : s.insertInLine({
							row: t,
				...
				var g = this.blockComment.start,
					C = this.blockComment.end,
					u = new RegExp("^(\\s*)(?:" + r.escapeRegExp(g) + ")"),
					w = new RegExp("(?:" + r.escapeRegExp(C) + ")\\s*$"),
					m = function(e, t) {
						v(e, t) || (!a || /\S/.test(e)) && (s.insertInLine({
							row: t,
							column: e.length
						}, C), s.insertInLine({
							row: t,
					...
					f = function(e, t) {
						var i;
						(i = e.match(w)) && s.removeInLine(t, e.length - i[0].length, e.length), (i = e.match(u)) && s.removeInLine(t, i[1].length, i[0].length)
					},
					v = function(e, i) {
			...
			if (o) {
				...
				if (h && /comment/.test(h.type)) {
					...
					g && t.remove(g), u && (t.remove(u), s = u.start.row, r = -o.start.length)
				} else r = o.start.length, s = i.start.row, t.insert(i.end, o.end), t.insert(i.start, o.start);
				d.start.row == s && (d.start.column += r), d.end.row == s && (d.end.column += r), t.selection.fromOrientedRange(d)
			}
			...
			if (!this.completionKeywords) {
				var t = this.$tokenizer.rules,
					i = [];
				for (var n in t) for (var o = t[n], s = 0, r = o.length; r > s; s++) if ("string" == typeof o[s].token) / keyword | support | storage / .test(o[s].token) && i.push(o[s].regex);
				else if ("object" == typeof o[s].token) for (var a = 0, l = o[s].token.length; l > a; a++) if (/keyword|support|storage/.test(o[s].token[a])) {
					var n = o[s].regex.match(/\(.+?\)/g)[a];
	...
	(function() {
		this.comparePoints = n, this.pointIndex = function(e, t, i) {
			for (var o = this.ranges, s = i || 0; s < o.length; s++) {
				var r = o[s],
					a = n(e, r.end);
				if (!(a > 0)) {
					var l = n(e, r.start);
			...
			for (var i, o = t[0], s = 1; s < t.length; s++) {
				i = o, o = t[s];
				var r = n(i.end, o.start);
				0 > r || (0 != r || i.isEmpty() || o.isEmpty()) && (n(i.end, o.end) < 0 && (i.end.row = o.end.row, i.end.column = o.end.column), t.splice(s, 1), e.push(o), o = i, s--)
			}
			...
			0 > o && (o = -o - 1);
			for (var s = [], r = n; o > r; r++) s.push(i[r]);
			return s
			...
			if ("i" == e.data.action[0]) var i = t.start,
				...
				i = t.end;
			for (var o = i.row, s = n.row, r = s - o, a = -i.column + n.column, l = this.ranges, c = 0, h = l.length; h > c; c++) {
				var d = l[c];
				if (!(d.end.row < o)) {
					if (d.start.row > o) break;
					if (d.start.row == o && d.start.column >= i.column && (d.start.column != i.column || !this.$insertRight) && (d.start.column += a, d.start.row += r), d.end.row == o && d.end.column >= i.column) {
						if (d.end.column == i.column && this.$insertRight) continue;
						d.end.column == i.column && a > 0 && h - 1 > c && d.end.column > d.start.column && d.end.column == l[c + 1].start.column && (d.end.column -= a), d.end.column += a, d.end.row += r
					}
				}
			}
			if (0 != r && h > c) for (; h > c; c++) {
				var d = l[c];
	...
	(function() {
		this.isEqual = function(e) {
			...
			return n.fromPoints(o || this.start, s || this.end)
	...
	function i() {
		this.findMatchingBracket = function(e, t) {
			...
			if (a || (a = r.stepForward()), a) {
				...
				for (var l = t.column - r.getCurrentTokenColumn() - 2, c = a.value;;) {
					for (; l >= 0;) {
						var h = c.charAt(l);
						if (h == o) {
							if (s -= 1, 0 == s) return {
	...
	(function() {
		i.implement(this, o), this.isEmpty = function() {
			...
			var s = this.session.getFoldAt(t, i, 1);
			return s ? void this.moveCursorTo(s.end.row, s.end.column) : ((e = this.session.nonTokenRe.exec(o)) && (i += this.session.nonTokenRe.lastIndex, this.session.nonTokenRe.lastIndex = 0, o = n.substring(i)), i >= n.length ? (this.moveCursorTo(t, n.length), this.moveCursorRight(), t < this.doc.getLength() - 1 && this.moveCursorWordRight(), void 0) : ((e = this.session.tokenRe.exec(o)) && (i += this.session.tokenRe.lastIndex, this.session.tokenRe.lastIndex = 0), void this.moveCursorTo(t, i)))
			...
			var s, r = n.stringReverse(o);
			return this.session.nonTokenRe.lastIndex = 0, this.session.tokenRe.lastIndex = 0, (s = this.session.nonTokenRe.exec(r)) && (i -= this.session.nonTokenRe.lastIndex, r = r.slice(this.session.nonTokenRe.lastIndex), this.session.nonTokenRe.lastIndex = 0), 0 >= i ? (this.moveCursorTo(t, 0), this.moveCursorLeft(), t > 0 && this.moveCursorWordLeft(), void 0) : ((s = this.session.tokenRe.exec(r)) && (i -= this.session.tokenRe.lastIndex, this.session.tokenRe.lastIndex = 0), void this.moveCursorTo(t, i))
		}, this.$shortWordEndIndex = function(e) {
			var t, i, n = 0,
				o = /\s/,
				s = this.session.tokenRe;
			if (s.lastIndex = 0, t = this.session.tokenRe.exec(e)) n = this.session.tokenRe.lastIndex;
			else {
				for (;
				(i = e[n]) && o.test(i);) n++;
				if (1 > n) for (s.lastIndex = 0;
				(i = e[n]) && !s.test(i);) if (s.lastIndex = 0, n++, o.test(i)) {
					if (n > 2) {
						n--;
						break
					}
			...
			if (0 == i) {
				do t--, o = this.doc.getLine(t);
				while (t > 0 && /^\s*$/.test(o));
				i = o.length, /\s+$/.test(o) || (o = "")
			}
			var s = n.stringReverse(o),
				r = this.$shortWordEndIndex(s);
	...
	(function() {
		this.set = function(e) {
			...
			var n = t.range,
				s = n ? e.getLines(n.start.row, n.end.row) : e.doc.getAllLines(),
				r = [],
				a = t.re;
			if (t.$isMultiLine) {
				var l, c = a.length,
				...
				e: for (var d = a.offset || 0; h >= d; d++) {
					for (var u = 0; c > u; u++) if (-1 == s[d + u].search(a[u])) continue e;
					var g = s[d],
						f = s[d + c - 1],
						p = g.length - g.match(a[0])[0].length,
						m = f.match(a[c - 1])[0].length;
					l && l.end.row === d && l.end.column > p || (r.push(l = new o(d, p, d + c - 1, m)), c > 2 && (d = d + c - 2))
				}
			} else for (var v = 0; v < s.length; v++) for (var A = i.getMatchOffsets(s[v], a), u = 0; u < A.length; u++) {
				var C = A[u];
				r.push(new o(v, C.offset, v, C.offset + C.length))
			}
			if (n) {
				for (var w = n.start.column, E = n.start.column, v = 0, u = r.length - 1; u > v && r[v].start.column < w && r[v].start.row == n.start.row;) v++;
				for (; u > v && r[u].end.column > E && r[u].end.row == n.end.row;) u--;
				for (r = r.slice(v, u + 1), v = 0, u = r.length; u > v; v++) r[v].start.row += n.start.row, r[v].end.row += n.start.row
			}
			return r
			...
			if (n) {
				...
				if (t = e.replace(n, t), i.preserveCase) {
					...
					for (var s = Math.min(e.length, e.length); s--;) {
						var r = e[s];
						t[s] = r && r.toLowerCase() != r ? t[s].toUpperCase() : t[s].toLowerCase()
					}
					t = t.join("")
				}
				return t
			...
			if (t.$isMultiLine) var l = n.length,
				c = function(t, i, r) {
					var a = t.search(n[0]);
					if (-1 != a) {
						for (var c = 1; l > c; c++) if (t = e.getLine(i + c), -1 == t.search(n[c])) return;
						var h = t.match(n[l - 1])[0].length,
							d = new o(i, a, i + l - 1, h);
						return 1 == n.offset ? (d.start.row--, d.start.column = Number.MAX_VALUE) : r && (d.start.column += r), s(d) ? !0 : void 0
					}
				};
			else if (a) var c = function(e, t, o) {
					for (var r = i.getMatchOffsets(e, n), a = r.length - 1; a >= 0; a--) if (s(r[a], t, o)) return !0
				};
			else var c = function(e, t, o) {
					for (var r = i.getMatchOffsets(e, n), a = 0; a < r.length; a++) if (s(r[a], t, o)) return !0
				};
			return {
				forEach: function(i) {
					s = i, r.$lineIterator(e, t).forEach(c)
				}
			}
			...
			var i = 1 == t.backwards,
				...
				o = t.range,
				s = t.start;
			s || (s = o ? o[i ? "end" : "start"] : e.selection.getRange()), s.start && (s = s[n != i ? "end" : "start"]);
			var r = o ? o.start.row : 0,
				a = o ? o.end.row : e.getLength() - 1,
				l = i ?
			function(i) {
				var n = s.row,
					o = e.getLine(n).substring(0, s.column);
				if (!i(o, n)) {
	...
	var i = e("./lib/oop"),
		...
		u = function(e, t) {
			this.$breakpoints = [], this.$decorations = [], this.$frontMarkers = {}, this.$backMarkers = {}, this.$markerId = 1, this.$undoSelect = !0, this.$foldData = [], this.$foldData.toString = function() {
				return this.join("\n")
			}, this.on("changeFold", this.onChangeFold.bind(this)), this.$onChange = this.onChange.bind(this), "object" == typeof e && e.getLine || (e = new c(e)), this.setDocument(e), this.selection = new r(this), o.resetOptions(this), this.setMode(t), o._signal("session", this)
		};
	(function() {
		function t(e) {
		...
		i.implement(this, s), this.setDocument = function(e) {
			...
			var i, n = this.bgTokenizer.getTokens(e),
				o = 0;
			if (null == t) s = n.length - 1, o = this.getLine(e).length;
			else for (var s = 0; s < n.length && (o += n[s].value.length, !(o >= t)); s++);
			return i = n[s], i ? (i.index = s, i.start = o - i.value.length, i) : null
			...
			return n ? (this.$frontMarkers[o] = s, this._signal("changeFrontMarker")) : (this.$backMarkers[o] = s, this._signal("changeBackMarker")), o
			...
			if (s > 0) {
				do s--;
				while (s >= 0 && i.charAt(s).match(o));
				s++
			}
			for (var r = t; r < i.length && i.charAt(r).match(o);) r++;
			return new l(e, s, e, r)
			...
			if (this.$modified || e) {
				...
				for (var t = this.doc.getAllLines(), i = this.$rowLengthCache, n = 0, o = 0, s = this.$foldData[o], r = s ? s.start.row : 1 / 0, a = t.length, l = 0; a > l; l++) {
					if (l > r) {
						if (l = s.end.row + 1, l >= a) break;
						s = this.$foldData[o++], r = s ? s.start.row : 1 / 0
					}
			...
			var o, s, r = e[0],
				a = !1;
			n(r) ? (o = l.fromPoints(r.range.start, r.range.end), a = !0) : (o = l.fromPoints(r.range.start, r.range.start), a = !1);
			for (var c = 1; c < e.length; c++) r = e[c], n(r) ? (s = r.range.start, -1 == o.compare(s.row, s.column) && o.setStart(r.range.start), s = r.range.end, 1 == o.compare(s.row, s.column) && o.setEnd(r.range.end), a = !0) : (s = r.range.start, -1 == o.compare(s.row, s.column) && (o = l.fromPoints(r.range.start, r.range.start)), a = !1);
			if (null != i) {
			...
			if (!i) {
				...
				a && (s.start.row == e.end.row && s.start.column > e.end.column && (s.start.column += a), s.end.row == e.end.row && s.end.column > e.end.column && (s.end.column += a)), r && s.start.row >= e.end.row && (s.start.row += r, s.end.row += r)
			}
			if (s.end = this.insert(s.start, n), o.length) {
				var c = e.start,
					h = s.start,
					r = h.row - c.row,
					a = h.column - c.column;
				this.addFolds(o.map(function(e) {
					return e = e.clone(), e.start.row == c.row && (e.start.column += a), e.end.row == c.row && (e.end.column += a), e.start.row += r, e.end.row += r, e
				}))
			}
			return s
			...
			for (var t = e.collapseRows(), i = new l(0, 0, 0, 0), n = this.getTabSize(), o = t.start.row; o <= t.end.row; ++o) {
				var s = this.getLine(o);
				i.start.row = o, i.end.row = o;
				for (var r = 0; n > r && " " == s.charAt(r); ++r);
				n > r && "	" == s.charAt(r) ? (i.start.column = r, i.end.column = r + 1) : (i.start.column = 0, i.end.column = r), this.remove(i)
			}
			...
			return this.doc.insertLines(e + o, a), r.length && this.addFolds(r), o
			...
			var t, i = this.$useWrapMode,
				...
				a = e.data.range.end,
				l = null;
			if (-1 != n.indexOf("Lines") ? (s = "insertLines" == n ? o + e.data.lines.length : o, t = e.data.lines ? e.data.lines.length : s - o) : t = s - o, this.$updating = !0, 0 != t) if (-1 != n.indexOf("remove")) {
				...
				var c = this.$foldData,
					...
					d = 0;
				if (h) {
					var p = h.range.compareInside(r.row, r.column);
					0 == p ? (h = h.split(r.row, r.column), h.shiftRow(t), h.addRemoveChars(s, 0, a.column - r.column)) : -1 == p && (h.addRemoveChars(o, 0, a.column - r.column), h.shiftRow(t)), d = c.indexOf(h) + 1
				}
				for (d; d < c.length; d++) {
					var h = c[d];
				...
				h && h.addRemoveChars(o, r.column, t)
			}
			return i && this.$wrapData.length != this.doc.getLength() && console.error("doc.getLength() and $wrapData.length have to be the same!"), this.$updating = !1, i ? this.$updateWrapData(o, s) : this.$updateRowLengthCache(o, s), l
			...
			var i, n, o = this.doc.getAllLines(),
				...
				a = this.$wrapLimit,
				l = e;
			for (t = Math.min(t, o.length - 1); t >= l;) n = this.getFoldLine(l, n), n ? (i = [], n.walk(function(e, t, n, s) {
				var r;
				if (null != e) {
					r = this.$getDisplayTokens(e, i.length), r[0] = u;
					for (var a = 1; a < r.length; a++) r[a] = g
				} else r = this.$getDisplayTokens(o[t].substring(s, n), i.length);
				i = i.concat(r)
			}.bind(this), n.end.row, o[n.end.row].length + 1), r[n.start.row] = this.$computeWrapSplits(i, a, s), l = n.end.row + 1) : (i = this.$getDisplayTokens(o[l]), r[l] = this.$computeWrapSplits(i, a, s), l++)
		};
		var r = 1,
			c = 2,
			u = 3,
		...
		this.$computeWrapSplits = function(e, t) {
			...
			for (var n = [], o = e.length, s = 0, r = 0, a = this.$wrapAsCode; o - s > t;) {
				var l = s + t;
				if (e[l - 1] >= p && e[l] >= p) i(l);
				else if (e[l] != u && e[l] != g) {
					for (var c = Math.max(l - (a ? 10 : t - (t >> 2)), s - 1); l > c && e[l] < u;) l--;
					if (a) {
						for (; l > c && e[l] < u;) l--;
						for (; l > c && e[l] == f;) l--
					} else for (; l > c && e[l] < p;) l--;
					l > c ? i(++l) : (l = s + t, i(l))
				} else {
					for (l; l != s - 1 && e[l] != u; l--);
					if (l > s) {
			...
			for (var s = 0; s < e.length; s++) {
				...
				if (9 == a) {
					n = this.getScreenTabSize(o.length + i), o.push(m);
					for (var l = 1; n > l; l++) o.push(v)
				} else 32 == a ? o.push(p) : a > 39 && 48 > a || a > 57 && 64 > a ? o.push(f) : a >= 4352 && t(a) ? o.push(r, c) : o.push(r)
			}
			return o
			...
			null == i && (i = 1 / 0), n = n || 0;
			var o, s;
			for (s = 0; s < e.length && (o = e.charCodeAt(s), n += 9 == o ? this.getScreenTabSize(n) : o >= 4352 && t(o) ? 2 : 1, !(n > i)); s++);
			return [n, s]
			...
			for (var u = this.getLength() - 1, g = this.getNextFoldLine(o), f = g ? g.start.row : 1 / 0; e >= r && (a = this.getRowLength(o), !(r + a > e || o >= u));) r += a, o++, o > f && (o = g.end.row + 1, g = this.getNextFoldLine(o, g), f = g ? g.start.row : 1 / 0), d && (this.$docRowCache.push(o), this.$screenRowCache.push(r));
			...
			if (this.$useWrapMode) {
				...
				if (p) {
					var m = Math.floor(e - r);
					n = p[m], m > 0 && p.length && (s = p[m - 1] || p[p.length - 1], i = i.substring(s))
				}
			}
			return s += this.$getStringScreenWidth(i, t)[1], this.$useWrapMode && s >= n && (s = n - 1), g ? g.idxToPosition(s) : {
				row: o,
				column: s
			}
			...
			var f = "";
			if (u && a >= g ? (f = this.getFoldDisplayLine(u, e, t), o = u.start.row) : (f = this.getLine(e).substring(0, t), o = e), this.$useWrapMode) {
				var p = this.$wrapData[o];
				if (p) {
			...
			var e = 0,
				t = null;
			if (this.$useWrapMode) for (var i = this.$wrapData.length, n = 0, o = 0, t = this.$foldData[o++], s = t ? t.start.row : 1 / 0; i > n;) {
				var r = this.$wrapData[n];
				e += r ? r.length + 1 : 1, n++, n > s && (n = t.end.row + 1, t = this.$foldData[o++], s = t ? t.start.row : 1 / 0)
			} else {
				e = this.getLength();
	...
	}).call(u.prototype), e("./edit_session/folding").Folding.call(u.prototype), e("./edit_session/bracket_match").BracketMatch.call(u.prototype), o.defineOptions(u.prototype, "session", {
		wrap: {
			set: function(e) {
	...
	(function() {
		this.setDefaultHandler = function(e) {
			...
			for (var s, r = !1, a = this.$editor.commands, l = this.$handlers.length; l-- && (s = this.$handlers[l].handleKeyboard(this.$data, e, t, i, o), !(s && s.command && (r = "null" == s.command ? !0 : a.exec(s.command, this.$editor, s.args, o), r && o && -1 != e && 1 != s.passEvent && 1 != s.command.passEvent && n.stopEvent(o), r))););
			return r
	...
	function i(e, t) {
		if (this.platform = t || (o.isMac ? "mac" : "win"), this.commands = {}, this.commandKeyBinding = {}, this.__defineGetter__ && this.__defineSetter__ && "undefined" != typeof console && console.error) {
			var i = !1,
				n = function() {
	...
	(function() {
		this.addCommand = function(e) {
			...
			for (var n in i) for (var o in i[n]) i[n][o] == e && delete i[n][o]
			...
			var t = e.toLowerCase().split(/[\-\+]([\-\+])?/).filter(function(e) {
				...
				i = t.pop(),
				o = n[i];
			if (n.FUNCTION_KEYS[o]) i = n.FUNCTION_KEYS[o].toLowerCase();
			else {
				if (!t.length) return {
					key: i,
					hashId: -1
	...
	function i(e) {
		e.on("click", function(t) {
			...
			if ("foldWidgets" == i) {
				var n = t.getDocumentPosition().row,
					o = e.session,
					s = o.getParentFoldRangeData(n, !0),
					r = s.range || s.firstRange;
				if (r) {
					n = r.start.row;
					var a = o.getFoldAt(n, o.getLine(n).length, 1);
					a ? o.removeFold(a) : (o.addFold("...", r), e.renderer.scrollCursorIntoView({
						row: r.start.row,
						column: 0
					}))
				}
	...
	t.commands = [{
		...
		bindKey: i(null, null),
		exec: function(e) {
			for (var t = e.selection.isBackwards(), i = t ? e.selection.getSelectionLead() : e.selection.getSelectionAnchor(), o = t ? e.selection.getSelectionAnchor() : e.selection.getSelectionLead(), r = e.session.doc.getLine(i.row).length, a = e.session.doc.getTextRange(e.selection.getRange()), l = a.replace(/\n\s*/, " ").length, c = e.session.doc.getLine(i.row), h = i.row + 1; h <= o.row + 1; h++) {
				var d = n.stringTrimLeft(n.stringTrimRight(e.session.doc.getLine(h)));
				0 !== d.length && (d = " " + d), c += d
			}
			o.row + 1 < e.session.doc.getLength() - 1 && (c += e.session.doc.getNewLineCharacter()), e.clearSelection(), e.session.doc.replace(new s(i.row, 0, o.row + 2, 0), c), l > 0 ? (e.selection.moveCursorTo(i.row, i.column), e.selection.selectTo(i.row, i.column + l)) : (r = e.session.doc.getLine(i.row).length > r ? r + 1 : r, e.selection.moveCursorTo(i.row, r))
		},
		multiSelectAction: "forEach",
		readOnly: !0
	}, {
	...
	i._emit = i._dispatchEvent = function(e, t) {
		...
		if (i.length || s) {
			...
			return s && !t.defaultPrevented ? s(t, this) : void 0
		}
		...
		if (i || (i = this._defaultHandlers = {
			...
			var s = o.indexOf(t); - 1 != s && o.splice(s, 1)
		}
		i[e] = t
...
}), define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/config", "ace/lib/useragent", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter"], function(e, t) {
	var i = e("./lib/oop"),
		n = e("./lib/dom"),
		o = e("./config"),
		s = e("./lib/useragent"),
	...
	(function() {
		this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, i.implement(this, f), this.updateCharacterSize = function() {
			...
			if (!(this.resizing > 2)) {
				...
				return this.$size.scrollerHeight && (i || n) ? (e && (this.$gutterLayer.$padding = null), e ? this.$renderChanges(s | this.$changes, !0) : this.$loop.schedule(s | this.$changes), this.resizing && (this.resizing = 0), void 0) : this.resizing = 0
			}
			...
			return n && (e || s.height != n) && (s.height = n, o |= this.CHANGE_SIZE, s.scrollerHeight = s.height, this.$horizScroll && (s.scrollerHeight -= this.scrollBarH.getHeight()), this.scrollBarV.element.style.bottom = this.scrollBarH.getHeight() + "px", o |= this.CHANGE_SCROLL), i && (e || s.width != i) && (o |= this.CHANGE_SIZE, s.width = i, null == t && (t = this.$showGutter ? this.$gutter.offsetWidth : 0), this.gutterWidth = t, this.scrollBarH.element.style.left = this.scroller.style.left = t + "px", s.scrollerWidth = Math.max(0, i - t - this.scrollBarV.getWidth()), this.scrollBarH.element.style.right = this.scroller.style.right = this.scrollBarV.getWidth() + "px", this.scroller.style.bottom = this.scrollBarH.getHeight() + "px", (this.session && this.session.getUseWrapMode() && this.adjustWrapLimit() || e) && (o |= this.CHANGE_FULL)), s.$dirty = !i || !n, o && this._signal("resize", r), o
			...
			if (this.$keepTextAreaAtCursor) {
				...
				if (!(0 > t || t > e.height - n)) {
					...
					if (this.$composition) {
						...
						o *= this.session.$getStringScreenWidth(s)[0] + 2, n += 2, t -= 1
					}
			...
			if (i != this.desiredHeight || this.$size.height != this.desiredHeight || n != this.$vScroll) {
				...
				this.container.style.height = i + "px", this.$updateCachedSize(!0, this.$gutterWidth, o, i), this.desiredHeight = i
			}
			...
			var e = this.session,
				...
				r = t.scrollerHeight + this.lineHeight,
				a = this.$getLongestLine(),
				l = !i && (this.$hScrollBarAlwaysVisible || t.scrollerWidth - a - 2 * this.$padding < 0),
				c = this.$horizScroll !== l;
			c && (this.$horizScroll = l, this.scrollBarH.setVisible(l)), !this.$maxLines && this.$scrollPastEnd && (o += (t.scrollerHeight - this.lineHeight) * this.$scrollPastEnd);
			var h = !i && (this.$vScrollBarAlwaysVisible || t.scrollerHeight - o < 0),
				d = this.$vScroll !== h;
			...
			var u, g, f = Math.ceil(r / this.lineHeight) - 1,
				p = Math.max(0, Math.round((this.scrollTop - s) / this.lineHeight)),
				m = p + f,
				v = this.lineHeight;
			p = e.screenToDocumentRow(p, 0);
			var A = e.getFoldLine(p);
			A && (p = A.start.row), u = e.documentToScreenRow(p, 0), g = e.getRowLength(p) * v, m = Math.min(e.screenToDocumentRow(m, 0), e.getLength() - 1), r = t.scrollerHeight + e.getRowLength(m) * v + g, s = this.scrollTop - u * v;
			var C = 0;
			return this.layerConfig.width != a && (C = this.CHANGE_H_SCROLL), (c || d) && (C = this.$updateCachedSize(!0, this.gutterWidth, t.width, t.height), this._signal("scrollbarVisibilityChanged"), d && (a = this.$getLongestLine())), this.layerConfig = {
				...
				maxHeight: o,
				offset: s,
				gutterOffset: Math.max(0, Math.ceil((s + t.height - t.scrollerHeight) / v)),
			...
			if (0 !== this.$size.scrollerHeight) {
				...
				l + r > s ? (t && (s -= t * this.$size.scrollerHeight), 0 === s && (s = -this.scrollMargin.top), this.session.setScrollTop(s)) : l + this.$size.scrollerHeight - a < s + this.lineHeight && (t && (s += t * this.$size.scrollerHeight), this.session.setScrollTop(s + this.lineHeight - this.$size.scrollerHeight));
			...
			for (i = 0; n > i; ++i) o.push(s(i / this.STEPS, e, t - e));
			return o
			...
			this.session.setScrollTop(s), i !== !1 && this.animateScrolling(r, n)
			...
			function i(i) {
				if (s.$themeId != e) return t && t();
				if (i.cssClass) {
					n.importCssString(i.cssText, i.cssClass, s.container.ownerDocument), s.theme && n.removeCssClass(s.container, s.theme.cssClass);
					var o = "padding" in i ? i.padding : "padding" in (s.theme || {}) ? 4 : s.$padding;
					s.$padding && o != s.$padding && s.setPadding(o), s.$theme = i.cssClass, s.theme = i, n.addCssClass(s.container, i.cssClass), n.setCssClass(s.container, "ace_dark", i.isDark), s.$size && (s.$size.width = 0, s.$updateSizeAsync()), s._dispatchEvent("themeLoaded", {
						theme: i
					}), t && t()
				}
			}
			var s = this;
			if (this.$themeId = e, s._dispatchEvent("themeChange", {
				theme: e
	...
	function n(n) {
		if (h.packaged = n || e.packaged || i.packaged || c.define && define.packaged, !c.document) return "";
		for (var s = {}, r = "", a = document.getElementsByTagName("script"), l = 0; l < a.length; l++) {
			var d = a[l],
				u = d.src || d.getAttribute("src");
			if (u) {
				for (var g = d.attributes, f = 0, p = g.length; p > f; f++) {
					var m = g[f];
					0 === m.name.indexOf("data-ace-") && (s[o(m.name.replace(/^data-ace-/, ""))] = m.value)
				}
				var v = u.match(/^(.*)\/ace(\-\w+)?\.js(\?|$)/);
				v && (r = v[1])
			}
		}
		r && (s.base = s.base || r, s.packaged = !0), s.basePath = s.base, s.workerPath = s.workerPath || s.base, s.modePath = s.modePath || s.base, s.themePath = s.themePath || s.base, delete s.base;
	...
	t.get = function(e) {
	...
	}, r.implement(t, l), t.moduleUrl = function(e, t) {
		...
		var r = h[t + "Path"];
		return null == r ? r = h.basePath : "/" == n && (t = n = ""), r && "/" != r.slice(-1) && (r += "/"), r + t + n + o + this.get("suffix")
		...
		if (t.$loading[i] || (t.$loading[i] = []), t.$loading[i].push(n), !(t.$loading[i].length > 1)) {
			...
			return t.get("packaged") ? void a.loadScript(t.moduleUrl(i, s), l) : l()
		}
	}, n(!0), t.init = n;
	var d = {
		...
		setOption: function(e, t) {
			if (this["$" + e] !== t) {
				...
				return i ? i.forwardTo ? this[i.forwardTo] && this[i.forwardTo].setOption(e, t) : (i.handlesSet || (this["$" + e] = t), void(i && i.set && i.set.call(this, t))) : void("undefined" != typeof console && console.warn && console.warn('misspelled option "' + e + '"'))
			}
		},
	...
	(function() {
		n.implement(this, s), this.setSession = function(e) {
			...
			if (this.$annotations.length) {
				var t = e.data,
					...
					n = i.start.row,
					o = i.end.row - n;
				if (0 !== o) if ("removeText" == t.action || "removeLines" == t.action) this.$annotations.splice(n, o + 1, null);
				else {
					var s = new Array(o + 1);
					s.unshift(n, 1), this.$annotations.splice.apply(this.$annotations, s)
				}
			}
		}, this.update = function(e) {
			for (var t = this.session, n = e.firstRow, o = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1), s = t.getNextFoldLine(n), r = s ? s.start.row : 1 / 0, a = this.$showFoldWidgets && t.foldWidgets, l = t.$breakpoints, c = t.$decorations, h = t.$firstLineNumber, d = 0, u = t.gutterRenderer || this.$renderer, g = null, f = -1, p = n;;) {
				if (p > r && (p = s.end.row + 1, s = t.getNextFoldLine(p, s), r = s ? s.start.row : 1 / 0), p > o) {
				...
				if (A) {
					...
					m += "start" == A && p == r && p < s.end.row ? " ace_closed" : " ace_open", g.foldWidget.className != m && (g.foldWidget.className = m);
				...
				var C = d = u ? u.getText(t, p) : p + h;
				C != g.textNode.data && (g.textNode.data = C), p++
			}
			this.element.style.height = e.minHeight + "px", (this.$fixedWidth || t.$useWrapMode) && (d = t.getLength() + h);
			var w = u ? u.getWidth(t, d, e) : d.toString().length * e.characterWidth,
	...
	function i(e) {
		function t(e, t) {
			...
			if (!D || o || s) m.$blockScrolling += 1, m.moveCursorToPosition(e), m.$blockScrolling -= 1, D = i, k = {
				x: w,
				y: E
			};
			else {
				var r = n(k.x, k.y, w, E);
				r > c ? D = null : i - D >= l && (m.renderer.scrollCursorIntoView(), D = null)
			}
		}
		function i(e, t) {
			var i = Date.now(),
				...
				c = Math.min(r.y.top, r.y.bottom),
				h = {
					row: e.row,
					column: e.column
				};
			2 >= l / o && (h.column += r.x.left < r.x.right ? -3 : 2), 1 >= c / n && (h.row += r.y.top < r.y.bottom ? -1 : 1);
			var d = e.row != h.row,
				u = e.column != h.column,
				g = !t || e.row != t.row;
			d || u && !g ? B ? i - B >= a && m.renderer.scrollCursorIntoView(h) : B = i : B = null
		}
		function h() {
			var e = y;
			y = m.renderer.screenToTextCoordinates(w, E), t(y, e), i(y, e)
		}
		function d() {
			b = m.selection.toOrientedRange(), C = m.session.addMarker(b, "ace_selection", m.getSelectionStyle()), m.clearSelection(), m.isFocused() && m.renderer.$cursorLayer.setBlinking(!1), clearInterval(F), F = setInterval(h, 20), _ = 0, s.addListener(document, "mousemove", g)
		}
		function u() {
			clearInterval(F), m.session.removeMarker(C), C = null, m.$blockScrolling += 1, m.selection.fromOrientedRange(b), m.$blockScrolling -= 1, m.isFocused() && !S && m.renderer.$cursorLayer.setBlinking(!m.getReadOnly()), b = null, _ = 0, B = null, D = null, s.removeListener(document, "mousemove", g)
		}
		function g() {
		...
		function p(e) {
			...
			var s = "none";
			return n && t.indexOf(o) >= 0 ? s = "copy" : i.indexOf(o) >= 0 ? s = "move" : t.indexOf(o) >= 0 && (s = "copy"), s
		}
		var m = e.editor,
			v = o.createElement("img");
		v.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", r.isOpera && (v.style.cssText = "width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;");
		...
		var C, w, E, F, b, y, x, S, B, D, k, $ = m.container,
			_ = 0;
		this.onDragStart = function(e) {
			...
			i.effectAllowed = m.getReadOnly() ? "copy" : "copyMove", r.isOpera && (m.container.appendChild(v), v._top = v.offsetTop), i.setDragImage && i.setDragImage(v, 0, 0), r.isOpera && m.container.removeChild(v), i.clearData(), i.setData("Text", m.session.getTextRange()), S = !0, this.setState("drag")
		}, this.onDragEnd = function(e) {
			if ($.draggable = !1, S = !1, this.setState(null), !m.getReadOnly()) {
			...
			return !m.getReadOnly() && f(e.dataTransfer) ? (C || d(), _++, e.dataTransfer.dropEffect = x = p(e), s.preventDefault(e)) : void 0
		}, this.onDragOver = function(e) {
			return !m.getReadOnly() && f(e.dataTransfer) ? (C || (d(), _++), null !== L && (L = null), w = e.clientX, E = e.clientY, e.dataTransfer.dropEffect = x = p(e), s.preventDefault(e)) : void 0
		}, this.onDragLeave = function(e) {
			return _--, 0 >= _ && C ? (u(), x = null, s.preventDefault(e)) : void 0
		}, this.onDrop = function(e) {
			if (C) {
				var t = e.dataTransfer;
				if (S) switch (x) {
				case "move":
					b = b.contains(y.row, y.column) ? {
						start: y,
						end: y
					} : m.moveText(b, y);
					break;
				case "copy":
					...
					b = {
						start: y,
						end: m.session.insert(y, i)
					}, m.focus(), x = null
				}
				return u(), s.preventDefault(e)
			}
		}, s.addListener($, "dragstart", this.onDragStart.bind(e)), s.addListener($, "dragend", this.onDragEnd.bind(e)), s.addListener($, "dragenter", this.onDragEnter.bind(e)), s.addListener($, "dragover", this.onDragOver.bind(e)), s.addListener($, "dragleave", this.onDragLeave.bind(e)), s.addListener($, "drop", this.onDrop.bind(e));
		var L = null
	}
	function n(e, t, i, n) {
	...
	(function() {
		this.$padding = 0, this.setPadding = function(e) {
			...
			if (e) {
				...
				for (var i in this.markers) {
					...
					if (o.range) {
						var s = o.range.clipRows(e.firstRow, e.lastRow);
						if (!s.isEmpty()) if (s = s.toScreenRange(this.session), o.renderer) {
							var r = this.$getTop(s.start.row, e),
								a = this.$padding + s.start.column * e.characterWidth;
							o.renderer(t, s, a, r, e)
						} else "fullLine" == o.type ? this.drawFullLineMarker(t, s, o.clazz, e) : "screenLine" == o.type ? this.drawScreenLineMarker(t, s, o.clazz, e) : s.isMultiLine() ? "text" == o.type ? this.drawTextMarker(t, s, o.clazz, e) : this.drawMultiLineMarker(t, s, o.clazz, e) : this.drawSingleLineMarker(t, s, o.clazz + " ace_start", e)
		...
		}, this.drawTextMarker = function(e, t, n, o, s) {
			var r = t.start.row,
				a = new i(r, t.start.column, r, this.session.getScreenLastRowColumn(r));
			for (this.drawSingleLineMarker(e, a, n + " ace_start", o, 1, s), r = t.end.row, a = new i(r, 0, r, t.end.column), this.drawSingleLineMarker(e, a, n, o, 0, s), r = t.start.row + 1; r < t.end.row; r++) a.start.row = r, a.end.row = r, a.end.column = this.session.getScreenLastRowColumn(r), this.drawSingleLineMarker(e, a, n, o, 1, s)
		}, this.drawMultiLineMarker = function(e, t, i, n, o) {
			var s = this.$padding,
				r = n.lineHeight,
				a = this.$getTop(t.start.row, n),
				l = s + t.start.column * n.characterWidth;
			o = o || "", e.push("<div class='", i, " ace_start' style='", "height:", r, "px;", "right:0;", "top:", a, "px;", "left:", l, "px;", o, "'></div>"), a = this.$getTop(t.end.row, n);
			var c = t.end.column * n.characterWidth;
			e.push("<div class='", i, "' style='", "height:", r, "px;", "width:", c, "px;", "top:", a, "px;", "left:", s, "px;", o, "'></div>"), r = (t.end.row - t.start.row - 1) * n.lineHeight, 0 > r || (a = this.$getTop(t.start.row + 1, n), e.push("<div class='", i, "' style='", "height:", r, "px;", "right:0;", "top:", a, "px;", "left:", s, "px;", o, "'></div>"))
			...
			var s = this.$getTop(t.start.row, n),
				r = n.lineHeight;
			t.start.row != t.end.row && (r += this.$getTop(t.end.row, n) - s), e.push("<div class='", i, "' style='", "height:", r, "px;", "top:", s, "px;", "left:0;right:0;", o || "", "'></div>")
	...
	(function() {
		i.implement(this, s), this.EOF_CHAR = "¶", this.EOL_CHAR_LF = "¬", this.EOL_CHAR_CRLF = "¤", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "→", this.SPACE_CHAR = "·", this.$padding = 0, this.$updateEolChar = function() {
			...
			for (var o = Math.max(t, e.firstRow), s = Math.min(i, e.lastRow), r = this.element.childNodes, a = 0, l = e.firstRow; o > l; l++) {
			...
			for (var l = o, c = this.session.getNextFoldLine(l), h = c ? c.start.row : 1 / 0; l > h && (l = c.end.row + 1, c = this.session.getNextFoldLine(l, c), h = c ? c.start.row : 1 / 0), !(l > s);) {
				var d = r[a++];
				if (d) {
					var u = [];
					this.$renderLine(u, l, !this.$useLineGroups(), l == h ? c : !1), d.style.height = e.lineHeight * this.session.getRowLength(l) + "px", n.setInnerHtml(d, u.join(""))
				}
				l++
			}
			...
			for (var o = this.element.ownerDocument.createDocumentFragment(), s = t, r = this.session.getNextFoldLine(s), a = r ? r.start.row : 1 / 0; s > a && (s = r.end.row + 1, r = this.session.getNextFoldLine(s, r), a = r ? r.start.row : 1 / 0), !(s > i);) {
				var l = n.createElement("div"),
					c = [];
				if (this.$renderLine(c, s, !1, s == a ? r : !1), l.innerHTML = c.join(""), this.$useLineGroups()) l.className = "ace_line_group", o.appendChild(l), l.style.height = e.lineHeight * this.session.getRowLength(s) + "px";
			...
			this.config = e;
			for (var t = [], i = e.firstRow, o = e.lastRow, s = i, r = this.session.getNextFoldLine(s), a = r ? r.start.row : 1 / 0; s > a && (s = r.end.row + 1, r = this.session.getNextFoldLine(s, r), a = r ? r.start.row : 1 / 0), !(s > o);) this.$useLineGroups() && t.push("<div class='ace_line_group' style='height:", e.lineHeight * this.session.getRowLength(s), "px'>"), this.$renderLine(t, s, !1, s == a ? r : !1), this.$useLineGroups() && t.push("</div>"), s++;
			this.element = n.setInnerHtml(this.element, t.join(""))
		}, this.$textToken = {
			text: !0,
			rparen: !0,
			...
			var s = this,
				...
				a = function(e, i, n, r) {
					if (i) return s.showInvisibles ? "<span class='ace_invisible ace_invisible_space'>" + o.stringRepeat(s.SPACE_CHAR, e.length) + "</span>" : o.stringRepeat(" ", e.length);
					if ("&" == e) return "&#38;";
					if ("<" == e) return "&#60;";
					if ("	" == e) {
						var a = s.session.getScreenTabSize(t + r);
						return t += a - 1, s.$tabStrings[a]
					}
					if ("　" == e) {
						var l = s.showInvisibles ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk",
							c = s.showInvisibles ? s.SPACE_CHAR : "";
						return t += 1, "<span class='" + l + "' style='width:" + 2 * s.config.characterWidth + "px'>" + c + "</span>"
					}
			...
			for (var o = 0, s = 0, r = i[0], a = 0, l = 0; l < t.length; l++) {
				var c = t[l],
					h = c.value;
				if (0 == l && this.displayIndentGuides) {
					if (o = h.length, h = this.renderIndentGuide(e, h, r), !h) continue;
					o -= h.length
				}
				if (o + h.length < r) a = this.$renderToken(e, a, c, h), o += h.length;
				else {
					for (; o + h.length >= r;) a = this.$renderToken(e, a, c, h.substring(0, r - o)), h = h.substring(r - o), o = r, n || e.push("</div>", "<div class='ace_line' style='height:", this.config.lineHeight, "px'>"), s++, a = 0, r = i[s] || Number.MAX_VALUE;
			...
			for (var s = 1; s < t.length; s++) n = t[s], o = n.value, i = this.$renderToken(e, i, n, o)
			...
			function i(e, t, i) {
				for (var n = 0, s = 0; s + e[n].value.length < t;) if (s += e[n].value.length, n++, n == e.length) return;
				if (s != t) {
					var r = e[n].value.substring(t - s);
					r.length > i - t && (r = r.substring(0, i - t)), o.push({
						type: e[n].type,
						value: r
					}), s = t + r.length, n += 1
				}
			...
			return t.walk(function(e, t, r, a, l) {
				null != e ? o.push({
					type: "fold",
					value: e
				}) : (l && (s = n.getTokens(t)), s.length && i(s, a, r))
		...
		this.$updateVisibility = function(e) {
			...
			for (var i = 0, o = t.length; o > i; i++) {
				...
				if (!((s.top > e.height + e.offset || s.top < 0) && i > 1)) {
					...
					r.left = s.left + "px", r.top = s.top + "px", r.width = e.characterWidth + "px", r.height = e.lineHeight + "px"
				}
			}
	...
	function i(e) {
		function t() {
			...
			if (t == o) {
				var r = a.renderer.pixelToScreenCoordinates(0, d.y).row,
					h = d.$pos;
				if (r > a.session.documentToScreenRow(h.row, h.column)) return i()
			}
			if (u != n) if (u = n.text.join("<br/>"), c.setHtml(u), c.show(), a.on("mousewheel", i), e.$tooltipFollowsMouse) s(d);
			else {
		...
		function i() {
			h && (h = clearTimeout(h)), u && (c.hide(), u = null, a.removeEventListener("mousewheel", i))
		}
		function s(e) {
		...
		e.editor.setDefaultHandler("guttermousemove", function(n) {
			...
			return o.hasCssClass(r, "ace_fold-widget") ? i() : (u && e.$tooltipFollowsMouse && s(n), d = n, void(h || (h = setTimeout(function() {
	...
	var o = e("../lib/dom"),
		...
		r = e("../lib/event"),
		a = e("../tooltip").Tooltip;
	s.inherits(n, a), function() {
		this.setPosition = function(e, t) {
			var i = window.innerWidth || document.documentElement.clientWidth,
				n = window.innerHeight || document.documentElement.clientHeight,
				o = this.getWidth(),
				s = this.getHeight();
			e += 15, t += 15, e + o > i && (e -= e + o - i), t + s > n && (t -= 20 + s), a.prototype.setPosition.call(this, e, t)
		}
	...
	(function() {
		this.onMouseDown = function(e) {
			...
			i ? t.selection.selectToPosition(e) : this.$clickSelection || t.selection.moveToPosition(e), t.renderer.scroller.setCapture && t.renderer.scroller.setCapture(), t.setStyle("ace_selecting"), this.setState("select")
			...
			o ? (o.isEmpty() && (o.start.column--, o.end.column++), this.setState("select")) : (o = i.selection.getWordRange(t.row, t.column), this.setState("selectByWords")), this.$clickSelection = o, this[this.state] && this[this.state](e)
		}, this.onTripleClick = function(e) {
			var t = e.getDocumentPosition(),
				i = this.editor;
			this.setState("selectByLines"), this.$clickSelection = i.selection.getLineRange(t.row), this[this.state] && this[this.state](e)
	...
	var i = e("../lib/event"),
		...
		l = e("../config"),
		c = function(e) {
			this.editor = e, new o(this), new s(this), new a(this);
			var t = function() {
					e.focus()
				},
				r = e.renderer.getMouseEventTarget();
			i.addListener(r, "click", this.onMouseEvent.bind(this, "click")), i.addListener(r, "mousemove", this.onMouseMove.bind(this, "mousemove")), i.addMultiMouseDownListener(r, [400, 300, 250], this, "onMouseEvent"), e.renderer.scrollBarV && (i.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"), i.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"), n.isIE && (i.addListener(e.renderer.scrollBarV.element, "mousedown", t), i.addListener(e.renderer.scrollBarH.element, "mousemove", t))), i.addMouseWheelListener(e.container, this.onMouseWheel.bind(this, "mousewheel"));
			var l = e.renderer.$gutter;
			i.addListener(l, "mousedown", this.onMouseEvent.bind(this, "guttermousedown")), i.addListener(l, "click", this.onMouseEvent.bind(this, "gutterclick")), i.addListener(l, "dblclick", this.onMouseEvent.bind(this, "gutterdblclick")), i.addListener(l, "mousemove", this.onMouseEvent.bind(this, "guttermousemove")), i.addListener(r, "mousedown", t), i.addListener(l, "mousedown", function(t) {
	...
	(function() {
		this.onMouseEvent = function(e, t) {
			...
			var s = this,
				a = function(e) {
					return e ? n.isWebKit && !e.which && s.releaseMouse ? s.releaseMouse() : (s.x = e.clientX, s.y = e.clientY, t && t(e), s.mouseEvent = new r(e, s.editor), s.$mouseMoved = !0, void 0) : void 0
				},
				l = function(e) {
					clearInterval(h), c(), s[s.state + "End"] && s[s.state + "End"](e), s.state = "", null == o.$keepTextAreaAtCursor && (o.$keepTextAreaAtCursor = !0, o.$moveTextAreaToCursor()), s.isMousePressed = !1, s.$onCaptureMouseMove = s.releaseMouse = null, e && s.onMouseEvent("mouseup", e)
				},
				c = function() {
			...
			s.$onCaptureMouseMove = a, s.releaseMouse = i.capture(this.editor.container, a, l);
	...
	(function() {
		i.implement(this, r), this.$characterSize = {
			...
			a = t > 0 && 1 > t ? 1 : 100, e.parentNode.removeChild(e)
			...
			if (1 === a) var e = this.$measureNode.getBoundingClientRect(),
				t = {
					height: e.height,
					width: e.width
				};
	...
	var i = e("../lib/event"),
		...
		l = function(e, t) {
			function l(e) {
				if (!p) {
					if (D) t = 0, i = e ? 0 : d.value.length - 1;
					else var t = e ? 2 : 1,
						i = 2;
					try {
			...
			function c() {
				p || (d.value = u, n.isWebKit && E.schedule())
			}
			function h() {
				setTimeout(function() {
			...
			d.className = "ace_text-input", n.isTouchPad && d.setAttribute("x-palm-disable-auto-cap", !0), d.wrap = "off", d.autocorrect = "off", d.autocapitalize = "off", d.spellcheck = !1, d.style.opacity = "0", e.insertBefore(d, e.firstChild);
			var u = "",
				g = !1,
				f = !1,
				p = !1,
				...
				v = !0;
			try {
				var A = document.activeElement === d
			} catch (C) {}
			...
			if (!d.setSelectionRange && d.createTextRange && (d.setSelectionRange = function(e, t) {
				...
				var b = !1,
					y = function(e) {
						if (!b) {
							var t = d.value;
							if (!p && t && t != u) return e && t == u[0] ? x.schedule() : ($(t), b = !0, c(), b = !1, void 0)
						}
					},
					x = s.delayedCall(y);
				i.addListener(d, "propertychange", y);
				var S = {
					13: 1,
					27: 1
				};
				i.addListener(d, "keyup", function(e) {
					return p && (!d.value || S[e.keyCode]) && setTimeout(W, 0), (d.value.charCodeAt(0) || 0) < 129 ? x.call() : void(p ? N() : I())
				}), i.addListener(d, "keydown", function() {
					x.schedule(50)
				})
			}
			var B = function() {
					g ? g = !1 : F(d) ? (t.selectAll(), l()) : D && l(t.selection.isEmpty())
				},
				D = null;
			...
			var k = !1,
				$ = function(e) {
					D && (e = D(e), D = null), f ? (l(), e && t.onPaste(e), f = !1) : e == u.charAt(0) ? k ? t.execCommand("del", {
						source: "ace"
					}) : t.execCommand("backspace", {
						source: "ace"
					}) : (e.substring(0, 2) == u ? e = e.substr(2) : e.charAt(0) == u.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == u.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == u.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)), k && (k = !1)
				},
				_ = function() {
					if (!p) {
						var e = d.value;
				...
				R = function(e, n) {
					var o = t.getCopyText();
					return o ? void(L(e, o) ? (n ? t.onCut() : t.onCopy(), i.preventDefault(e)) : (g = !0, d.value = o, d.select(), setTimeout(function() {
				...
				O = function(e) {
					var o = L(e);
					"string" == typeof o ? (o && t.onPaste(o), n.isIE && setTimeout(l), i.preventDefault(e)) : (d.value = "", f = !0)
				};
			i.addCommandKeyListener(d, t.onCommandKey.bind(t)), i.addListener(d, "select", B), i.addListener(d, "input", _), i.addListener(d, "cut", T), i.addListener(d, "copy", M), i.addListener(d, "paste", O), !("oncut" in d && "oncopy" in d && "onpaste" in d || !i.addListener(e, "keydown", function(e) {
			...
			var I = function() {
					!p && t.onCompositionStart && (p = {}, t.onCompositionStart(), setTimeout(N, 0), t.on("mousedown", W), t.selection.isEmpty() || (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()), t.session.markUndoGroup())
				},
				N = function() {
					if (p && t.onCompositionUpdate) {
				...
				W = function(e) {
					if (t.onCompositionEnd) {
						...
						var n = setTimeout(function() {
							n = null;
							var e = d.value.replace(/\x01/g, "");
							p || (e == i.lastValue ? c() : !i.lastValue && e && (c(), $(e)))
						});
						D = function(e) {
							return n && clearTimeout(n), e = e.replace(/\x01/g, ""), e == i.lastValue ? "" : (i.lastValue && n && t.undo(), e)
						}, t.onCompositionEnd(), t.removeListener("mousedown", W), "compositionend" == e.type && i.range && t.selection.setRange(i.range)
					}
				},
				P = s.delayedCall(N, 50);
			if (i.addListener(d, "compositionstart", I), n.isGecko ? i.addListener(d, "text", function() {
				P.schedule()
			}) : (i.addListener(d, "keyup", function() {
				P.schedule()
			}), i.addListener(d, "keydown", function() {
				P.schedule()
			})), i.addListener(d, "compositionend", W), this.getElement = function() {
				return d
			}, this.setReadOnly = function(e) {
				d.readOnly = e
			}, this.onContextMenu = function(e) {
				k = !0, m || (m = d.style.cssText), d.style.cssText = "z-index:100000;" + (n.isIE ? "opacity:0.1;" : ""), l(t.selection.isEmpty()), t._emit("nativecontextmenu", {
					target: t,
					domEvent: e
				});
				var s = t.container.getBoundingClientRect(),
					r = o.computedStyle(t.container),
					a = s.top + (parseInt(r.borderTopWidth) || 0),
					c = s.left + (parseInt(s.borderLeftWidth) || 0),
					u = s.bottom - a - d.clientHeight,
					g = function(e) {
						d.style.left = e.clientX - c - 2 + "px", d.style.top = Math.min(e.clientY - a - 2, u) + "px"
					};
				g(e), "mousedown" == e.type && (t.renderer.$keepTextAreaAtCursor && (t.renderer.$keepTextAreaAtCursor = null), n.isWin && i.capture(t.container, g, h))
			}, this.onContextMenuClose = h, !n.isGecko || n.isMac) {
				var H = function(e) {
						t.textInput.onContextMenu(e), h()
					};
				i.addListener(t.renderer.scroller, "contextmenu", H), i.addListener(d, "contextmenu", H)
			}
		};
	t.TextInput = l
	...
	var i = e("../lib/oop"),
		...
		s = e("../config"),
		r = function(t, i, n, o) {
			if (this.$sendDeltaQueue = this.$sendDeltaQueue.bind(this), this.changeListener = this.changeListener.bind(this), this.onMessage = this.onMessage.bind(this), e.nameToUrl && !e.toUrl && (e.toUrl = e.nameToUrl), s.get("packaged") || !e.toUrl) o = o || s.moduleUrl(i, "worker");
			else {
	...
	var i = e("./lib/oop"),
		...
		v = function(e, t) {
			...
			this.container = i, this.renderer = e, this.commands = new f(s.isMac ? "mac" : "win", p), this.textInput = new r(e.getTextAreaContainer(), this), this.renderer.textarea = this.textInput.getElement(), this.keyBinding = new c(this), this.$mouseHandler = new a(this), new l(this), this.$blockScrolling = 0, this.$search = (new d).set({
				wrap: !0
	...
	(function() {
		i.implement(this, g), this.$initOperationListeners = function() {
			...
			}.bind(this), !0), this.$opResetTimer = o.delayedCall(this.endOperation.bind(this)), this.on("change", function() {
			...
			if (e) if ("string" == typeof e) {
				this.$keybindingId = e;
				var t = this;
				m.loadModule(["keybinding", e], function(i) {
			...
			var t, i = e.data,
				n = i.range;
			t = n.start.row == n.end.row && "insertLines" != i.action && "removeLines" != i.action ? n.end.row : 1 / 0, this.renderer.updateLines(n.start.row, t), this._signal("change", e), this.$cursorChange()
			...
			if (!t.isEmpty() && !t.isMultiLine()) {
				var i = t.start.column - 1,
					...
					s = o.length,
					r = o.substring(Math.max(i, 0), Math.min(n, s));
				if (!(i >= 0 && /^[\w\d]/.test(r) || s >= n && /[\w\d]$/.test(r)) && (r = o.substring(t.start.column, t.end.column), /^[\w\d]+$/.test(r))) {
			...
			if (this.getBehavioursEnabled() && !t) {
				var s = n.transformAction(i.getState(o.row), "insertion", this, i, e);
			...
			if ("	" == e && (e = this.session.getTabString()), this.selection.isEmpty()) {
				if (this.session.getOverwrite()) {
					var r = new u.fromPoints(o, o);
					r.end.column += e.length, this.session.remove(r)
				}
			} else {
				var r = this.getSelectionRange();
				o = this.session.remove(r), this.clearSelection()
			}
			if ("\n" == e || "\r\n" == e) {
			...
			if (s && s.selection && this.selection.setSelectionRange(2 == s.selection.length ? new u(o.row, c + s.selection[0], o.row, c + s.selection[1]) : new u(o.row + s.selection[0], s.selection[1], o.row + s.selection[2], s.selection[3])), i.getDocument().isNewLine(e)) {
			...
			if (this.session.getUseSoftTabs()) var c = a - l % a,
				...
				for (var c = l % a;
				" " == s[t.start.column] && c;) t.start.column--, c--;
			...
			for (var n = new u(0, 0, 0, 0), o = e.first; o <= e.last; o++) {
				var s = t.getLine(o);
				n.start.row = o, n.end.row = o, n.end.column = s.length, t.replace(n, i[o - e.first])
			}
			...
			if (!isNaN(parseFloat(o)) && isFinite(o)) {
				...
				if (s) {
					var r = s.value.indexOf(".") >= 0 ? s.start + s.value.indexOf(".") + 1 : s.end,
						a = s.start + s.value.length - r,
						l = parseFloat(s.value);
					l *= Math.pow(10, a), e *= r !== s.end && r > i ? Math.pow(10, s.end - i - 1) : Math.pow(10, s.end - i), l += e, l /= Math.pow(10, a);
					var c = l.toFixed(a),
						h = new u(t, s.start, t, s.end);
			...
			if (i.isEmpty()) {
				...
				var s = n ? i.start : i.end,
					r = t.insert(s, t.getTextRange(i), !1);
				i.start = s, i.end = r, e.setSelectionRange(i, n)
			}
			...
			if (!t.inMultiSelectMode || this.inVirtualSelectionMode) {
				...
				for (var r = s.length; r--;) {
					for (var a = r, n = s[r].collapseRows(), l = n.end.row, c = n.start.row; r-- && (n = s[r].collapseRows(), c - n.end.row <= 1);) c = n.end.row;
					r++;
					for (var o = e.call(this, c, l); a >= r;) s[a].moveBy(o, 0), a--
				}
			...
			var s = i.scrollTop;
			i.scrollBy(0, o * n.lineHeight), null != t && i.scrollCursorIntoView(null, .5), i.animateScrolling(s)
			...
			n = i && i.cursor || n, n && (e ? i && i.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(n.row, n.column) : this.selection.moveTo(n.row, n.column))
					...
					a = this.renderer.on("afterRender", function() {
						if (n && t && i.isFocused()) {
							var e = i.renderer,
								...
								r = e.layerConfig,
								a = s.top - r.offset;
							n = s.top >= 0 && a + t.top < 0 ? !0 : s.top < r.height && s.top + t.top + r.lineHeight > window.innerHeight ? !1 : null, null != n && (o.style.top = a + "px", o.style.left = s.left + "px", o.style.height = r.lineHeight + "px", o.scrollIntoView(n)), n = t = null
						}
					});
				this.setAutoScrollEditorIntoView = function(e) {
					e || (delete this.setAutoScrollEditorIntoView, this.removeEventListener("changeSelection", s), this.renderer.removeEventListener("afterRender", a), this.renderer.removeEventListener("beforeRender", r))
				}
			}
	...
	var i = e("./range").Range,
		n = e("./lib/event_emitter").EventEmitter,
		o = e("./lib/oop"),
		s = function(e, t, i, n, o, s) {
			var r = this;
			this.length = t, this.session = e, this.doc = e.getDocument(), this.mainClass = o, this.othersClass = s, this.$onUpdate = this.onUpdate.bind(this), this.doc.on("change", this.$onUpdate), this.$others = n, this.$onCursorChange = function() {
				setTimeout(function() {
					r.onCursorChange()
				})
			}, this.$pos = i;
	...
	(function() {
		...
		this.ranges = null, this.rangeList = null, this.addRange = function(e, t) {
			...
			if (this.rangeCount > 1) {
				...
				for (var d = o + 1; s > d; d++) c.push(this.getLineRange(d, !0));
				h = this.getLineRange(s, !0), h.end.column = i.end.column, c.push(h), c.forEach(this.addRange, this)
			}
			...
			for (var u = h; d >= u; u++) {
				var g = a.fromPoints(this.session.screenToDocumentPosition(u, r), this.session.screenToDocumentPosition(u, l));
				if (g.isEmpty()) {
					if (f && n(g.end, f)) break;
					var f = g.end
				}
				g.cursor = s ? g.start : g.end, o.push(g)
			}
			if (c && o.reverse(), !i) {
				for (var p = o.length - 1; o[p].isEmpty() && p > 0;) p--;
				if (p > 0) for (var m = 0; o[m].isEmpty();) m++;
		...
		this.updateSelectionMarkers = function() {
			...
			if (!this.inVirtualSelectionMode) {
				...
				for (var g = h.length; g--;) {
					if (s) for (; g > 0 && h[g].start.row == h[g - 1].end.row;) g--;
					u.fromOrientedRange(h[g]), u.index = g, this.selection = r.selection = u;
					var f = e.exec ? e.exec(this, t || {}) : e(this, t || {});
					!n && void 0 !== f && (n = f), u.toOrientedRange(h[g])
				}
			...
			if (!this.$readOnly) {
				...
				for (var o = n.length; o--;) {
					var s = n[o];
					s.isEmpty() || this.session.remove(s), this.session.insert(s.start, i[o])
				}
			}
			...
			i || s.toSingleRange(o[0]);
			for (var r = o.length; r--;) s.addRange(o[r], !0);
			return n && s.rangeList.rangeAtPoint(n.start) && s.addRange(n, !0), this.$blockScrolling -= 1, o.length
			...
			var s = this.session.screenToDocumentPosition(o.row + e, o.column);
			if (i.isEmpty()) var r = s;
			...
			for (var t = this.session, i = t.multiSelect, n = i.ranges, o = n.length; o--;) {
				var s = n[o];
				if (s.isEmpty()) {
					var r = t.getWordRange(s.start.row, s.start.column);
					s.start.row = r.start.row, s.start.column = r.start.column, s.end.row = r.end.row, s.end.column = r.end.column
				}
			}
			...
			for (var o = n.length; o--;) {
				var s = n[o],
					r = s.clone();
				t.replace(s, a[o]), s.start.row = r.start.row, s.start.column = r.start.column
			}
		}, this.selectMore = function(e, t) {
			var n = this.session,
				o = n.multiSelect,
				s = o.toOrientedRange();
			s.isEmpty() && (s = n.getWordRange(s.start.row, s.start.column), s.cursor = -1 == e ? s.start : s.end, this.multiSelect.addRange(s));
			var r = n.getTextRange(s),
				a = i(n, r, e);
			a && (a.cursor = -1 == e ? a.start : a.end, this.$blockScrolling += 1, this.session.unfold(a), this.multiSelect.addRange(a), this.$blockScrolling -= 1, this.renderer.scrollCursorIntoView(null, .5)), t && this.multiSelect.substractPoint(s.cursor)
			...
			if (i.length) {
				...
				var s = 0,
					...
					l = i.map(function(t) {
						...
						return -1 == o && (o = 0), i.column > s && (s = i.column), r > o && (r = o), o
					});
				i.forEach(function(t, i) {
					var n = t.cursor,
						o = s - n.column,
						c = l[i] - r;
					o > c ? e.insert(n, d.stringRepeat(" ", o - c)) : e.remove(new a(n.row, n.column, n.row, n.column - o + c)), t.start.column = t.end.column = s, t.start.row = t.end.row = n.row, t.cursor = t.end
			...
			return e.map(function(e) {
				var t = e.match(/(\s*)(.*?)(\s*)([=:].*)/);
				return t ? null == r ? (r = t[1].length, a = t[2].length, l = t[3].length, t) : (r + a + l != t[1].length + t[2].length + t[3].length && (h = !1), r != t[1].length && (c = !1), r > t[1].length && (r = t[1].length), a < t[2].length && (a = t[2].length), l > t[3].length && (l = t[3].length), t) : [e]
			}).map(t ? n : c ? h ? o : n : s)
		}
	...
	function n(e) {
		...
		if (!r && !n) return void(0 === a && e.editor.inMultiSelectMode && e.editor.exitMultiSelectMode());
		var l = e.editor,
			c = l.selection,
			h = l.inMultiSelectMode,
			d = e.getDocumentPosition(),
			u = c.getCursor(),
			g = e.inSelection() || c.isEmpty() && i(d, u),
			f = e.x,
			p = e.y,
			m = function(e) {
			...
			v = function() {
				...
				i(w, e) && i(t, c.selectionLead) || (w = e, l.selection.moveToPosition(t), l.renderer.scrollCursorIntoView(), l.removeSelectionMarkers(E), E = c.rectangularRangeBlock(w, C), E.forEach(l.addSelectionMarker, l), l.updateSelectionMarkers())
			},
			A = l.session,
			C = l.renderer.pixelToScreenCoordinates(f, p),
			w = C;
		if (!r || n || s || 0 !== a) {
			if (n && 0 === a) {
				e.stop(), h && !r ? c.toSingleRange() : !h && r && c.addRange();
				var E = [];
				s ? (C = A.documentToScreenPosition(c.lead), v()) : c.moveToPosition(d);
				var F = function() {
						clearInterval(y), l.removeSelectionMarkers(E);
						for (var e = 0; e < E.length; e++) c.addRange(E[e])
					},
					b = v;
				o.capture(l.container, m, F);
			...
			l.$blockScrolling++, l.once("mouseup", function() {
				...
				S && e.isEmpty() && i(S.cursor, e.cursor) ? c.substractPoint(e.cursor) : (x && (l.removeSelectionMarker(x), c.addRange(x)), c.addRange(e)), l.$blockScrolling--
			})
		}
	}
	var o = e("../lib/event");
	...
	function i(e, t, i) {
		...
		if (8 & l && (91 === i || 93 === i) && (i = -1), l || 13 !== i || !t.location && 3 !== t.keyLocation || (e(t, l, -i), !t.defaultPrevented)) {
			if (o.isChromeOS && 8 & l) {
	...
	var s = !o.isMac || !o.isOpera || "KeyboardEvent" in window ?
	function(e) {
	...
	if (t.addCommandKeyListener = function(e, n) {
		...
		t.nextTick = function(e, i) {
			...
			t.addListener(i, "message", function o(s) {
				s.data == n && (t.stopPropagation(s), t.removeListener(i, "message", o), e())
			}), i.postMessage(n, "*")
		}
	}
	...
	(function() {
		this.foldingStartMarker = null, this.foldingStopMarker = null, this.getFoldWidget = function(e, t, i) {
			...
			var o = /\S/,
				...
				r = s.search(o);
			if (-1 != r) {
				for (var a = n || s.length, l = e.getLength(), c = t, h = t; ++t < l;) {
		...
		}, this.openingBracketBlock = function(e, t, n, o, s) {
			var r = {
				row: n,
				column: o + 1
			},
				a = e.$findClosingBracket(t, r, s);
			if (a) {
			...
			var s = {
				...
				r = e.$findOpeningBracket(t, s);
			if (r) return r.column++, s.column--, i.fromPoints(r, s)
		}
	}).call(n.prototype)
	...
	if ("undefined" != typeof document) {
		...
		t.getDocumentHead = function(e) {
			...
			var s;
			o.createStyleSheet ? (s = o.createStyleSheet(), s.cssText = e, n && (s.owningElement.id = n)) : (s = o.createElementNS ? o.createElementNS(i, "style") : o.createElement("style"), s.appendChild(o.createTextNode(e)), n && (s.id = n), t.getDocumentHead(o).appendChild(s))
		...
		function(e, t) {
			...
			o.overflow = "scroll";
			var a = i.offsetWidth;
			return r == a && (a = n.clientWidth), s.removeChild(n), r - a
	...
	var n, o, s, r, a, l = Function.prototype.call,
		c = Array.prototype,
		h = Object.prototype,
		d = c.slice,
		u = l.bind(h.toString),
		g = l.bind(h.hasOwnProperty);
	if ((a = g(h, "__defineGetter__")) && (n = l.bind(h.__defineGetter__), o = l.bind(h.__defineSetter__), s = l.bind(h.__lookupGetter__), r = l.bind(h.__lookupSetter__)), 2 != [1, 2].splice(0).length) if (function() {
		function e(e) {
			var t = new Array(e + 2);
			return t[0] = t[1] = 0, t
		}
		...
		var n = this.slice(e, e + t),
			o = d.call(arguments, 2),
			s = o.length;
		if (e === i) s && this.push.apply(this, o);
		else {
			var r = Math.min(t, i - e),
				...
				c = i - a,
				h = i - r;
			if (a > l) for (var u = 0; c > u; ++u) this[l + u] = this[a + u];
			else if (l > a) for (u = c; u--;) this[l + u] = this[a + u];
			if (s && e === h) this.length = h, this.push.apply(this, o);
			else for (this.length = h + s, u = 0; s > u; ++u) this[e + u] = o[u]
		}
		return n
	};
	...
	if (Array.prototype.forEach || (Array.prototype.forEach = function(e) {
		var t = R(this),
			i = m && "[object String]" == u(this) ? this.split("") : t,
			n = arguments[1],
			o = -1,
			s = i.length >>> 0;
		if ("[object Function]" != u(e)) throw new TypeError;
		for (; ++o < s;) o in i && e.call(n, i[o], o, t)
		...
		for (var r = 0; n > r; r++) r in i && (o[r] = e.call(s, i[r], r, t));
		return o
	}), Array.prototype.filter || (Array.prototype.filter = function(e) {
		var t, i = R(this),
			n = m && "[object String]" == u(this) ? this.split("") : i,
			o = n.length >>> 0,
			s = [],
			r = arguments[1];
		if ("[object Function]" != u(e)) throw new TypeError(e + " is not a function");
		for (var a = 0; o > a; a++) a in n && (t = n[a], e.call(r, t, a, i) && s.push(t));
		return s
		...
		var t = R(this),
			...
			o = arguments[1];
		if ("[object Function]" != u(e)) throw new TypeError(e + " is not a function");
		for (var s = 0; n > s; s++) if (s in i && !e.call(o, i[s], s, t)) return !1;
		return !0
		...
		var t = R(this),
			...
			o = arguments[1];
		if ("[object Function]" != u(e)) throw new TypeError(e + " is not a function");
		for (var s = 0; n > s; s++) if (s in i && e.call(o, i[s], s, t)) return !0;
		return !1
		...
		for (; n > s; s++) s in i && (o = e.call(void 0, o, i[s], s, t));
		return o
		...
		do s in this && (o = e.call(void 0, o, i[s], s, t));
		while (s--);
		return o
	}), Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function(e) {
		var t = m && "[object String]" == u(this) ? this.split("") : R(this),
			n = t.length >>> 0;
		if (!n) return -1;
		var o = 0;
		for (arguments.length > 1 && (o = i(arguments[1])), o = o >= 0 ? o : Math.max(0, n + o); n > o; o++) if (o in t && t[o] === e) return o;
		return -1
		...
		if (!n) return -1;
		var o = n - 1;
		for (arguments.length > 1 && (o = Math.min(o, i(arguments[1]))), o = o >= 0 ? o : n - Math.abs(o); o >= 0; o--) if (o in t && e === t[o]) return o;
		return -1
	...
	if (Object.getOwnPropertyNames || (Object.getOwnPropertyNames = function(e) {
		...
		var A;
		A = null === Object.prototype.__proto__ ?
		function() {
			return {
				__proto__: null
			}
	...
	if (Object.defineProperty) {
		var C = t({}),
			w = "undefined" == typeof document || t(document.createElement("div"));
		if (!C || !w) var E = Object.defineProperty
	}
	if (!Object.defineProperty || E) {
		...
		Object.defineProperty = function(e, t, i) {
			...
			if ("object" != typeof i && "function" != typeof i || null === i) throw new TypeError(F + i);
			if (E) try {
				return E.call(Object, e, t, i)
			} catch (l) {}
			if (g(i, "value")) if (a && (s(e, t) || r(e, t))) {
				var c = e.__proto__;
	...
	o && n || (RegExp.prototype.exec = function(s) {
		var r, a, l = i.exec.apply(this, arguments);
		if ("string" == typeof s && l) {
			if (!n && l.length > 1 && t(l, "") > -1 && (a = RegExp(this.source, i.replace.call(e(this), "g", "")), i.replace.call(s.slice(l.index), a, function() {
				for (var e = 1; e < arguments.length - 2; e++) void 0 === arguments[e] && (l[e] = void 0)
			})), this._xregexp && this._xregexp.captureNames) for (var c = 1; c < l.length; c++) r = this._xregexp.captureNames[c - 1], r && (l[r] = l[c]);
	...
	function n(e, t, n) {
		var o = e.getAnnotations().sort(r.comparePoints);
		if (o.length) {
			var s = i(o, {
				row: t,
				column: -1
			}, r.comparePoints);
			0 > s && (s = -s - 1), s >= o.length - 1 ? s = n > 0 ? 0 : o.length - 1 : 0 === s && 0 > n && (s = o.length - 1);
			var a = o[s];
			if (a && n) {
				if (a.row === t) {
					do a = o[s += n];
				...
				var l = [];
				t = a.row;
				do l[0 > n ? "unshift" : "push"](a), a = o[s += n];
				while (a && a.row == t);
				return l.length && l
			}
		}
	}
	var o = e("ace/line_widgets").LineWidgets,
		s = e("ace/lib/dom"),
		r = e("ace/range").Range;
	t.showErrorMarker = function(e, t) {
		...
		if (h) {
			var d = h[0];
			r.column = (d.pos && "number" != typeof d.column ? d.pos.sc : d.column) || 0, r.row = d.row, c = e.renderer.$gutterLayer.$annotations[r.row]
		} else {
			if (l) return;
			c = {
				text: ["Looks good!"],
		...
		f.style.left = p + e.renderer.gutterWidth - 5 + "px", u.el.className = "error_widget_wrapper", g.className = "error_widget " + c.className, g.innerHTML = c.text.join("<br>"), g.appendChild(s.createElement("div"));
		...
		u.destroy = function() {
			e.$mouseHandler.isMousePressed || (e.keyBinding.removeKeyboardHandler(m), i.widgetManager.removeLineWidget(u), e.off("changeSelection", u.destroy), e.off("changeSession", u.destroy), e.off("mouseup", u.destroy), e.off("change", u.destroy))
		}, e.keyBinding.addKeyboardHandler(m), e.on("changeSelection", u.destroy), e.on("changeSession", u.destroy), e.on("mouseup", u.destroy), e.on("change", u.destroy), e.session.widgetManager.addLineWidget(u), u.el.onmousedown = e.focus.bind(e), e.renderer.scrollCursorIntoView(null, .5, {
	...
	function i(e) {
		...
		this.getRowLength = function(e) {
			...
			e.widgetManager && e.widgetManager != this && e.widgetManager.detach(), this.editor != e && (this.detach(), this.editor = e, this.editor.on("changeSession", this.detach), e.widgetManager = this, e.setOption("enableLineWidgets", !0), e.renderer.on("beforeRender", this.measureWidgets), e.renderer.on("afterRender", this.renderWidgets))
			...
			if (t) {
				var i = e.data,
					...
					o = n.start.row,
					s = n.end.row - o;
				if (0 !== s) if ("removeText" == i.action || "removeLines" == i.action) {
					var r = t.splice(o + 1, s);
			...
			var i = this.session._changedWidgets,
				n = t.layerConfig;
			if (i && i.length) {
				for (var o = 1 / 0, s = 0; s < i.length; s++) {
					var r = i[s];
					...
					r.coverLine && (a -= this.session.getRowLineCount(r.row), 0 > a && (a = 0)), r.rowCount != a && (r.rowCount = a, r.row < o && (o = r.row))
				}
			...
			if (n) {
				for (var o = Math.min(this.firstRow, i.firstRow), s = Math.max(this.lastRow, i.lastRow, n.length); o > 0 && !n[o];) o--;
	...
	(function() {
		...
		function(e) {
			...
			for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = t || 0, s = i.length; s > o; o++) if (e -= i[o].length + n, 0 > e) return {
				row: o,
			...
			for (var i = this.$lines || this.getAllLines(), n = this.getNewLineCharacter().length, o = 0, s = Math.min(e.row, i.length), r = t || 0; s > r; ++r) o += i[r].length + n;
			return o + e.column
		}
	...
	(function() {
		this.setEditor = function(e) {
			...
			o.addListener(e, "mousedown", function(e) {
				...
				var s = a.keyCodeToString(n),
					r = t.$searchBarKb.findKeyCommand(i, s);
				r && r.exec && (r.exec(t), o.stopEvent(e))
		...
		}, this.$closeSearchBarKb = new r([{
			bindKey: "Esc",
			name: "closeSearchBar",
			exec: function(e) {
				e.searchBox.hide()
			}
		}]), this.$searchBarKb = new r, this.$searchBarKb.bindKeys({
...
}(), define("ace/mode/json", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/json_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/worker/worker_client"], function(e, t) {
	var i = e("../lib/oop"),
		n = e("./text").Mode,
		...
		c = function() {
			this.HighlightRules = o, this.$outdent = new s, this.$behaviour = new r, this.foldingRules = new a
		};
...
}), define("ace/mode/json_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t) {
	var i = e("../lib/oop"),
		n = e("./text_highlight_rules").TextHighlightRules,
		o = function() {
			this.$rules = {
	...
	var i, n = e("../../lib/oop"),
		...
		h = function(e) {
			var t = -1;
			return e.multiSelect && (t = e.selection.id, c.rangeCount != e.multiSelect.rangeCount && (c = {
		...
		d = function() {
			this.add("braces", "insertion", function(e, t, n, o, s) {
				...
				if ("{" == s) {
					...
					if (d.isSaneInsertion(n, o)) return /[\]\}\)]/.test(l[a.column]) || n.inMultiSelectMode ? (d.recordAutoInsert(n, o, "}"), {
						text: "{}",
						selection: [1, 1]
					}) : (d.recordMaybeInsert(n, o, "{"), {
						text: "{",
						selection: [1, 1]
					})
				} else if ("}" == s) {
					...
					if ("}" == g) {
						...
						if (null !== f && d.isAutoInsertedClosing(a, l, s)) return d.popAutoInsertedClosing(), {
							text: "",
							selection: [1, 1]
						}
					}
					...
					if ("\n" == s || "\r\n" == s) {
						h(n);
						var p = "";
						d.isMaybeInsertedClosing(a, l) && (p = r.stringRepeat("}", i.maybeInsertedBrackets), d.clearMaybeInsertedClosing());
						var g = l.substring(a.column, a.column + 1);
						if ("}" === g) {
			...
			}), this.add("braces", "deletion", function(e, t, n, o, s) {
				var r = o.doc.getTextRange(s);
				if (!s.isMultiLine() && "{" == r) {
					h(n);
					var a = o.doc.getLine(s.start.row),
						l = a.substring(s.end.column, s.end.column + 1);
					if ("}" == l) return s.end.column++, s;
				...
				if ("(" == o) {
					...
					if ("" !== r && i.getWrapBehavioursEnabled()) return {
						text: "(" + r + ")",
						selection: !1
					};
					...
					if (")" == c) {
						var u = n.$findOpeningBracket(")", {
							column: a.column + 1,
							row: a.row
						});
						if (null !== u && d.isAutoInsertedClosing(a, l, o)) return d.popAutoInsertedClosing(), {
							text: "",
							selection: [1, 1]
						}
					}
				...
				if (!o.isMultiLine() && "(" == s) {
					h(i);
					var r = n.doc.getLine(o.start.row),
						a = r.substring(o.start.column + 1, o.start.column + 2);
				...
				if ('"' == o || "'" == o) {
					...
					if ("\\" == u) return null;
					for (var g, f = n.getTokens(r.start.row), p = 0, m = -1, v = 0; v < f.length && (g = f[v], "string" == g.type ? m = -1 : 0 > m && (m = g.value.indexOf(s)), !(g.value.length + p > r.start.column)); v++) p += f[v].value.length;
					if (!g || 0 > m && "comment" !== g.type && ("string" !== g.type || r.start.column !== g.value.length + p - 1 && g.value.lastIndexOf(s) === g.value.length - 1)) {
				...
				var s = n.doc.getTextRange(o);
				if (!o.isMultiLine() && ('"' == s || "'" == s)) {
					h(i);
					var r = n.doc.getLine(o.start.row),
						a = r.substring(o.start.column + 1, o.start.column + 2);
					if (a == s) return o.end.column++, o
				}
			})
		};
	d.isSaneInsertion = function(e, t) {
		...
		var o = e.getCursorPosition(),
			s = t.doc.getLine(o.row);
		this.isAutoInsertedClosing(o, s, i.autoInsertedLineEnd[0]) || (i.autoInsertedBrackets = 0), i.autoInsertedRow = o.row, i.autoInsertedLineEnd = n + s.substr(o.column), i.autoInsertedBrackets++
	}, d.recordMaybeInsert = function(e, t, n) {
		var o = e.getCursorPosition(),
			s = t.doc.getLine(o.row);
		this.isMaybeInsertedClosing(o, s) || (i.maybeInsertedBrackets = 0), i.maybeInsertedRow = o.row, i.maybeInsertedLineStart = s.substr(0, o.column) + n, i.maybeInsertedLineEnd = s.substr(o.column), i.maybeInsertedBrackets++
	...
	}, n.inherits(d, o), t.CstyleBehaviour = d
	...
	i.inherits(s, o), function() {
		this.foldingStartMarker = /(\{|\[)[^\}\]]*$|^\s*(\/\*)/, this.foldingStopMarker = /^[^\[\{]*(\}|\])|^[\s\*]*(\*\/)/, this.getFoldWidgetRange = function(e, t, i, n) {
			var o = e.getLine(i),
				s = o.match(this.foldingStartMarker);
			if (s) {
				var r = s.index;
				if (s[1]) return this.openingBracketBlock(e, s[1], i, r);
				var a = e.getCommentFoldRange(i, r + s[0].length, 1);
				return a && !a.isMultiLine() && (n ? a = this.getSectionRange(e, i) : "all" != t && (a = null)), a
			}
			if ("markbegin" !== t) {
				var s = o.match(this.foldingStopMarker);
				if (s) {
					var r = s.index + s[0].length;
					return s[1] ? this.closingBracketBlock(e, s[1], i, r) : e.getCommentFoldRange(i, r, -1)
				}
			}
			...
			return new n(s, r, a, e.getLine(a).length)
		}
	}.call(s.prototype)
}), define("ace/theme/textmate", ["require", "exports", "module", "ace/lib/dom"], function(e, t) {
	t.isDark = !1, t.cssClass = "ace-tm", t.cssText = '.ace-tm .ace_gutter {background: #f0f0f0;color: #333;}.ace-tm .ace_print-margin {width: 1px;background: #e8e8e8;}.ace-tm .ace_fold {background-color: #6B72E6;}.ace-tm {background-color: #FFFFFF;color: black;}.ace-tm .ace_cursor {color: black;}.ace-tm .ace_invisible {color: rgb(191, 191, 191);}.ace-tm .ace_storage,.ace-tm .ace_keyword {color: blue;}.ace-tm .ace_constant {color: rgb(197, 6, 11);}.ace-tm .ace_constant.ace_buildin {color: rgb(88, 72, 246);}.ace-tm .ace_constant.ace_language {color: rgb(88, 92, 246);}.ace-tm .ace_constant.ace_library {color: rgb(6, 150, 14);}.ace-tm .ace_invalid {background-color: rgba(255, 0, 0, 0.1);color: red;}.ace-tm .ace_support.ace_function {color: rgb(60, 76, 114);}.ace-tm .ace_support.ace_constant {color: rgb(6, 150, 14);}.ace-tm .ace_support.ace_type,.ace-tm .ace_support.ace_class {color: rgb(109, 121, 222);}.ace-tm .ace_keyword.ace_operator {color: rgb(104, 118, 135);}.ace-tm .ace_string {color: rgb(3, 106, 7);}.ace-tm .ace_comment {color: rgb(76, 136, 107);}.ace-tm .ace_comment.ace_doc {color: rgb(0, 102, 255);}.ace-tm .ace_comment.ace_doc.ace_tag {color: rgb(128, 159, 191);}.ace-tm .ace_constant.ace_numeric {color: rgb(0, 0, 205);}.ace-tm .ace_variable {color: rgb(49, 132, 149);}.ace-tm .ace_xml-pe {color: rgb(104, 104, 91);}.ace-tm .ace_entity.ace_name.ace_function {color: #0000A2;}.ace-tm .ace_heading {color: rgb(12, 7, 255);}.ace-tm .ace_list {color:rgb(185, 6, 144);}.ace-tm .ace_meta.ace_tag {color:rgb(0, 22, 142);}.ace-tm .ace_string.ace_regex {color: rgb(255, 0, 0)}.ace-tm .ace_marker-layer .ace_selection {background: rgb(181, 213, 255);}.ace-tm.ace_multiselect .ace_selection.ace_start {box-shadow: 0 0 3px 0px white;border-radius: 2px;}.ace-tm .ace_marker-layer .ace_step {background: rgb(252, 255, 0);}.ace-tm .ace_marker-layer .ace_stack {background: rgb(164, 229, 101);}.ace-tm .ace_marker-layer .ace_bracket {margin: -1px 0 0 -1px;border: 1px solid rgb(192, 192, 192);}.ace-tm .ace_marker-layer .ace_active-line {background: rgba(0, 0, 0, 0.07);}.ace-tm .ace_gutter-active-line {background-color : #dcdcdc;}.ace-tm .ace_marker-layer .ace_selected-word {background: rgb(250, 250, 255);border: 1px solid rgb(200, 200, 250);}.ace-tm .ace_indent-guide {background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAE0lEQVQImWP4////f4bLly//BwAmVgd1/w11/gAAAABJRU5ErkJggg==") right repeat-y;}';
	var i = e("../lib/dom");
	i.importCssString(t.cssText, t.cssClass)
}), define("ace/theme/jsoneditor", ["require", "exports", "module", "ace/lib/dom"], function(e, t) {
...
var jsonlint = function() {
		var e = {
			...
			performAction: function(e, t, i, n, o, s) {
				var r = s.length - 1;
				switch (o) {
				case 1:
				...
				case 15:
					...
					break;
				case 16:
					this.$ = {}, this.$[s[r][0]] = s[r][1];
					break;
				case 17:
					this.$ = s[r - 2], s[r - 2][s[r][0]] = s[r][1];
					break;
				case 18:
					this.$ = [];
					break;
			...
			parse: function(e) {
				function t(e) {
					o.length = o.length - 2 * e, s.length = s.length - e, r.length = r.length - e
				}
				function i() {
					var e;
				...
				r.push(f), "function" == typeof this.yy.parseError && (this.parseError = this.yy.parseError);
				for (var p, m, v, A, C, w, E, F, b, y = {};;) {
					if (v = o[o.length - 1], this.defaultActions[v] ? A = this.defaultActions[v] : (null == p && (p = i()), A = a[v] && a[v][p]), "undefined" == typeof A || !A.length || !A[0]) {
						if (!d) {
							b = [];
							for (w in a[v]) this.terminals_[w] && w > 2 && b.push("'" + this.terminals_[w] + "'");
							var x = "";
							x = this.lexer.showPosition ? "Parse error on line " + (c + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + b.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (c + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(x, {
						...
						m = p, p = u, v = o[o.length - 1], A = a[v] && a[v][u], d = 3
					}
					if (A[0] instanceof Array && A.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + v + ", token: " + p);
					switch (A[0]) {
					case 1:
						o.push(p), s.push(this.lexer.yytext), r.push(this.lexer.yylloc), o.push(A[1]), p = null, m ? (p = m, m = null) : (h = this.lexer.yyleng, l = this.lexer.yytext, c = this.lexer.yylineno, f = this.lexer.yylloc, d > 0 && d--);
						break;
					case 2:
						if (E = this.productions_[A[1]][1], y.$ = s[s.length - E], y._$ = {
							first_line: r[r.length - (E || 1)].first_line,
							last_line: r[r.length - 1].last_line,
							first_column: r[r.length - (E || 1)].first_column,
							last_column: r[r.length - 1].last_column
						}, C = this.performAction.call(y, l, h, c, this.yy, A[1], s, r), "undefined" != typeof C) return C;
						E && (o = o.slice(0, -1 * E * 2), s = s.slice(0, -1 * E), r = r.slice(0, -1 * E)), o.push(this.productions_[A[1]][0]), s.push(y.$), r.push(y._$), F = a[o[o.length - 2]][o[o.length - 1]], o.push(F);
						break;
					case 3:
						return !0
					}
...
"undefined" != typeof require && "undefined" != typeof exports && (exports.parser = jsonlint, exports.parse = function() {
	...
	else var i = require("file").path(require("file").cwd()),
		t = i.join(e[1]).read({
			charset: "utf-8"
		});
...
util.addEventListener = function(e, t, i, n) {
	...
	s.className = "prompt-form", s.target = e.formTarget || "", s.action = e.formAction || "", s.method = e.formMethod || "POST", s.enctype = "multipart/form-data", s.encoding = "multipart/form-data", s.onsubmit = function() {
	...
	if (r.className = "prompt-title", r.appendChild(document.createTextNode(e.title || "Dialog")), s.appendChild(r), e.description) {
		var a = document.createElement("div");
		a.className = "prompt-description", a.innerHTML = e.description, s.appendChild(a)
	}
	var l = document.createElement("input");
	l.className = "prompt-field", l.type = e.inputType || "text", l.name = e.inputName || "text", l.value = e.inputDefault || "";
	var c = document.createElement("div");
	c.className = "prompt-contents", c.appendChild(l), s.appendChild(c);
	var h = document.createElement("input");
	h.className = "prompt-cancel", h.type = "button", h.value = e.titleCancel || "Cancel", h.onclick = i;
	var d = document.createElement("input");
	d.className = "prompt-submit", d.type = "submit", d.value = e.titleSubmit || "Ok";
	var u = document.createElement("div");
	u.className = "prompt-buttons", u.appendChild(h), u.appendChild(d), s.appendChild(u);
	var g = document.createElement("div");
	g.className = "prompt-border", g.appendChild(s);
	...
	for (var e, t, i = window.location.search.substring(1), n = i.split("&"), o = {}, s = 0, r = n.length; r > s; s++) {
		var a = n[s].split("=");
		...
		function e(e, t, i, n, o) {
			try {
				...
				if (s.onreadystatechange = function() {
					4 == s.readyState && o(null, s.responseText, s.status)
				}, s.open(e, t, !0), n) for (var r in n) n.hasOwnProperty(r) && s.setRequestHeader(r, n[r]);
				s.send(i)
			} catch (a) {
				o(a, null, 0)
			}
...
Notify.prototype.showNotification = function(e, t) {
	...
	if (d.innerHTML = e.message || "", h.appendChild(d), r) {
		var u = document.createElement("td");
		u.style.textAlign = "right", u.style.verticalAlign = "top", h.appendChild(u);
		var g = document.createElement("button");
		g.innerHTML = "&times;", g.title = "Close message (ESC)", u.appendChild(g);
		var f = this;
		g.onclick = function() {
			f.removeMessage(a)
		}
	...
	var n = this,
		...
		s = this.scriptUrl;
	ajax.get(e, n.headers, function(t, i, r) {
		if (200 == r) o(null, i);
		else {
			var a = s + "?url=" + encodeURIComponent(e);
	...
	var t = void 0,
		...
		o = function(n, o, s) {
			e && (e(n, o, s), e = null), i.notify && t && (i.notify.removeMessage(t), t = void 0)
		},
	...
	if (s) util.prompt({
		...
		var r = "fileretriever-upload-" + Math.round(1e15 * Math.random()),
	...
	var s = this,
		r = function(e) {
			i && (i(e), i = void 0), s.notify && o && (s.notify.removeMessage(o), o = void 0)
		},
		a = document.createElement("a");
	this.options.html5 && void 0 != a.download && !util.isFirefox() ? (a.style.display = "none", a.href = "data:application/json;charset=utf-8," + encodeURIComponent(e), a.download = n, document.body.appendChild(a), a.click(), document.body.removeChild(a), r()) : e.length < this.options.maxSize ? ajax.post(s.scriptUrl, e, s.headers, function(e, t, i) {
		if (200 == i) {
			var o = document.createElement("iframe");
			o.src = s.scriptUrl + "?id=" + t + "&filename=" + n, s._hide(o), document.body.appendChild(o), r()
	...
	if (e) {
		...
		var o, s = this,
			r = t.name || null,
			a = i && i.silent || !1;
		t.name = r, t._rev = this.revs[t._id] || t._rev, a || (o = this.notify.showNotification("saving document..."));
		var l = JSON.stringify(t),
			c = {
				"content-type": "application/json"
			};
		ajax.put(this.url, l, c, function(e, i, a) {
			if (s.notify.removeMessage(o), 200 == a) {
				var l = JSON.parse(i),
					c = l && l.id || t._id || null,
	...
	ajax.get(this.url + e, null, function(e, o, s) {
		i.removeMessage(n), 200 == s ? t(null, JSON.parse(o)) : t(OnlineStore._createError(e || o, new Error("Failed to load document")), null)
	})
}, OnlineStore.prototype.remove = function(e, t) {
	var i = this.notify,
		n = i.showNotification("deleting document...");
	ajax.del(this.url + e._id + "/" + e._rev, null, function(e, o, s) {
		i.removeMessage(n), 200 == s || 404 == s ? t(null, o) : t(OnlineStore._createError(e || o, new Error("Failed to delete document")), null)
	})
...
app.doc = {
	...
	try {
		app.notify = new Notify, app.retriever = new FileRetriever({
			...
			url: "http://api.jsoneditoronline.org/docs/",
			notify: app.notify
		});
		...
		}, util.addEventListener(window, "resize", app.resize), document.body.onkeydown = function(e) {
		...
		var s = document.getElementById("openFromDisk");
		s.onclick = function(e) {
			app.openFromDisk(), e.stopPropagation(), e.preventDefault()
		};
		var r = document.getElementById("openUrl");
		...
		else if (d) codeEditor.setText(d), treeEditor.setText(d), app.changed = !1;
		else if (u) app.openUrl(u);
	...
	if (app.lastFilesStr != t) {
		...
		i.innerHTML = "", n.length > 0 && n.forEach(function(t) {
			...
			s.className = "open", s.href = location.pathname + "?id=" + t, s.appendChild(document.createTextNode(n.name || t)), s.title = "Date: " + n.updated.substring(0, 19).replace("T", " "), o.appendChild(s);
			var r = document.createElement("a");
			r.className = "remove", r.innerHTML = "&times;", r.title = 'Delete "' + n.name + '"', r.onclick = function(e) {
	...
	return "undefined" != typeof jsonlint && (i += '<a class="error" href="http://www.bejson.com/" target="_blank">validated online</a>'), i
	...
	if (c && (l -= c + a), app.splitter) {
		...
		if (d) if (u) {
			...
			s.innerHTML = m ? "|" : "&#8942;", s.title = "Drag left or right to change the width of the panels"
		} else f = l * h - p, s.innerHTML = "&lsaquo;", s.title = "Drag left to show the tree editor";
		else f = 0, s.innerHTML = "&rsaquo;", s.title = "Drag right to show the code editor";
		i.style.display = 0 == h ? "none" : "", i.style.width = Math.max(Math.round(f), 0) + "px", codeEditor.resize(), s.style.height = n.clientHeight - o.clientHeight - 2 * a - (g ? a : 0) + "px", s.style.lineHeight = s.style.height, t.style.display = 1 == h ? "none" : "", t.style.left = Math.round(f + p) + "px", t.style.width = Math.max(Math.round(l - f - p - 2), 0) + "px"
	}
