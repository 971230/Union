...
<script type="text/javascript" src="js/contract_audit.js"></script>
<div class="division">
<form  class="validate" method="post" action="" id='contract_audit_form' validate="true">
...
<table width="100%">
  <tbody>
	  ...
	  <tr>
	  	<tr>
	    <th>申请时间：</th>
	   	 <td colspan="3"><span>${orderAudit.create_date}</span></td>
	    <tr>
	    <th>申请原因：</th>
	   	 <td colspan="3"><span>${orderAudit.apply_message}</span></td>
	  </tr>
	  </tr>
	 ...
	 <c:if test="${orderAudit.mgr_deal_message!=null}">  
      ...
      <tr>
	    <th>审核处理：</th>
	   	 <td colspan="3"><textarea value="" autocomplete="on"  required="true" rows="5" cols="70" name="orderAudit.p_audit_message"></textarea></td>
	  </tr>
	  <tr>
		<th>处理：</th>
