...
<table  class="form-table">
	<tr>
		...
		<td><input type="text" class="ipttxt"  name="eopSite.sitename" 
	...
	<tr>
     ...
     <tr>
       ...
       <td><input type="text" class="ipttxt"  name="sitedomain" id="sitedomain"  /><span class="notice-span"  id="warn_brandlogo">必须为站点指定域名</span>
           </td>
     </tr>
	<tr>
