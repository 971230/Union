...
<div class="grid">
	<div class="comBtnDiv">
		...
		<a href="javascript:;" id="revertBtn" style="margin-right:10px;" class="graybtn1"><span>还原</span></a>
		<a href="javascript:;" id="cleanBtn" style="margin-right:10px;" class="graybtn1"><span>清除</span></a>
		<a href="comments!bglist.do?object_type=${object_type }" style="margin-right:10px;" class="graybtn1" ><span>返回列表</span></a>
...
<grid:grid  from="webpage">
	...
	<grid:header>
	<grid:cell width="250px"><input type="checkbox" id="toggleChk" /></grid:cell>
