...
<title>${title }</title>
<link rel="stylesheet" href="<%=request.getContextPath() %>${themes}/default/css/reset_hn.css" type="text/css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>${themes}/default/css/login_hn.css" type="text/css" />
    	...
    	<div class="login_table">
    	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	    ...
    	    <tr>
    	      ...
    	      <td>
                  <div class="login_sel">
                  <select id="app_source_from" style="width:255px; height:24px;border:none;" class="ipt_new" ></select>
    	  ...
    	  <tr>
    	  	<th></th>
    	      <td>
                  <div style="width:260px;padding-right:5px;text-align: right;">
    	  ...
    	  <script>
  	      $("#loss_pwd").bind("click",function(){
  	      	  var url =ctx+"/core/admin/user/userAdmin!forwardResetBossPwdJsp.do"; //addby wui修改，不能再动了
				window.open(url);
