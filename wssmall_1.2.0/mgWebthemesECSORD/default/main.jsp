...
<link href="${context}/css/tab.css" rel="stylesheet" type="text/css" />
<link href="${context}/css/top.css" rel="stylesheet" type="text/css" />
...
<body>
	<div class="topContent">
		...
		<div class="userTop">
			...
			<div class="userTxt" style="width: 500px;">
				<p class="p_name">
					<span class="item"><%=adminUser.getRealname()%></span>
					<a href="javascipt:void(0);" class="vbb" style="margin-left:10px;display: none;"></a>
				</p>
				<p>
					...
					<!-- <a href="javascipt:void(0);">系统通知</a><span>|</span> 
					<a
						href="javascript:void(0);"
						onclick="javascript:window.open('/index.jsp');return false;"
						target='iframe' style="margin-right:5px;">浏览</a><span>|</span>-->
				<p class="p_link">
					<!-- <a
				        ...
				        <span>|</span> --><a
						target='noneMenu' name="修改密码" app_menu_id="11107" class='shortCut' iframeall='yes' href="../core/admin/user/userAdmin!forwardBossPwdJsp.do" text="修改密码">修改密码</a>
				</p>
			</div>
			<p class="p_link">
	...
	<div class="top2" style="background:none;">
