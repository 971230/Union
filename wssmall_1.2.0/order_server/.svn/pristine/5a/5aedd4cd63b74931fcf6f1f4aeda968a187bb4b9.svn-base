 ...
 *
 */
public class ContractHandleReportAction extends WWAction {
	...
	public String reportList(){
		...
		this.webpage = reportManager.getContractHandlePage(userid, lan_id == null ? null :new String[]{lan_id}, state, startTime, endTime, getPage(), getPageSize(), isExport); 
		return returnResult;
	...
	public String reportDetail() {
		...
		this.webpage = reportManager.getContractDetail(userid, new String[]{lan_id}, state, startTime, endTime, getPage(), getPageSize(), isExport);
		return returnResult;
	}
