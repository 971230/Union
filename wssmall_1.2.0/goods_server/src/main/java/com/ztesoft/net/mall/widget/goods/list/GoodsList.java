...
public class GoodsList extends AbstractWidget {
	...
	protected void display(Map<String, String> params) {
        ...
        Settings setting = JSON.parseObject(settingJson, Settings.class);
        ...
        if (setting != null) {
            ...
            if (distype == null || "default".equals(distype)) {
                ...
                Term term = JSON.parseObject(termJson, Term.class);
                if (term != null) {
            ...
            if (distype == null || "morediv".equals(distype)) {
                ...
                Collection configList = JSON.parseArray(tabsjson, Tab.class);
