 ...
 * @version V1.0
 */
public class GeneralProductPluginN extends AutoRegisterPlugin implements IGoodsAfterAddEventN,IGoodsAfterEditEventN,IGoodsDeleteEventN {
