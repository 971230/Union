...
public class GoodsImageReader {
	...
	public String[] read(String folder,Integer goodsid,String excludeStr ){ //C:\goodsimport\ 359929607_SendPhoto_20130506185721_6.jpg
		String[] exclude = null;
		...
		for(String imgname: imgNames){
			...
			FileBaseUtil.copyFile(sourcePath,  EopSetting.IMG_SERVER_PATH+"/attachment/goods/"+goodsid+"/"+imgname);
	...
	public String[] readStr(String folder,String goodsid,String excludeStr ){
		String[] exclude = null;
		...
		for(String imgname: imgNames){
			...
			String targetPath = getThumbPathStr(imgname,"_thumbnail",goodsid);
			createThumb(sourcePath,targetPath,thumbnail_pic_width,thumbnail_pic_height);
			
			targetPath = getThumbPathStr(imgname,"_small",goodsid);
			createThumb(sourcePath,targetPath,detail_pic_width,detail_pic_height);
			
			targetPath = getThumbPathStr(imgname,"_big",goodsid);
			createThumb(sourcePath,targetPath,album_pic_width,album_pic_height);
	...
	private String getThumbPathStr(String filename,String shortName,String goodsid){
		String name  =UploadUtil.getThumbPath(filename, shortName);
		String path  =  EopSetting.IMG_SERVER_PATH+"/attachment/goods/"+goodsid;
		File file =new File(path);
