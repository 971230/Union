...
function initUpload(ctx,ext){
	...
	var settings = {
		flash_url :  ctx+"/appres/com/ztesoft/net/mall/plugin/standard/album/js/swfupload.swf",
		...
		// Button settings
		button_image_url: ctx+"/appres/com/ztesoft/net/mall/plugin/standard/album/images/XPButtonUploadText_61x22.png",	// Relative to the Flash file
		button_width: "61",
		button_height: "22",
