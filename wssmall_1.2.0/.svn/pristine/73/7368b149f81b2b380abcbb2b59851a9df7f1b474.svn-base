package zte.net.iservice.params.sms.req;
...
public class SendOfflineMsgReq extends ZteRequest<SendOfflineMsgResp>{
	...
	@ZteSoftCommentAnnotationParam(name="内容类型",type="String",isNecessary="Y",desc="01：通知；02：回复；03：广告；20：其他")
	...
	public String getApiMethodName() {
		return SysConst.API_PREFIX + "sendOfflineMsg";
	}
