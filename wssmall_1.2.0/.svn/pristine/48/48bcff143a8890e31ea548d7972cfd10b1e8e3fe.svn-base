package com.ztesoft.net.framework.util.ip;
...
public class IPSeeker {
    ...
    /*	 logger.info(DateUtil.toString(new Date(),"yyMMddHHmmss ssss"  )); 
    	  
    	  //测试IP 58.20.43.13  
    	 logger.info(ip.getIPLocation("60.15.93.239").getCountry()+":"+ip.getIPLocation("60.15.93.239").getArea());  
    	 logger.info(DateUtil.toString(new Date(),"yyMMddHHmmss ssss"  )); 
