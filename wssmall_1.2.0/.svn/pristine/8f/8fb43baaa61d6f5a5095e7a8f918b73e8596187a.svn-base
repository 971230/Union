...
public class OrderInfo {
	...
	private String sessionId;//请求标志唯一号，目前用订单号标识

	private String eparchyCode;//归属城市
	
	private String idTypeCode;//证件类型
	...
	private String firstFeeType;//资费方式
	
	private String telephone;//开户号码
	
	private String activityCode;//合约编码
	
	private String productName;//产品别名
	
	private String bizPackage;//可选活动
	...
	private String result;//开户写卡处理结果
	
	private String usim;//开户写卡成功后，返回订单系统的USIM卡号
