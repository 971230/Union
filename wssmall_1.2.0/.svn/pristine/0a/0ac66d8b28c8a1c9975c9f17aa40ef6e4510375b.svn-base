...
public class InternetOrderStandardResp extends OrderCollectionResp {
	...
	public String toString() {
		...
		builder.append("InternetOrderStandardResp [validate_type=").append(validate_type).append(", validate_msg=")
