 ...
 *
 */
public class GoodsAttHKHY extends GoodsAtt implements Serializable {
	...
	@ZteSoftCommentAnnotationParam(name = "货品类型", type = "String", isNecessary = "N", desc = "ProductType：货品类型")
	...
	@ZteSoftCommentAnnotationParam(name = "合约信息", type = "String", isNecessary = "Y", desc = "ActivityInfo：合约信息")
