...
import com.ztesoft.net.cache.redis.jedis.ScanParams;
import com.ztesoft.net.cache.redis.jedis.ScanResult;
import com.ztesoft.net.cache.redis.jedis.Tuple;
import com.ztesoft.net.cache.redis.jedis.ZParams;
