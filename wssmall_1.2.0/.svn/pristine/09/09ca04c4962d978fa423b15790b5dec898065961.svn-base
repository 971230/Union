...
//                        } 
                        ...
                        logger.debug("a>>>>>>> : " + distFolder + File.separator + localFile.getParent()); 
                        logger.debug("x>>>>>>> : " + objFolder); 
              ...
              //  property = new Properties(); 
               ...
               // try { 
                       ...
                       // property.load(inBuff); 
                        userName ="weblogic";// property.getProperty("username"); 
                        password ="weblogic";//property.getProperty("password"); 
                        ip = "10.45.46.240";//property.getProperty("ip"); 
                        port = Integer.parseInt("22"); 
