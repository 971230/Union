...
//		if (p_dynamic_dict.m_ActionId.equals("WSS_SERV_TYPE_QRY"))
//			logger.info("ertwert");
//
////		DynamicDict dict = WBCacheUtil.getAction(p_dynamic_dict, strDBName);
////
////		if (dict != null)
////			return dict;
//
...
//		disp = null;
////		WBCacheUtil.putAction(p_dynamic_dict, strDBName);
//		return p_dynamic_dict;
//	}
//
//	/**
