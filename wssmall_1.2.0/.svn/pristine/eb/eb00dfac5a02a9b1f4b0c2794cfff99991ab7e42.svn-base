...
public class MobileProductPage2_6Request extends AbsHttpRequest<MobileNetworkServiceHandleReq, String>{
	private static Logger logger = Logger.getLogger(MobileProductPage2_6Request.class);
	private final String globalPageName = "personalserv.dealtradefee.DealTradeFee";


	public MobileProductPage2_6Request(HttpLoginClient client) {
		super(client);
	}
	...
	protected String unpack(PageHttpResponse response) {
		...
		this.body.add(new BasicNameValuePair("netCode", "50"));
	...
	public String getUrl() {
		return "https://gd.cbss.10010.com/custserv?swallow/personalserv.dealtradefee.DealTradeFee/archiveMphoneNo/1";
	}
