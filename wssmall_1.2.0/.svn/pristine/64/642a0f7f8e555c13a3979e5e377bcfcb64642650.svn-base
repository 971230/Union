...
public interface IDataManager {
	...
	public Page listAllN(String catid, String source_from, String term, String orders, boolean showchild, int page,int pageSize);
	 ...
	 */
	public void edit(Integer modelid,String catid,String dataid,String source_from);
	...
	public Page listAll(String catid,String source_from,String term,String orders, boolean showchild, int page, int pageSize);
	/**
	 * 读取相关文章
	 * @param catid
	 * @param id
