...
import com.ztesoft.net.eop.processor.core.freemarker.DateFormateDirectiveModel;
...
public class FreeMarkerUtil {
	...
	public static void test() {
		...
		try {
			cfg = FreeMarkerUtil
					.getFolderCfg("D:/workspace/eopnew/eop/WebContent/WEB-INF/classes/com/enation/mall/core/widget/goodscat");
