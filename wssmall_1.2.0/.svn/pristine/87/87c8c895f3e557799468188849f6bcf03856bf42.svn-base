...
import com.ztesoft.ibss.common.service.DWRException;
    ...
    public static void remoteHandleException(ScriptConduit conduit, String batchId, String callId, Throwable ex) throws IOException
    {
        try
        {
            ...
            if (ex instanceof InvocationTargetException) {
				...
				Object obj =itex.getTargetException();
				if(obj instanceof DWRException){
					DWRException dwrEx = (DWRException)obj;
					script.appendScript("dwr.engine._remoteDwrException(\'")
	                  .appendScript(String.valueOf(dwrEx.getLevel()))
	                  .appendScript("\',\'")
	                  .appendData(dwrEx.getMsg())
	                  .appendScript("\',")
	                  .appendData(dwrEx.getEx())
	                  .appendScript(");");
