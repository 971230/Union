...
public class CreateOrderReq extends ZteRequest {

	private String member_id; //必填
	...
	public GoodsUsers getGoodsUsers() {
		if(goodsUsers == null) 
			 return new GoodsUsers();
		return goodsUsers;
	}

	public void setGoodsUsers(GoodsUsers goodsUsers) {
