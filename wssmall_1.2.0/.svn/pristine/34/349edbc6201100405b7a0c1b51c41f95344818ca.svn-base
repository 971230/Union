...
public abstract class RequestUtil {
	...
	public static void main(String[] args) {
         String str = "wssmall/shop/admin/card!list.do?card.type_code=RECHARGE_CARD&version=20130522181110&page=2";			
         logger.info(str.replaceAll("&version=\\d{14}", ""));
         str = "wssmall/shop/admin/card!list.do?card.type_code=RECHARGE_CARD&version=20130522181110";			
         logger.info(str.replaceAll("&version=\\d{14}", ""));
	}
