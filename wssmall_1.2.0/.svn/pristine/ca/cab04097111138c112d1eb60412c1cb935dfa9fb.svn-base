...
/**
 * @Description 接口请求头部历史数据业务对象
 * @author  zhangJun
 * @date    2015-6-10
 * @version 1.0
 */
@RequestBeanAnnontion(primary_keys="inf_head_id", cache_keys="order_id,co_id",table_name="es_inf_head_his",table_archive = "yes", service_desc="接口请求头部")
public class InfHeadHisBusiRequest extends ZteBusiRequest<ZteResponse>  implements IZteBusiRequestHander {
	...
	@NotDbField
	public <T> T store() {
		ZteInstUpdateRequest<InfHeadHisBusiRequest> updateRequest = new ZteInstUpdateRequest<InfHeadHisBusiRequest>(); 
	...
	public <T> T load(ZteInstQueryRequest instQuery) {
		//构造参数
		QueryResponse<InfHeadHisBusiRequest> resp = new QueryResponse<InfHeadHisBusiRequest>();
	...
	public String toString() {
		...
		builder.append("InfHeadHisBusiRequest [inf_head_id=");
