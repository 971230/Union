...
public class InternetGroupStandardResp extends OrderCollectionResp {
	...
	public String toString() {
		...
		builder.append("BroadBandCtnStandardResp [validate_type=").append(validate_type).append(", validate_msg=")
