...
public class JNDINames {
	...
	public static final String BAKUOS_DATASOURCE = "bakSource";
	public static final String LOG_DATASOURCE = "dataSource";

	public static final String PPM_DATASOURCE = "dataSource";// 订单模型数据源
	public static final String PRODDB_DATASOURCE = "dataSource";// 销售品规格模型数据源
	...
	public static final String CQDEFAULT_DATASOURCE = "CQCRM";// 同步需求及时完成率

	/* 云南一点配置数据源 */
	public static final String YN_DEFAULT_DATASOURCE = "YNCRM";// CRM一点配置插数据表
}
