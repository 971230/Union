...
public interface IDlyTypeManager{
	 ...
	 * @param type 配送方式实体
	 * @param config 配送费用设置
	 * @see com.ztesoft.net.net.test.shop.delivery.DeliveryTest#addSameTest
	 */
	 ...
	 * @see com.ztesoft.net.net.test.shop.delivery.DeliveryTest#addDiffTest
	 */
	 ...
	 * @see com.ztesoft.net.net.test.shop.delivery.DeliveryTest#testGetTypeForOrder
	 */
	 ...
	 * @return
	 */
	public DlyType getDlyTypeById(String type_id);
