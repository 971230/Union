...
public class OrderStdStandarService extends BaseSupport{

	private StdOrderService stdOrderService;
	public OrderAddResp syncOrderStandardizing(OrderCollect oc,String userSessionId,String service_code) throws Exception {
...
//				}
			...
			resp = stdOrderService.syncAddOrder(req);
			//非现场交付订单插入数据,整个系统替换后需要屏蔽
...
//			}
	...
	public StdOrderService getStdOrderService(){
		return stdOrderService;
	}
	public void setStdOrderService(StdOrderService stdOrderService){
		this.stdOrderService = stdOrderService;
	}
}
