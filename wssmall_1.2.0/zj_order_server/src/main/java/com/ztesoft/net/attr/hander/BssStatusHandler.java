...
public class BssStatusHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		//业务办理状态：-1无需业务办理，0未办理，1已办理未竣工，2已办理已竣工
		...
		String goodsType = (String) orderAttrValues.get(AttrConsts.GOODS_TYPE);
		//裸机和配件不需要业务办理
		if(EcsOrderConsts.GOODS_TYPE_PHONE.equals(goodsType) || EcsOrderConsts.GOODS_TYPE_ADJUNCT.equals(goodsType)){
			value = ZjEcsOrderConsts.BSS_STATUS_NOT_NEED;
		}
		else{
			value = ZjEcsOrderConsts.BSS_STATUS_0;
		}
