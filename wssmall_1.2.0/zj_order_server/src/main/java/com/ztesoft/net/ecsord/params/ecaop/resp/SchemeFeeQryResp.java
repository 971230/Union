...
import com.ztesoft.net.ecsord.params.ecaop.vo.SchemeFeeQryRespVO;

public class SchemeFeeQryResp extends ZteResponse{
	...
	private SchemeFeeQryRespVO respJson;
	...
	public SchemeFeeQryRespVO getRespJson() {
		return respJson;
	}

	public void setRespJson(SchemeFeeQryRespVO respJson) {
