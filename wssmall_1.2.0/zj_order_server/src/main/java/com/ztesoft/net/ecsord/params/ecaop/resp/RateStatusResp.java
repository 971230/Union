...
import com.ztesoft.net.ecsord.params.ecaop.vo.RateStatusRespVO;

import params.ZteResponse;

public class RateStatusResp extends ZteResponse{
	...
	private RateStatusRespVO respJson;
	...
	public RateStatusRespVO getRespJson() {
		return respJson;
	}

	public void setRespJson(RateStatusRespVO respJson) {
