...
import com.ztesoft.net.ecsord.params.ecaop.vo.QryFtthObjIDVO;

public class QryFtthObjIDResp extends ZteResponse {
	...
	private QryFtthObjIDVO respJson;
	...
	public QryFtthObjIDVO getRespJson() {
		return respJson;
	}

	public void setRespJson(QryFtthObjIDVO respJson) {
