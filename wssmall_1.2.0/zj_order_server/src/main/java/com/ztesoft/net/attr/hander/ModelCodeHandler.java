 ...
 *
 */
public class ModelCodeHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(StringUtils.isEmpty(value)){
			value = CommonDataFactory.getInstance().getProductSpec(order_id, EcsOrderConsts.PRODUCT_TYPE_TERMINAL, SpecConsts.GOODS_SN);
		}
