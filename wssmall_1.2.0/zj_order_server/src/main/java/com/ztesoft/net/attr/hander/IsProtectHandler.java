...
public class IsProtectHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		//如果为空，默认否
		if(StringUtils.isEmpty(isProtect)){
			isProtect = EcsOrderConsts.NO_DEFAULT_VALUE;
		}
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(isProtect);
		return resp;
	}
