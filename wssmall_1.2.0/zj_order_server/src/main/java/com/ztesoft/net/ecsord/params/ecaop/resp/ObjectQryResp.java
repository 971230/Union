...
public class ObjectQryResp extends ZteResponse{
	...
	private  List<ObjectQryVO> respJson;
	...
	public List<ObjectQryVO> getRespJson() {
		return respJson;
	}

	public void setRespJson(List<ObjectQryVO> respJson) {
