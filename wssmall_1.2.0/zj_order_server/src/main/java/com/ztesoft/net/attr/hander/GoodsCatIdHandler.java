...
public class GoodsCatIdHandler extends BaseSupport implements IAttrHandler {
	@Override
...
//			cat_id = CommonDataFactory.getInstance().getGoodSpec(null, goods_id, SpecConsts.NEW_CAT_ID);
//		}
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(cat_id);
		return resp;
	}
