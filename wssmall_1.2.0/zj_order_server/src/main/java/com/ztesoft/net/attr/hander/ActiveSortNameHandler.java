 ...
 *
 */
public class ActiveSortNameHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String active_sort =(String) paramsValue.get(AttrConsts.ACTIVE_SORT);
		
		
		CommHandler comm=new CommHandler();
		active_sort_name=comm.getNameBykey(value,active_sort, StypeConsts.ACTIVE_SORT);
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(active_sort_name);
		return resp;
	}
