 ...
 *
 */
public class PayMethodHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(EcsOrderConsts.PAY_METHOD_ZFB.equals(value)){
			value = EcsOrderConsts.PAY_METHOD_QEZF;
		}
