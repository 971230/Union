 ...
 *
 */
public class PlanTitleHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String plan_title = CommonDataFactory.getInstance().getProductSpec(order_id, SpecConsts.TYPE_ID_10002, SpecConsts.PLAN_TITLE);
		if(StringUtils.isEmpty(plan_title)){
			plan_title = value;
		}
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(plan_title);
		return resp;
	}
