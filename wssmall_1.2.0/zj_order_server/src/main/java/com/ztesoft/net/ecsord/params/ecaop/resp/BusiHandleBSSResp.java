...
public class BusiHandleBSSResp extends ZteResponse {
	...
	private BusiHandleBSSVO respJson;
	...
	public BusiHandleBSSVO getRespJson() {
		return respJson;
	}

	public void setRespJson(BusiHandleBSSVO respJson) {
