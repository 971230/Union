 ...
 *
 */
public class LiangPriceHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(CommonDataFactory.getInstance().isZbOrder(plat_type)){
			...
			if(!StringUtils.isEmpty(phone_num)){
				value = CommonDataFactory.getInstance().getNumberSpec(phone_num, SpecConsts.NUMERO_DEPOSIT);
			}
		}
