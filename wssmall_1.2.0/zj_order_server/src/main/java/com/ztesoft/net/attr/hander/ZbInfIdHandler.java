...
public class ZbInfIdHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String zb_inf_id = (String) orderAttrValues.get(AttrConsts.OUT_TID);
		...
		if(!CommonDataFactory.getInstance().isZbOrder(plat_type)){
			...
			zb_inf_id = year  + "" + month + "" + date+ "" + hour + "" + minute + ""+ second+Math.round(Math.random()*8999+1000);
		}
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(zb_inf_id);
		return resp;
	}
