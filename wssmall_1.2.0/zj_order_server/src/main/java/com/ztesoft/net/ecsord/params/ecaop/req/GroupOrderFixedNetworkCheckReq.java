...
public class GroupOrderFixedNetworkCheckReq extends ZteRequest{
	...
	private GroupOrderApiTerminal unibssbody;
	...
	public String getApiMethodName() {
		return "com.zte.unicomService.zj.grouporder.checkApiTerminal";
	}
    ...
    public GroupOrderApiTerminal getUnibssbody() {
        return unibssbody;
    }

    public void setUnibssbody(GroupOrderApiTerminal unibssbody) {
