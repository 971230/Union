 ...
 *
 */
public class SpecificationCodeHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(!CommonDataFactory.getInstance().isZbOrder(plat_type) && StringUtils.isEmpty(value)) {
			value = CommonDataFactory.getInstance().getProductSpec(order_id, SpecConsts.TYPE_ID_10000, null, SpecConsts.MODEL_CODE);
		}
