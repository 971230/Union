 ...
 *
 */
public class GoodsNameHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(StringUtils.isEmpty(value)){
			value = CommonDataFactory.getInstance().getGoodSpec(goods_id==null?order_id:null, goods_id, SpecConsts.GOODS_NAME);
		}
		if(!StringUtils.isEmpty(value)){
