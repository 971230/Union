...
public class PayResultAPPResp extends ZteResponse{
	...
	@ZteSoftCommentAnnotationParam(name="激活状态",type="String",isNecessary="Y",desc="激活状态")
	...
	public void setActivite_status(String activite_status) {
