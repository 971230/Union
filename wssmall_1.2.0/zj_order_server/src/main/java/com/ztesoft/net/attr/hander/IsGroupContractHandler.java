 ...
 *
 */
public class IsGroupContractHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(StringUtils.isEmpty(value))
			value = CommonDataFactory.getInstance().isGroupContract(order_from, goods_id);
