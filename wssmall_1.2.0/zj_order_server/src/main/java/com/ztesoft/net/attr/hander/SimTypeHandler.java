 ...
 * 1白卡、0成卡
 */
public class SimTypeHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		//String sim_type = CommonDataFactory.getInstance().getSimType(order_id, order_from, value, orderAttrValues);
		resp.setField_value("1");//只有白卡
		return resp;
	}
