 ...
 * 01主卡、02副卡
 */
public class CardTypeHandler  extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		{
			resp.setField_value(EcsOrderConsts.CARD_TYPE_ZHU);
		}
		else
		{
			resp.setField_value(EcsOrderConsts.CARD_TYPE_FU);
		}
		return resp;
	}
