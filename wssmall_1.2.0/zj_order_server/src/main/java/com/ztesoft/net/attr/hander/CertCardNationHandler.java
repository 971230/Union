 ...
 *
 */
public class CertCardNationHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String certNation = (String) orderAttrValues.get("cert_nation");
		if(StringUtils.isEmpty(certNation)){
			resp.setField_value(EcsOrderConsts.CERT_CARD_NATION);
		}
		else{
			resp.setField_value(certNation);
		}
		return resp;
	}
