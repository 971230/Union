 ...
 *
 */
public class FirstFeeTypeNameHandler extends BaseSupport implements
		IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		first_fee_type_name=comm.getNameBykey(value,first_fee_type, StypeConsts.OFFER_EFF_TYPE);

		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(first_fee_type_name);
		return resp;
	}
