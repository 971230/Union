 ...
 *
 */
public class ColorCodeHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(!CommonDataFactory.getInstance().isZbOrder(plat_type) && StringUtils.isEmpty(value)) {
			value = CommonDataFactory.getInstance().getProductSpec(order_id, null, pro_goods_id, SpecConsts.COLOR_CODE);
		}
