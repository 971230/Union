...
import com.ztesoft.net.ecsord.params.ecaop.vo.TabuserBtocbSubVO;

public class TabuserBtocbSubResp extends ZteResponse{
	...
	private TabuserBtocbSubVO respJson;
	...
	public TabuserBtocbSubVO getRespJson() {
		return respJson;
	}

	public void setResp(TabuserBtocbSubVO respJson) {
