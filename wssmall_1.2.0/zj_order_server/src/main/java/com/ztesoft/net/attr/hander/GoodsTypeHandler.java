 ...
 *
 */
public class GoodsTypeHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(StringUtils.isEmpty(type_id)){
			value = CommonDataFactory.getInstance().getGoodSpec(null, goods_id, SpecConsts.TYPE_ID);
		}
		else{
			value = type_id;
		}
//		//如果是淘宝的上网卡，按号卡流程处理订单-add by zou.qh 2015-01-30
//		if((EcsOrderConsts.ORDER_FROM_10001.equals(order_from) 
//				|| EcsOrderConsts.ORDER_FROM_10012.equals(order_from)) && EcsOrderConsts.GOODS_TYPE_WIFI_CARD.equals(value)){
//			value = EcsOrderConsts.GOODS_TYPE_NUM_CARD;
//		}
