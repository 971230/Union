...
import com.ztesoft.net.ecsord.params.ecaop.vo.KdNumberCheckVO;

public class KdNumberCheckResp extends ZteResponse {
	...
	private KdNumberCheckVO respJson;
	...
	public KdNumberCheckVO getRespJson() {
		return respJson;
	}

	public void setRespJson(KdNumberCheckVO respJson) {
