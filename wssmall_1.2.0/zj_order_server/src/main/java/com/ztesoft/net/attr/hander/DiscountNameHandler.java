 ...
 *
 */
public class DiscountNameHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(!CommonDataFactory.getInstance().isZbOrder(plat_type) && StringUtils.isEmpty(value)) {
			...
			if(!StringUtils.isEmpty(activity_code)){
				value = CommonDataFactory.getInstance().getActivitySpec(activity_code, SpecConsts.ACTIVITY_NAME);
			}
		}
