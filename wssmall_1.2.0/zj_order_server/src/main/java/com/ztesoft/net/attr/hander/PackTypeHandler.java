...
public class PackTypeHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String type_id = Const.getStrValue(orderAttrValues, "type_id");
		value = CommonDataFactory.getInstance().getDictCodeValue(StypeConsts.PACK_TYPE, type_id);
