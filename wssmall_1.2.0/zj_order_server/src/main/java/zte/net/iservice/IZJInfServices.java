...
public interface IZJInfServices {
	 ...
	 * @date 2017年6月1日
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "订单信息列表查询接口", summary = "订单信息列表查询接口")
	 ...
	 * @date 2017年2月28日
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "订单信息更新接口", summary = "订单信息更新接口")
	 ...
	 * @throws Exception
	 * @author songqi
	 * @date 2017年10月19日 11:41:46
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "订单信息更新接口new", summary = "订单信息更新接口new")
	 ...
	 * @date 2017年2月28日
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "业务办理校验接口", summary = "业务办理校验接口")
	 ...
	 * @date 2017年2月28日
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "业务办理预提交接口", summary = "业务办理预提交接口")
	 ...
	 * @date 2017年2月28日
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "订单收费接口", summary = "订单收费接口")
	...
	// 获取商品报文
	@ZteSoftCommentAnnotation(type = "method", desc = "商品报文", summary = "商品报文")
	 ...
	 * 订单正式提交接口
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "订单正式提交接口", summary = "订单正式提交接口")
	public BroadbandOrderSubResp orderFormalSub(OrderFormalSubReq requ) throws Exception;

	/**
	 * 卡数据同步(省内)
	 */
	@ZteSoftCommentAnnotation(type = "method", desc = "卡数据同步接口(省内)", summary = "卡数据同步接口(省内)")
	CardDataSyncBssResp cardDataSyncBss(CardDataSyncBssReq requ) throws Exception;
	...
	@ZteSoftCommentAnnotation(type = "method", desc = "工单相关订单列表查询", summary = "工单相关订单列表查询")
...
//	public AppOrderCancelResp cancelOrderByRequ(AppOrderCancelReq requ) throws Exception ;
	...
	public CmcSmsSendResp cmcSmsSend(CmcSmsSendReq req) throws ApiBusiException, Exception;
    ...
    @ZteSoftCommentAnnotation(type = "method", desc = "物流信息跟新接口", summary = "物流信息跟新接口")
    public	DeliveryInfoUpdateResp deliveryInfoUpdate(DeliveryInfoUpdateReq req);
    
    @ZteSoftCommentAnnotation(type = "method", desc = "预、选占号码查询接口", summary = "号码资源释放接口")
    public ResourCecenterAppResp QuerySelectNumber(QuerySelectNumberReq req)throws Exception;
    
    @ZteSoftCommentAnnotation(type = "method", desc = "号码手动释放", summary = "号码资源释放接口")
    ...
    @ZteSoftCommentAnnotation(type = "method", desc = "通用收单接口", summary = "通用收单接口")
