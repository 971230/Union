...
public class OrderStatusQryResp extends ZteResponse{
	...
	private OrderStatusQryVO respJson;
	...
	public OrderStatusQryVO getRespJson() {
		return respJson;
	}
	public void setRespJson(OrderStatusQryVO respJson) {
