...
import com.ztesoft.net.ecsord.params.ecaop.vo.CbssrefundFeeQryRespVO;

public class CbssrefundFeeQryResp extends ZteResponse {
	...
	private CbssrefundFeeQryRespVO respJson;
	...
	public CbssrefundFeeQryRespVO getRespJson() {
		return respJson;
	}

	public void setRespJson(CbssrefundFeeQryRespVO respJson) {
