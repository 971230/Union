...
public class ReliefPresFlagHandler extends BaseSupport implements IAttrHandler {
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(EcsOrderConsts.NO_DEFAULT_VALUE.equals(value) || StringUtils.isEmpty(value)){
			value = EcsOrderConsts.RELIEFPRES_FLAG_NO;
		}
		else if(EcsOrderConsts.IS_DEFAULT_VALUE.equals(value)){
			value = EcsOrderConsts.RELIEFPRES_FLAG_YES;
		}
