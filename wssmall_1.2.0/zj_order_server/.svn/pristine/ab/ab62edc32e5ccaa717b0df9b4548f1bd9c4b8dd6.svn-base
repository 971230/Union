 ...
 *
 */
public class InventoryNameHandler implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		String inventory_name = (value==null || "".equals(value))?EcsOrderConsts.DEFAULT_INVENTORY_NAME:value;
		AttrInstLoadResp resp = new AttrInstLoadResp();
		resp.setField_value(inventory_name);
		return resp;
	}
