 ...
 *
 */
public class DisfeeSelectHandler extends BaseSupport implements IAttrHandler {
	@Override
...
//		if(Consts.ORDER_FROM_ZB.equals(order_from)){
//	        return value;
//		}
//		else {
//			return CommonDataFactory.getInstance().getActivitySpec(order_id,
//				SpecConsts.DISFEE_SELECT);
//		}
