 ...
 *
 */
public class PlatTypeHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(CommonDataFactory.getInstance().isZbOrder(value)){
			value = EcsOrderConsts.ORDER_FROM_10003;
		}
