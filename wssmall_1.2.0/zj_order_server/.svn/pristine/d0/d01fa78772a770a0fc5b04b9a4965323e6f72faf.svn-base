...
public class DEVELOPER_INFO {
	...
	private String DEVELOP_STAFF_NAME;
	private String DEVELOP_DATE;
	private String DEVELOP_MANAGER_ID;
	private String DEVELOP_MANAGER_NAME;
	private String DEVELOP_NICK_ID;
	private String DEVELOP_NICK_NAME;
	...
	public void setDEVELOP_MANAGER_ID(String DEVELOP_MANAGER_ID) {
		this.DEVELOP_MANAGER_ID = DEVELOP_MANAGER_ID;
	}

	public String getDEVELOP_MANAGER_ID() {
		return DEVELOP_MANAGER_ID;
	}

	public void setDEVELOP_MANAGER_NAME(String DEVELOP_MANAGER_NAME) {
		this.DEVELOP_MANAGER_NAME = DEVELOP_MANAGER_NAME;
	}

	public String getDEVELOP_MANAGER_NAME() {
		return DEVELOP_MANAGER_NAME;
	}

	public void setDEVELOP_NICK_ID(String DEVELOP_NICK_ID) {
		this.DEVELOP_NICK_ID = DEVELOP_NICK_ID;
	}

	public String getDEVELOP_NICK_ID() {
		return DEVELOP_NICK_ID;
	}

	public void setDEVELOP_NICK_NAME(String DEVELOP_NICK_NAME) {
		this.DEVELOP_NICK_NAME = DEVELOP_NICK_NAME;
	}

	public String getDEVELOP_NICK_NAME() {
		return DEVELOP_NICK_NAME;
	}
