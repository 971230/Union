 ...
 *
 */
public class DeliveryStatusHandler extends BaseSupport implements IAttrHandler {
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if("未发货".equals(value))
			value = EcsOrderConsts.DELVERY_STATUS_00;
		
		if("发货到货".equals(value))
			value = EcsOrderConsts.DELVERY_STATUS_01;
		
		if("已发货".equals(value))
			value = EcsOrderConsts.DELVERY_STATUS_02;
