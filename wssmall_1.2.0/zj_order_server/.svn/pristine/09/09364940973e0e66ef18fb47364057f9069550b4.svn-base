 ...
 * 订单正式撤单接口请求
 */
public class OrderCancelSubmitReq extends ZteRequest{
	@ZteSoftCommentAnnotationParam(name = "内部订单号", type = "String", isNecessary = "Y", desc = "notNeedReqStrOrderId:订单系统内部订单")
	private String notNeedReqStrOrderId;
	@ZteSoftCommentAnnotationParam(name = "定单id，如1631979215", type = "String", isNecessary = "Y", desc = "orderid：定单id，如1631979215")
	private String order_id;
	
	@ZteSoftCommentAnnotationParam(name = "地市编码，如A，B", type = "String", isNecessary = "Y", desc = "regionid：地市编码，如A，B")
	...
	public String getApiMethodName() {
		return "com.zte.unicomService.zj.broadband.orderCancelSubmit";
	}
