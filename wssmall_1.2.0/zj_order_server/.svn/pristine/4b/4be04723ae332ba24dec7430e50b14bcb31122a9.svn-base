 ...
 *
 */
public class ModelNameHandler extends BaseSupport implements IAttrHandler{
	@Override
	...
	public AttrInstLoadResp handler(AttrSwitchParams params) {
		...
		if(StringUtils.isEmpty(value)){
			value = CommonDataFactory.getInstance().getProductSpec(order_id, EcsOrderConsts.PRODUCT_TYPE_TERMINAL, SpecConsts.MACHINE_NAME);
		}
