 ...
 *
 */
public class WorkOrderMixOrdUpdateReq extends ZteRequest {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1126007567401204808L;
	...
	@ZteSoftCommentAnnotationParam(name = "系统", type = "String", isNecessary = "Y", desc = "系统")
	...
	public String getApiMethodName() {
		return "zte.net.iservice.impl.ZJInfServices.doWorkOrderMixOrdUpdate";
	}
}
