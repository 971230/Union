...
public class ApiTest {
	...
	private static final String serverUrl = "http://132.151.42.121:8006/api/http/alibaba.tianji.supplier.order.query/2.0?method=alibaba.tianji.supplier.order.query&v=2.0&appkey=21605828&secret=8da0baffaf8bca4a3654b7cbde92a843&sessionKey=61011185be8d4d111dc8a86760164778f97a87c90820fde712456631&access_token=Y2IxYmM5ZThhMzMwNjJkMzUxMDJmZjMyZmNiYzUzODg=";
	private static final String appKey = "21605828"; // 可替换为您的沙箱环境应用的appKey
	private static final String appSecret = "8da0baffaf8bca4a3654b7cbde92a843"; // 可替换为您的沙箱环境应用的appSecret
	private static final String sessionKey = "61011185be8d4d111dc8a86760164778f97a87c90820fde712456631"; // 必须替换为沙箱账号授权得到的真实有效sessionKey
	private static Logger logger = Logger.getLogger(ApiTest.class);
	public static void main(String[] args) throws Exception {
	logger.info(getSellerItem());
    }

	private static String getSellerItem() throws IOException {
	    Map<String, String> params = new HashMap<String, String>();
	    // 公共参数
	    params.put("method", "alibaba.tianji.supplier.order.query");
        ...
        // 业务参数
        params.put("param_supplier_top_query_model", "{\"end_time\":\"2017-08-10 22:04:22\",\"page_num\":1,\"page_size\":10,\"start_time\":\"2017-08-01 06:58:32\"}");
