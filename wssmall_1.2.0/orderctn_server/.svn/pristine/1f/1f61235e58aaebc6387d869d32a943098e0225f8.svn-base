 ...
 */
public class LocalMallServlet extends HttpServlet {
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (null != inJson && !"".equals(inJson)) {
				...
				orderId = json.getString("outOrderId");//MallUtils.searchValue(inJson, "outOrderId");
				//订单来源
				orderSource = json.getString("orderSrc");
			    ...
			    if (null != def && def.equals(key)) {
					...
					req.setOutServiceCode(OrderCtnConsts.OUT_SERVICE_CODE_ZJLOCALMALLORDERSTANDARD);
