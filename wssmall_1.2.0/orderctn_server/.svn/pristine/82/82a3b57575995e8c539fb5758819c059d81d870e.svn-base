 ...
 */
public interface OrderCtnConsts {
	...
	/**
	 * 订单标准化outService - 码上购商城订单标准化
	 */
	public static final String OUT_SERVICE_CODE_CODEPURCHASEMALLORDERSTANDARD = "create_order_codePurchaseMallOrderStandard";
	/**
	...
	/**
	 * 订单标准化outService - 淘宝天机平台订单标准化
	 */
	public static final String OUT_SERVICE_CODE_TAOBAOTJORDERSTANDARD = "create_order_taoBaoTianjiOrderStandard";
	...
	/**
	 * 订单标准化outService - 河北单宽带收单接口
	 */
	public static final String OUT_SERVICE_CODE_HBBROADBANDORDERSTANDARD = "create_order_HBBroadbandOrderStandard";
	/**
	 * 订单标准化outService - 河北融合新装标准化
	 */
	public static final String OUT_SERVICE_CODE_HBNOWOADDMIXEDORDERSTANDARD = "create_order_HBNoWoAddMixedServletOrderStandard";
	
	/**
	 * 订单标准化outService - 河北手网微宽带收单接口
	 */
	public static final String OUT_SERVICE_CODE_NETWORK_HAND_MICRO_STANDARD = "create_order_NetworkHandMicroStandard";
	
	
	/**
	 * 订单标准化outService - 融合业务标准化
	 */
	public static final String OUT_SERVICE_CODE_GROUPORDERSTANDARD = "create_order_groupOrderStandard";
	
	public static final String OUT_SERVICE_CODE_INTERGROUPORDERSTANDARD = "create_order_internetGroupStandard";
	/**
	 * 订单标准化outService - 温大固网业务标准化
	 */
	public static final String OUT_SERVICE_CODE_FIXBUSIORDERSTANDARD = "create_order_fixBusiOrderStandard";
	
	/**
	 * 订单标准化outService - 新固网业务标准化
	 */
	public static final String OUT_SERVICE_CODE_BROADBANDSTANDARD = "create_order_broadBandCtnStandard";
	/**
	 * 订单标准化outService - 互联网业务标准化
	 */
	public static final String OUT_SERVICE_CODE_INTERNETORDERSTANDARD = "create_order_internetBusiOrderStandard";
	
	/**
	 * 订单标准化outService - 移网/产品/活动业务通用收单接口
	 */
	public static final String OUT_SERVICE_CODE_MOBILEBUSIORDERSTANDARD = "create_order_MobileBusiOrderStandard";
	
	/**
	 * 固网终端更换标准化
	 */
	public static final String OUT_SERVICE_CODE_OBJECTREPLACESTANDARD = "create_order_ObjectReplaceStandard";
