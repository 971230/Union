...
public abstract class AbsTaobao implements OuterInf{
	...
	//@Resource
		 ...
		 * 可传多个使用","号分开
		 */
		public static final String ORDER_TYPE = "fixed,step";
		...
		////public static final String default_city = "310000|杭州市|310000";
		//public static final String default_provin = "330000|浙江省|330000";
